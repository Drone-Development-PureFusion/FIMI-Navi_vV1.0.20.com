...
.method public constructor <init>(IILjava/lang/String;Lcom/twitter/Extractor$Entity$Type;)V
    ...
    .param p4, "type"    # Lcom/twitter/Extractor$Entity$Type;
...
.method public constructor <init>(IILjava/lang/String;Ljava/lang/String;Lcom/twitter/Extractor$Entity$Type;)V
    ...
    .param p2, "end"    # I
    .param p3, "value"    # Ljava/lang/String;
    .param p4, "listSlug"    # Ljava/lang/String;
    .param p5, "type"    # Lcom/twitter/Extractor$Entity$Type;
...
.method public constructor <init>(Ljava/util/regex/Matcher;Lcom/twitter/Extractor$Entity$Type;I)V
    ...
    .param p2, "type"    # Lcom/twitter/Extractor$Entity$Type;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 52
    :cond_1
    instance-of v3, p1, Lcom/twitter/Extractor$Entity;
    ...
    .line 58
    .local v0, "other":Lcom/twitter/Extractor$Entity;
    iget-object v3, p0, Lcom/twitter/Extractor$Entity;->type:Lcom/twitter/Extractor$Entity$Type;

    iget-object v4, v0, Lcom/twitter/Extractor$Entity;->type:Lcom/twitter/Extractor$Entity$Type;

    invoke-virtual {v3, v4}, Lcom/twitter/Extractor$Entity$Type;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_3

    iget v3, p0, Lcom/twitter/Extractor$Entity;->start:I

    iget v4, v0, Lcom/twitter/Extractor$Entity;->start:I

    if-ne v3, v4, :cond_3

    iget v3, p0, Lcom/twitter/Extractor$Entity;->end:I

    iget v4, v0, Lcom/twitter/Extractor$Entity;->end:I

    if-ne v3, v4, :cond_3

    iget-object v3, p0, Lcom/twitter/Extractor$Entity;->value:Ljava/lang/String;

    iget-object v4, v0, Lcom/twitter/Extractor$Entity;->value:Ljava/lang/String;
...
.method public setDisplayURL(Ljava/lang/String;)V
    .locals 0
    .param p1, "displayURL"    # Ljava/lang/String;
...
.method public setExpandedURL(Ljava/lang/String;)V
    .locals 0
    .param p1, "expandedURL"    # Ljava/lang/String;
