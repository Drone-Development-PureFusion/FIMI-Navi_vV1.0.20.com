...
.method constructor <init>(Lcom/twitter/sdk/android/core/TwitterAuthConfig;Ljava/util/concurrent/ConcurrentHashMap;Lcom/twitter/sdk/android/core/TwitterApiClient;)V
    .locals 5
    .param p1, "authConfig"    # Lcom/twitter/sdk/android/core/TwitterAuthConfig;
    .param p3, "guestClient"    # Lcom/twitter/sdk/android/core/TwitterApiClient;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lcom/twitter/sdk/android/core/TwitterCore;->context:Landroid/content/Context;

    .line 70
    new-instance v0, Lcom/twitter/sdk/android/core/PersistedSessionManager;

    new-instance v1, Lcom/twitter/sdk/android/core/internal/persistence/PreferenceStoreImpl;

    iget-object v2, p0, Lcom/twitter/sdk/android/core/TwitterCore;->context:Landroid/content/Context;

    const-string v3, "session_store"

    invoke-direct {v1, v2, v3}, Lcom/twitter/sdk/android/core/internal/persistence/PreferenceStoreImpl;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/twitter/sdk/android/core/PersistedSessionManager;-><init>(Lcom/twitter/sdk/android/core/internal/persistence/PreferenceStore;Lcom/twitter/sdk/android/core/internal/persistence/SerializationStrategy;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/twitter/sdk/android/core/Twitter;->getExecutorService()Ljava/util/concurrent/ExecutorService;
...
.method private declared-synchronized createGuestClient(Lcom/twitter/sdk/android/core/TwitterApiClient;)V
    .locals 1
    .param p1, "twitterApiClient"    # Lcom/twitter/sdk/android/core/TwitterApiClient;
...
.method private declared-synchronized createGuestSessionProvider()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/twitter/sdk/android/core/TwitterCore;->guestSessionProvider:Lcom/twitter/sdk/android/core/GuestSessionProvider;
    ...
    .line 156
    .end local v0    # "service":Lcom/twitter/sdk/android/core/internal/oauth/OAuth2Service;
    :cond_0
    monitor-exit p0
...
.method public static getInstance()Lcom/twitter/sdk/android/core/TwitterCore;
    ...
    .line 86
    const-class v1, Lcom/twitter/sdk/android/core/TwitterCore;
    ...
    invoke-direct {v0, v2}, Lcom/twitter/sdk/android/core/TwitterCore;-><init>(Lcom/twitter/sdk/android/core/TwitterAuthConfig;)V

    sput-object v0, Lcom/twitter/sdk/android/core/TwitterCore;->instance:Lcom/twitter/sdk/android/core/TwitterCore;
...
.method public addApiClient(Lcom/twitter/sdk/android/core/TwitterSession;Lcom/twitter/sdk/android/core/TwitterApiClient;)V
    ...
    .param p2, "customTwitterApiClient"    # Lcom/twitter/sdk/android/core/TwitterApiClient;
...
.method public addGuestApiClient(Lcom/twitter/sdk/android/core/TwitterApiClient;)V
    .locals 1
    .param p1, "customTwitterApiClient"    # Lcom/twitter/sdk/android/core/TwitterApiClient;
