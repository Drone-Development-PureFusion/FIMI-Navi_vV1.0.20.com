...
.field protected final filesManager:Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ScheduledExecutorService;Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;)V
    ...
    .prologue
    .line 49
    .local p0, "this":Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;, "Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy<TT;>;"
    .local p3, "filesManager":Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;, "Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager<TT;>;"
    ...
    iput-object v0, p0, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->scheduledRolloverFutureRef:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public recordEvent(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, p1}, Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;->writeEvent(Ljava/lang/Object;)V
    :try_end_0
...
.method public rollFileOver()Z
    ...
    invoke-virtual {v1}, Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;->rollFileOver()Z
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method scheduleTimeBasedFileRollOver(JJ)V
    ...
    .line 119
    new-instance v1, Lcom/twitter/sdk/android/core/internal/scribe/TimeBasedFileRollOverRunnable;

    iget-object v0, p0, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->context:Landroid/content/Context;

    invoke-direct {v1, v0, p0}, Lcom/twitter/sdk/android/core/internal/scribe/TimeBasedFileRollOverRunnable;-><init>(Landroid/content/Context;Lcom/twitter/sdk/android/core/internal/scribe/FileRollOverManager;)V
    ...
    invoke-static {v0, v2}, Lcom/twitter/sdk/android/core/internal/CommonUtils;->logControlled(Landroid/content/Context;Ljava/lang/String;)V

    .line 123
    :try_start_0
    iget-object v9, p0, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->scheduledRolloverFutureRef:Ljava/util/concurrent/atomic/AtomicReference;

    iget-object v0, p0, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->executorService:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-static {v0, v2, v7}, Lcom/twitter/sdk/android/core/internal/CommonUtils;->logControlledError(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public scheduleTimeBasedRollOverIfNeeded()V
    ...
    .line 58
    .local p0, "this":Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;, "Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy<TT;>;"
    iget v1, p0, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->rolloverIntervalSeconds:I
    ...
    invoke-virtual {p0, v2, v3, v4, v5}, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->scheduleTimeBasedFileRollOver(JJ)V
...
.method sendAndCleanUpIfSuccess()V
    ...
    .line 143
    .local p0, "this":Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;, "Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy<TT;>;"
    invoke-virtual {p0}, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->getFilesSender()Lcom/twitter/sdk/android/core/internal/scribe/FilesSender;

    move-result-object v3

    .line 144
    .local v3, "filesSender":Lcom/twitter/sdk/android/core/internal/scribe/FilesSender;
    if-nez v3, :cond_1

    .line 145
    iget-object v5, p0, Lcom/twitter/sdk/android/core/internal/scribe/EnabledEventsStrategy;->context:Landroid/content/Context;

    const-string v6, "skipping files send because we don\'t yet know the target endpoint"

    invoke-static {v5, v6}, Lcom/twitter/sdk/android/core/internal/CommonUtils;->logControlled(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v5}, Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;->getBatchOfFilesToSend()Ljava/util/List;
    ...
    .line 158
    invoke-interface {v3, v0}, Lcom/twitter/sdk/android/core/internal/scribe/FilesSender;->send(Ljava/util/List;)Z
    ...
    invoke-virtual {v5, v0}, Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;->deleteSentFiles(Ljava/util/List;)V
    :try_end_0
    ...
    invoke-virtual {v5}, Lcom/twitter/sdk/android/core/internal/scribe/EventsFilesManager;->deleteOldestInRollOverIfOverMax()V
    ...
    .line 172
    invoke-static {v5, v6, v2}, Lcom/twitter/sdk/android/core/internal/CommonUtils;->logControlledError(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Throwable;)V
