...
.method public final release()V
    ...
    sget-object v2, Lcom/google/android/gms/common/api/internal/zzdk;->zzgbr:[Lcom/google/android/gms/common/api/internal/BasePendingResult;
    ...
    invoke-virtual {v2, v7}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zza(Lcom/google/android/gms/common/api/internal/zzdn;)V

    invoke-virtual {v2}, Lcom/google/android/gms/common/api/PendingResult;->zzaid()Ljava/lang/Integer;

    move-result-object v1

    if-nez v1, :cond_1

    invoke-virtual {v2}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zzaip()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/zzdk;->zzgbs:Ljava/util/Set;
    ...
    iget-object v5, p0, Lcom/google/android/gms/common/api/internal/zzdk;->zzfyj:Ljava/util/Map;

    move-object v1, v2

    check-cast v1, Lcom/google/android/gms/common/api/internal/zzm;

    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/zzm;->zzahm()Lcom/google/android/gms/common/api/Api$zzc;
    ...
    invoke-interface {v1}, Lcom/google/android/gms/common/api/Api$zze;->zzaho()Landroid/os/IBinder;
    ...
    new-instance v5, Lcom/google/android/gms/common/api/internal/zzdm;

    invoke-direct {v5, v2, v7, v1, v7}, Lcom/google/android/gms/common/api/internal/zzdm;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;Lcom/google/android/gms/common/api/zze;Landroid/os/IBinder;Lcom/google/android/gms/common/api/internal/zzdl;)V

    invoke-virtual {v2, v5}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->zza(Lcom/google/android/gms/common/api/internal/zzdn;)V
