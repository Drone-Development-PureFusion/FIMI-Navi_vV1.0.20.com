...
.method public static open(Ljava/io/File;IIJI)Lcom/nostra13/universalimageloader/cache/disc/impl/ext/DiskLruCache;
    ...
    invoke-direct {v10, p0, v1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    .line 220
    .local v10, "journalFile":Ljava/io/File;
    ...
    .line 228
    .end local v10    # "journalFile":Ljava/io/File;
    :cond_3
    :goto_0
    ...
    .local v8, "cache":Lcom/nostra13/universalimageloader/cache/disc/impl/ext/DiskLruCache;
    move-object v9, v0

    .line 251
    .end local v8    # "cache":Lcom/nostra13/universalimageloader/cache/disc/impl/ext/DiskLruCache;
    .local v9, "cache":Ljava/lang/Object;
    :goto_1
    return-object v9

    .line 223
    .end local v9    # "cache":Ljava/lang/Object;
    .restart local v10    # "journalFile":Ljava/io/File;
    :cond_4
    const/4 v1, 0x0

    invoke-static {v7, v10, v1}, Lcom/nostra13/universalimageloader/cache/disc/impl/ext/DiskLruCache;->renameTo(Ljava/io/File;Ljava/io/File;Z)V
    ...
    .line 237
    .local v11, "journalIsCorrupt":Ljava/io/IOException;
    ...
    .line 248
    .end local v11    # "journalIsCorrupt":Ljava/io/IOException;
    :cond_5
    ...
    .end local v0    # "cache":Lcom/nostra13/universalimageloader/cache/disc/impl/ext/DiskLruCache;
    .restart local v8    # "cache":Lcom/nostra13/universalimageloader/cache/disc/impl/ext/DiskLruCache;
    move-object v9, v0

    .line 251
    .restart local v9    # "cache":Ljava/lang/Object;
    goto :goto_1
.end method
