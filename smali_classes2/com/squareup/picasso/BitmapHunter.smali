...
.method private computeNewPriority()Lcom/squareup/picasso/Picasso$Priority;
    ...
    iget-object v10, p0, Lcom/squareup/picasso/BitmapHunter;->actions:Ljava/util/List;
    ...
    :goto_0
    iget-object v10, p0, Lcom/squareup/picasso/BitmapHunter;->action:Lcom/squareup/picasso/Action;
    ...
    .local v7, "newPriority":Lcom/squareup/picasso/Picasso$Priority;
    :goto_2
    return-object v7

    .end local v1    # "hasAny":Z
    .end local v2    # "hasMultiple":Z
    .end local v7    # "newPriority":Lcom/squareup/picasso/Picasso$Priority;
    ...
    :cond_3
    iget-object v8, p0, Lcom/squareup/picasso/BitmapHunter;->action:Lcom/squareup/picasso/Action;
    ...
    invoke-virtual {v8}, Lcom/squareup/picasso/Action;->getPriority()Lcom/squareup/picasso/Picasso$Priority;
    ...
    .local v3, "i":I
    iget-object v8, p0, Lcom/squareup/picasso/BitmapHunter;->actions:Ljava/util/List;
    ...
    check-cast v8, Lcom/squareup/picasso/Action;
    ...
    .line 330
    .end local v6    # "newPriority":Lcom/squareup/picasso/Picasso$Priority;
    .restart local v7    # "newPriority":Lcom/squareup/picasso/Picasso$Priority;
    goto :goto_2
.end method
...
.method hunt()Landroid/graphics/Bitmap;
    ...
    .line 193
    .local v0, "bitmap":Landroid/graphics/Bitmap;
    iget v5, p0, Lcom/squareup/picasso/BitmapHunter;->memoryPolicy:I
    ...
    .line 194
    iget-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->cache:Lcom/squareup/picasso/Cache;

    iget-object v6, p0, Lcom/squareup/picasso/BitmapHunter;->key:Ljava/lang/String;

    invoke-interface {v5, v6}, Lcom/squareup/picasso/Cache;->get(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 196
    iget-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->stats:Lcom/squareup/picasso/Stats;

    invoke-virtual {v5}, Lcom/squareup/picasso/Stats;->dispatchCacheHit()V

    .line 197
    sget-object v5, Lcom/squareup/picasso/Picasso$LoadedFrom;->MEMORY:Lcom/squareup/picasso/Picasso$LoadedFrom;

    iput-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->loadedFrom:Lcom/squareup/picasso/Picasso$LoadedFrom;

    .line 198
    iget-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->picasso:Lcom/squareup/picasso/Picasso;
    ...
    invoke-static {v5, v6, v7, v8}, Lcom/squareup/picasso/Utils;->log(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v5, p0, Lcom/squareup/picasso/BitmapHunter;->retryCount:I

    if-nez v5, :cond_9

    sget-object v5, Lcom/squareup/picasso/NetworkPolicy;->OFFLINE:Lcom/squareup/picasso/NetworkPolicy;

    iget v5, v5, Lcom/squareup/picasso/NetworkPolicy;->index:I

    :goto_1
    iput v5, v6, Lcom/squareup/picasso/Request;->networkPolicy:I

    .line 206
    iget-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->requestHandler:Lcom/squareup/picasso/RequestHandler;

    iget-object v6, p0, Lcom/squareup/picasso/BitmapHunter;->data:Lcom/squareup/picasso/Request;

    iget v7, p0, Lcom/squareup/picasso/BitmapHunter;->networkPolicy:I

    invoke-virtual {v5, v6, v7}, Lcom/squareup/picasso/RequestHandler;->load(Lcom/squareup/picasso/Request;I)Lcom/squareup/picasso/RequestHandler$Result;

    move-result-object v4

    .line 207
    .local v4, "result":Lcom/squareup/picasso/RequestHandler$Result;
    if-eqz v4, :cond_2

    .line 208
    invoke-virtual {v4}, Lcom/squareup/picasso/RequestHandler$Result;->getLoadedFrom()Lcom/squareup/picasso/Picasso$LoadedFrom;
    ...
    .line 209
    invoke-virtual {v4}, Lcom/squareup/picasso/RequestHandler$Result;->getExifOrientation()I

    move-result v5

    iput v5, p0, Lcom/squareup/picasso/BitmapHunter;->exifRotation:I

    .line 211
    invoke-virtual {v4}, Lcom/squareup/picasso/RequestHandler$Result;->getBitmap()Landroid/graphics/Bitmap;
    ...
    .line 215
    invoke-virtual {v4}, Lcom/squareup/picasso/RequestHandler$Result;->getStream()Ljava/io/InputStream;
    ...
    invoke-static {v3, v5}, Lcom/squareup/picasso/BitmapHunter;->decodeStream(Ljava/io/InputStream;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
    :try_end_0
    ...
    invoke-static {v5, v6, v7}, Lcom/squareup/picasso/Utils;->log(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 228
    :cond_3
    iget-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->stats:Lcom/squareup/picasso/Stats;

    invoke-virtual {v5, v0}, Lcom/squareup/picasso/Stats;->dispatchBitmapDecoded(Landroid/graphics/Bitmap;)V

    .line 229
    iget-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->data:Lcom/squareup/picasso/Request;

    invoke-virtual {v5}, Lcom/squareup/picasso/Request;->needsTransformation()Z
    ...
    invoke-virtual {v5}, Lcom/squareup/picasso/Request;->needsMatrixTransform()Z
    ...
    iget v7, p0, Lcom/squareup/picasso/BitmapHunter;->exifRotation:I

    invoke-static {v5, v0, v7}, Lcom/squareup/picasso/BitmapHunter;->transformResult(Lcom/squareup/picasso/Request;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v8, p0, Lcom/squareup/picasso/BitmapHunter;->data:Lcom/squareup/picasso/Request;

    invoke-virtual {v8}, Lcom/squareup/picasso/Request;->logId()Ljava/lang/String;

    move-result-object v8

    invoke-static {v5, v7, v8}, Lcom/squareup/picasso/Utils;->log(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 237
    :cond_6
    iget-object v5, p0, Lcom/squareup/picasso/BitmapHunter;->data:Lcom/squareup/picasso/Request;

    invoke-virtual {v5}, Lcom/squareup/picasso/Request;->hasCustomTransformations()Z
    ...
    iget-object v5, v5, Lcom/squareup/picasso/Request;->transformations:Ljava/util/List;

    invoke-static {v5, v0}, Lcom/squareup/picasso/BitmapHunter;->applyCustomTransformations(Ljava/util/List;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    const-string v9, "from custom transformations"

    invoke-static {v5, v7, v8, v9}, Lcom/squareup/picasso/Utils;->log(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0}, Lcom/squareup/picasso/Stats;->dispatchBitmapTransformed(Landroid/graphics/Bitmap;)V
    ...
    .line 205
    .end local v2    # "bitmap":Landroid/graphics/Bitmap;
    .end local v4    # "result":Lcom/squareup/picasso/RequestHandler$Result;
    .restart local v0    # "bitmap":Landroid/graphics/Bitmap;
    :cond_9
    iget v5, p0, Lcom/squareup/picasso/BitmapHunter;->networkPolicy:I

    goto/16 :goto_1

    .line 219
    .restart local v3    # "is":Ljava/io/InputStream;
    .restart local v4    # "result":Lcom/squareup/picasso/RequestHandler$Result;
    :catchall_0
    move-exception v5
