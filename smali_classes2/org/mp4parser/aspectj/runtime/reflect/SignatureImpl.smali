...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->EMPTY_STRING_ARRAY:[Ljava/lang/String;
...
.method extractString(I)Ljava/lang/String;
    ...
    iget-object v3, p0, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->stringRep:Ljava/lang/String;
...
.method shortTypeName(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->stripPackageName(Ljava/lang/String;)Ljava/lang/String;
...
.method toString(Lorg/mp4parser/aspectj/runtime/reflect/StringMaker;)Ljava/lang/String;
    ...
    sget-boolean v2, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->useCache:Z

    if-eqz v2, :cond_0

    .line 43
    iget-object v2, p0, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->stringCache:Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl$Cache;

    if-nez v2, :cond_3

    .line 45
    :try_start_0
    new-instance v2, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl$CacheImpl;

    invoke-direct {v2}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl$CacheImpl;-><init>()V

    iput-object v2, p0, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->stringCache:Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl$Cache;
    :try_end_0
    ...
    iget v3, p1, Lorg/mp4parser/aspectj/runtime/reflect/StringMaker;->cacheOffset:I

    invoke-interface {v2, v3, v0}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl$Cache;->set(ILjava/lang/String;)V
    ...
    sput-boolean v2, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->useCache:Z
    ...
    invoke-interface {v2, v3}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl$Cache;->get(I)Ljava/lang/String;
