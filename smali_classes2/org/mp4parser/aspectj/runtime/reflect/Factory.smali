...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/Class;)V
    ...
    iput v0, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->count:I
    ...
    iput-object v0, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method static makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    .line 58
    :cond_1
    sget-object v2, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->prims:Ljava/util/Hashtable;
    ...
    sget-object v2, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->class$java$lang$ClassNotFoundException:Ljava/lang/Class;

    if-nez v2, :cond_3

    const-string v2, "java.lang.ClassNotFoundException"

    invoke-static {v2}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->class$java$lang$ClassNotFoundException:Ljava/lang/Class;
...
.method public static makeEncSJP(Ljava/lang/reflect/Member;)Lorg/mp4parser/aspectj/lang/JoinPoint$StaticPart;
    ...
    .line 143
    .local v0, "sig":Lorg/mp4parser/aspectj/lang/Signature;
    const/4 v9, 0x0
    ...
    .end local v0    # "sig":Lorg/mp4parser/aspectj/lang/Signature;
    ...
    .line 149
    .restart local v0    # "sig":Lorg/mp4parser/aspectj/lang/Signature;
    const-string v9, "method-execution"

    .line 158
    .end local v10    # "method":Ljava/lang/reflect/Method;
    :goto_0
    new-instance v1, Lorg/mp4parser/aspectj/runtime/reflect/JoinPointImpl$EnclosingStaticPartImpl;

    const/4 v2, -0x1

    const/4 v3, 0x0

    invoke-direct {v1, v2, v9, v0, v3}, Lorg/mp4parser/aspectj/runtime/reflect/JoinPointImpl$EnclosingStaticPartImpl;-><init>(ILjava/lang/String;Lorg/mp4parser/aspectj/lang/Signature;Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;)V
    ...
    .line 154
    .restart local v0    # "sig":Lorg/mp4parser/aspectj/lang/Signature;
    const-string v9, "constructor-execution"
    ...
    const-string v2, "member must be either a method or constructor"
...
.method public static makeJP(Lorg/mp4parser/aspectj/lang/JoinPoint$StaticPart;Ljava/lang/Object;Ljava/lang/Object;)Lorg/mp4parser/aspectj/lang/JoinPoint;
    .locals 2
    .param p0, "staticPart"    # Lorg/mp4parser/aspectj/lang/JoinPoint$StaticPart;
...
.method public makeAdviceSig(ILjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;[Ljava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Lorg/mp4parser/aspectj/lang/reflect/AdviceSignature;
    ...
    .line 334
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/AdviceSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-virtual {v0, v1}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->setLookupClassLoader(Ljava/lang/ClassLoader;)V
...
.method public makeAdviceSig(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/AdviceSignature;
    ...
    iget-object v3, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    move-object/from16 v0, p3

    invoke-static {v0, v3}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    iget-object v12, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-static {v3, v12}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    invoke-direct/range {v1 .. v8}, Lorg/mp4parser/aspectj/runtime/reflect/AdviceSignatureImpl;-><init>(ILjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;[Ljava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)V

    .line 326
    .local v1, "ret":Lorg/mp4parser/aspectj/runtime/reflect/AdviceSignatureImpl;
    iget-object v3, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-virtual {v1, v3}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->setLookupClassLoader(Ljava/lang/ClassLoader;)V
...
.method public makeCatchClauseSig(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/CatchClauseSignature;
    ...
    .line 381
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/CatchClauseSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeCatchClauseSig(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/CatchClauseSignature;
    ...
    invoke-static {p1, v5}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    new-instance v3, Lorg/mp4parser/aspectj/runtime/reflect/CatchClauseSignatureImpl;

    invoke-direct {v3, v0, v2, v1}, Lorg/mp4parser/aspectj/runtime/reflect/CatchClauseSignatureImpl;-><init>(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)V

    .line 375
    .local v3, "ret":Lorg/mp4parser/aspectj/runtime/reflect/CatchClauseSignatureImpl;
    iget-object v5, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-virtual {v3, v5}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->setLookupClassLoader(Ljava/lang/ClassLoader;)V
...
.method public makeConstructorSig(ILjava/lang/Class;[Ljava/lang/Class;[Ljava/lang/String;[Ljava/lang/Class;)Lorg/mp4parser/aspectj/lang/reflect/ConstructorSignature;
    ...
    .line 265
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/ConstructorSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeConstructorSig(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/ConstructorSignature;
    ...
    .line 235
    .local v2, "modifiersAsInt":I
    iget-object v10, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-static {p2, v10}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    iget-object v11, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-static {v10, v11}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    .line 255
    :cond_2
    new-instance v1, Lorg/mp4parser/aspectj/runtime/reflect/ConstructorSignatureImpl;
    ...
    .line 257
    .local v1, "ret":Lorg/mp4parser/aspectj/runtime/reflect/ConstructorSignatureImpl;
    iget-object v10, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-virtual {v1, v10}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->setLookupClassLoader(Ljava/lang/ClassLoader;)V
...
.method public makeESJP(Ljava/lang/String;Lorg/mp4parser/aspectj/lang/Signature;I)Lorg/mp4parser/aspectj/lang/JoinPoint$EnclosingStaticPart;
    ...
    .param p2, "sig"    # Lorg/mp4parser/aspectj/lang/Signature;
    .param p3, "l"    # I
    ...
    invoke-direct {v0, v1, p1, p2, v2}, Lorg/mp4parser/aspectj/runtime/reflect/JoinPointImpl$EnclosingStaticPartImpl;-><init>(ILjava/lang/String;Lorg/mp4parser/aspectj/lang/Signature;Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;)V
...
.method public makeESJP(Ljava/lang/String;Lorg/mp4parser/aspectj/lang/Signature;Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;)Lorg/mp4parser/aspectj/lang/JoinPoint$EnclosingStaticPart;
    ...
    .param p1, "kind"    # Ljava/lang/String;
    .param p2, "sig"    # Lorg/mp4parser/aspectj/lang/Signature;
    .param p3, "loc"    # Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;
...
.method public makeFieldSig(ILjava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)Lorg/mp4parser/aspectj/lang/reflect/FieldSignature;
    ...
    .line 287
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/FieldSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeFieldSig(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/FieldSignature;
    ...
    .line 277
    .local v2, "modifiersAsInt":I
    iget-object v4, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-static {p3, v4}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    invoke-static {p4, v4}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;

    move-result-object v1

    .line 280
    .local v1, "fieldTypeClass":Ljava/lang/Class;
    new-instance v3, Lorg/mp4parser/aspectj/runtime/reflect/FieldSignatureImpl;

    invoke-direct {v3, v2, p2, v0, v1}, Lorg/mp4parser/aspectj/runtime/reflect/FieldSignatureImpl;-><init>(ILjava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)V

    .line 281
    .local v3, "ret":Lorg/mp4parser/aspectj/runtime/reflect/FieldSignatureImpl;
    iget-object v4, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-virtual {v3, v4}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->setLookupClassLoader(Ljava/lang/ClassLoader;)V
...
.method public makeInitializerSig(ILjava/lang/Class;)Lorg/mp4parser/aspectj/lang/reflect/InitializerSignature;
    ...
    .line 355
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/InitializerSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeInitializerSig(Ljava/lang/String;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/InitializerSignature;
    ...
    invoke-static {p2, v3}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;

    move-result-object v0

    .line 348
    .local v0, "declaringTypeClass":Ljava/lang/Class;
    new-instance v2, Lorg/mp4parser/aspectj/runtime/reflect/InitializerSignatureImpl;

    invoke-direct {v2, v1, v0}, Lorg/mp4parser/aspectj/runtime/reflect/InitializerSignatureImpl;-><init>(ILjava/lang/Class;)V

    .line 349
    .local v2, "ret":Lorg/mp4parser/aspectj/runtime/reflect/InitializerSignatureImpl;
    iget-object v3, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;

    invoke-virtual {v2, v3}, Lorg/mp4parser/aspectj/runtime/reflect/SignatureImpl;->setLookupClassLoader(Ljava/lang/ClassLoader;)V
...
.method public makeLockSig()Lorg/mp4parser/aspectj/lang/reflect/LockSignature;
    ...
    invoke-static {v2, v3}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeClass(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    .line 394
    .local v1, "ret":Lorg/mp4parser/aspectj/runtime/reflect/LockSignatureImpl;
    iget-object v2, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeLockSig(Ljava/lang/Class;)Lorg/mp4parser/aspectj/lang/reflect/LockSignature;
    ...
    .line 400
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/LockSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeMethodSig(ILjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;[Ljava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Lorg/mp4parser/aspectj/lang/reflect/MethodSignature;
    ...
    .line 221
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/MethodSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeMethodSig(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/MethodSignature;
    ...
    invoke-direct/range {v1 .. v8}, Lorg/mp4parser/aspectj/runtime/reflect/MethodSignatureImpl;-><init>(ILjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;[Ljava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)V

    .line 214
    .local v1, "ret":Lorg/mp4parser/aspectj/runtime/reflect/MethodSignatureImpl;
    return-object v1
.end method
...
.method public makeSJP(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Lorg/mp4parser/aspectj/lang/JoinPoint$StaticPart;
    ...
    invoke-virtual/range {v1 .. v8}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeMethodSig(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/mp4parser/aspectj/lang/reflect/MethodSignature;

    move-result-object v9

    .line 114
    .local v9, "sig":Lorg/mp4parser/aspectj/lang/Signature;
    new-instance v1, Lorg/mp4parser/aspectj/runtime/reflect/JoinPointImpl$StaticPartImpl;

    iget v2, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->count:I

    add-int/lit8 v3, v2, 0x1

    iput v3, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->count:I

    const/4 v3, -0x1

    move/from16 v0, p8

    invoke-virtual {p0, v0, v3}, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->makeSourceLoc(II)Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;

    move-result-object v3

    invoke-direct {v1, v2, p1, v9, v3}, Lorg/mp4parser/aspectj/runtime/reflect/JoinPointImpl$StaticPartImpl;-><init>(ILjava/lang/String;Lorg/mp4parser/aspectj/lang/Signature;Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;)V
...
.method public makeSJP(Ljava/lang/String;Lorg/mp4parser/aspectj/lang/Signature;I)Lorg/mp4parser/aspectj/lang/JoinPoint$StaticPart;
    ...
    invoke-direct {v0, v1, p1, p2, v2}, Lorg/mp4parser/aspectj/runtime/reflect/JoinPointImpl$StaticPartImpl;-><init>(ILjava/lang/String;Lorg/mp4parser/aspectj/lang/Signature;Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;)V
...
.method public makeSourceLoc(II)Lorg/mp4parser/aspectj/lang/reflect/SourceLocation;
    ...
    .prologue
    .line 424
    new-instance v0, Lorg/mp4parser/aspectj/runtime/reflect/SourceLocationImpl;

    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lexicalClass:Ljava/lang/Class;

    iget-object v2, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->filename:Ljava/lang/String;

    invoke-direct {v0, v1, v2, p1}, Lorg/mp4parser/aspectj/runtime/reflect/SourceLocationImpl;-><init>(Ljava/lang/Class;Ljava/lang/String;I)V
...
.method public makeUnlockSig()Lorg/mp4parser/aspectj/lang/reflect/UnlockSignature;
    ...
    .line 413
    .local v1, "ret":Lorg/mp4parser/aspectj/runtime/reflect/UnlockSignatureImpl;
    iget-object v2, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
...
.method public makeUnlockSig(Ljava/lang/Class;)Lorg/mp4parser/aspectj/lang/reflect/UnlockSignature;
    ...
    .line 419
    .local v0, "ret":Lorg/mp4parser/aspectj/runtime/reflect/UnlockSignatureImpl;
    iget-object v1, p0, Lorg/mp4parser/aspectj/runtime/reflect/Factory;->lookupClassLoader:Ljava/lang/ClassLoader;
