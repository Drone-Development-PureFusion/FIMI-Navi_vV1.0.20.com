...
.method private forEach(Lrx/functions/Func1;II)I
    ...
    iget-object v9, p0, Lrx/internal/util/IndexedRingBuffer;->index:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v8, p0, Lrx/internal/util/IndexedRingBuffer;->elements:Lrx/internal/util/IndexedRingBuffer$ElementSection;

    .line 455
    .local v8, "section":Lrx/internal/util/IndexedRingBuffer$ElementSection;, "Lrx/internal/util/IndexedRingBuffer$ElementSection<TE;>;"
    sget v9, Lrx/internal/util/IndexedRingBuffer;->SIZE:I
    ...
    .end local v7    # "realIndex":I
    .restart local v2    # "i":I
    .restart local v3    # "lastIndex":I
    .restart local v6    # "realIndex":I
    :cond_3
    iget-object v9, v8, Lrx/internal/util/IndexedRingBuffer$ElementSection;->array:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    .restart local v6    # "realIndex":I
    :cond_6
    iget-object v9, v8, Lrx/internal/util/IndexedRingBuffer$ElementSection;->next:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v9}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v8

    .end local v8    # "section":Lrx/internal/util/IndexedRingBuffer$ElementSection;, "Lrx/internal/util/IndexedRingBuffer$ElementSection<TE;>;"
    check-cast v8, Lrx/internal/util/IndexedRingBuffer$ElementSection;

    .line 478
    .restart local v8    # "section":Lrx/internal/util/IndexedRingBuffer$ElementSection;, "Lrx/internal/util/IndexedRingBuffer$ElementSection<TE;>;"
    const/4 p2, 0x0
