...
.method public constructor <init>(Lcom/fimi/soul/media/player/widget/TextureRenderView;Landroid/graphics/SurfaceTexture;)V
    .locals 0
    .param p1, "textureView"    # Lcom/fimi/soul/media/player/widget/TextureRenderView;
...
.method public bindToMediaPlayer(Lcom/fimi/soul/media/player/IMediaPlayer;)V
    ...
    instance-of v2, p1, Lcom/fimi/soul/media/player/ISurfaceTextureHolder;
    ...
    .line 142
    check-cast v1, Lcom/fimi/soul/media/player/ISurfaceTextureHolder;

    .line 143
    .local v1, "textureHolder":Lcom/fimi/soul/media/player/ISurfaceTextureHolder;
    iget-object v2, p0, Lcom/fimi/soul/media/player/widget/TextureRenderView$InternalSurfaceHolder;->mTextureView:Lcom/fimi/soul/media/player/widget/TextureRenderView;

    invoke-static {v2}, Lcom/fimi/soul/media/player/widget/TextureRenderView;->access$100(Lcom/fimi/soul/media/player/widget/TextureRenderView;)Lcom/fimi/soul/media/player/widget/TextureRenderView$SurfaceCallback;

    move-result-object v2

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lcom/fimi/soul/media/player/widget/TextureRenderView$SurfaceCallback;->setOwnSurfaceTecture(Z)V

    .line 145
    invoke-interface {v1}, Lcom/fimi/soul/media/player/ISurfaceTextureHolder;->getSurfaceTexture()Landroid/graphics/SurfaceTexture;
    ...
    invoke-virtual {v2, v0}, Lcom/fimi/soul/media/player/widget/TextureRenderView;->setSurfaceTexture(Landroid/graphics/SurfaceTexture;)V

    goto :goto_0

    .line 149
    :cond_1
    iget-object v2, p0, Lcom/fimi/soul/media/player/widget/TextureRenderView$InternalSurfaceHolder;->mSurfaceTexture:Landroid/graphics/SurfaceTexture;

    invoke-interface {v1, v2}, Lcom/fimi/soul/media/player/ISurfaceTextureHolder;->setSurfaceTexture(Landroid/graphics/SurfaceTexture;)V

    goto :goto_0

    .line 152
    .end local v0    # "surfaceTexture":Landroid/graphics/SurfaceTexture;
    .end local v1    # "textureHolder":Lcom/fimi/soul/media/player/ISurfaceTextureHolder;
    :cond_2
    ...
    invoke-interface {p1, v2}, Lcom/fimi/soul/media/player/IMediaPlayer;->setSurface(Landroid/view/Surface;)V
