.class public Lcom/fimi/player/FimiMediaCodecInfo;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_MAX:I

    .line 19
    const/16 v0, 0x320

    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_TESTED:I

    .line 20
    const/16 v0, 0x2bc

    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_ACCEPTABLE:I

    .line 21
    const/16 v0, 0x258

    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_LAST_CHANCE:I

    .line 22
    const/16 v0, 0x12c

    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_SECURE:I

    .line 23
    const/16 v0, 0xc8

    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_SOFTWARE:I

    .line 24
    const/16 v0, 0x64

    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_NON_STANDARD:I

    .line 25
    const/4 v0, 0x0

    sput v0, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_NO_SENSE:I
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/fimi/player/FimiMediaCodecInfo;->mRank:I
...
.method private static declared-synchronized getKnownCodecList()Ljava/util/Map;
    ...
    .prologue
    .line 34
    const-class v1, Lcom/fimi/player/FimiMediaCodecInfo;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/fimi/player/FimiMediaCodecInfo;->sKnownCodecList:Ljava/util/Map;
    ...
    sput-object v0, Lcom/fimi/player/FimiMediaCodecInfo;->sKnownCodecList:Ljava/util/Map;
    ...
    sget v3, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_TESTED:I
    ...
    sget v3, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_SECURE:I
    ...
    sget v3, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_NO_SENSE:I
    ...
    sget v3, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_SOFTWARE:I
...
.method public static getProfileLevelName(II)Ljava/lang/String;
    ...
    .line 219
    invoke-static {p0}, Lcom/fimi/player/FimiMediaCodecInfo;->getProfileName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/fimi/player/FimiMediaCodecInfo;->getLevelName(I)Ljava/lang/String;
...
.method public static setupCandidate(Landroid/media/MediaCodecInfo;Ljava/lang/String;)Lcom/fimi/player/FimiMediaCodecInfo;
    .locals 8
    ...
    .line 139
    sget v5, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_NO_SENSE:I
    ...
    .line 141
    sget v5, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_NON_STANDARD:I

    .line 180
    :goto_1
    new-instance v0, Lcom/fimi/player/FimiMediaCodecInfo;

    invoke-direct {v0}, Lcom/fimi/player/FimiMediaCodecInfo;-><init>()V

    .line 181
    .local v0, "candidate":Lcom/fimi/player/FimiMediaCodecInfo;
    iput-object p0, v0, Lcom/fimi/player/FimiMediaCodecInfo;->mCodecInfo:Landroid/media/MediaCodecInfo;

    .line 182
    iput v5, v0, Lcom/fimi/player/FimiMediaCodecInfo;->mRank:I

    .line 183
    iput-object p1, v0, Lcom/fimi/player/FimiMediaCodecInfo;->mMimeType:Ljava/lang/String;

    goto :goto_0

    .line 142
    .end local v0    # "candidate":Lcom/fimi/player/FimiMediaCodecInfo;
    :cond_2
    ...
    .line 143
    sget v5, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_SOFTWARE:I
    ...
    .line 161
    :cond_9
    sget v5, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_TESTED:I

    goto :goto_1

    .line 163
    :cond_a
    invoke-static {}, Lcom/fimi/player/FimiMediaCodecInfo;->getKnownCodecList()Ljava/util/Map;
    ...
    .line 171
    sget v5, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_ACCEPTABLE:I

    goto :goto_1

    .line 173
    :cond_c
    sget v5, Lcom/fimi/player/FimiMediaCodecInfo;->RANK_LAST_CHANCE:I
    :try_end_0
...
.method public dumpProfileLevels(Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    iget-object v6, p0, Lcom/fimi/player/FimiMediaCodecInfo;->mCodecInfo:Landroid/media/MediaCodecInfo;
    ...
    .line 211
    invoke-static {v3, v2}, Lcom/fimi/player/FimiMediaCodecInfo;->getProfileLevelName(II)Ljava/lang/String;
