.class public Lcom/fimi/player/FimiMediaMeta;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;
    }
.end annotation
...
# instance fields
.field public mAudioStream:Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;
...
.field public mVideoStream:Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;
...
.method public static parse(Landroid/os/Bundle;)Lcom/fimi/player/FimiMediaMeta;
    .locals 11
    .param p0, "mediaMeta"    # Landroid/os/Bundle;
    ...
    .line 173
    :cond_1
    new-instance v2, Lcom/fimi/player/FimiMediaMeta;

    invoke-direct {v2}, Lcom/fimi/player/FimiMediaMeta;-><init>()V

    .line 174
    .local v2, "meta":Lcom/fimi/player/FimiMediaMeta;
    iput-object p0, v2, Lcom/fimi/player/FimiMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    .line 176
    const-string v7, "format"

    invoke-virtual {v2, v7}, Lcom/fimi/player/FimiMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v2, Lcom/fimi/player/FimiMediaMeta;->mFormat:Ljava/lang/String;

    .line 177
    const-string v7, "duration_us"

    invoke-virtual {v2, v7}, Lcom/fimi/player/FimiMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v8

    iput-wide v8, v2, Lcom/fimi/player/FimiMediaMeta;->mDurationUS:J

    .line 178
    const-string v7, "start_us"

    invoke-virtual {v2, v7}, Lcom/fimi/player/FimiMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v8

    iput-wide v8, v2, Lcom/fimi/player/FimiMediaMeta;->mStartUS:J
    ...
    iput-wide v8, v2, Lcom/fimi/player/FimiMediaMeta;->mBitrate:J

    .line 181
    const-string/jumbo v7, "video"

    invoke-virtual {v2, v7, v10}, Lcom/fimi/player/FimiMediaMeta;->getInt(Ljava/lang/String;I)I

    move-result v6

    .line 182
    .local v6, "videoStreamIndex":I
    ...
    .line 185
    invoke-virtual {v2, v7}, Lcom/fimi/player/FimiMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v5

    .line 186
    .local v5, "streams":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/os/Bundle;>;"
    if-eqz v5, :cond_0
    ...
    .line 191
    .local v3, "streamBundle":Landroid/os/Bundle;
    ...
    .line 197
    new-instance v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;

    invoke-direct {v4, v1}, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;-><init>(I)V

    .line 198
    .local v4, "streamMeta":Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;
    iput-object v3, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    .line 199
    const-string/jumbo v8, "type"

    invoke-virtual {v4, v8}, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;

    .line 200
    iget-object v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    .line 208
    const-string v8, "bitrate"

    invoke-virtual {v4, v8}, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v8

    int-to-long v8, v8

    iput-wide v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mHeight:I
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mFpsNum:I
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mFpsDen:I
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mTbrNum:I
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mSarDen:I

    .line 220
    if-ne v6, v1, :cond_2

    .line 221
    iput-object v4, v2, Lcom/fimi/player/FimiMediaMeta;->mVideoStream:Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;
    ...
    iput v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mSampleRate:I

    .line 226
    const-string v8, "channel_layout"

    .line 227
    invoke-virtual {v4, v8}, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v8

    iput-wide v8, v4, Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;->mChannelLayout:J

    .line 229
    if-ne v0, v1, :cond_2

    .line 230
    iput-object v4, v2, Lcom/fimi/player/FimiMediaMeta;->mAudioStream:Lcom/fimi/player/FimiMediaMeta$IjkStreamMeta;
...
.method public getDurationInline()Ljava/lang/String;
    ...
    .line 160
    iget-wide v8, p0, Lcom/fimi/player/FimiMediaMeta;->mDurationUS:J
...
.method public getInt(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1, v0}, Lcom/fimi/player/FimiMediaMeta;->getInt(Ljava/lang/String;I)I
...
.method public getInt(Ljava/lang/String;I)I
    ...
    .prologue
    .line 128
    invoke-virtual {p0, p1}, Lcom/fimi/player/FimiMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getLong(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/fimi/player/FimiMediaMeta;->getLong(Ljava/lang/String;J)J
...
.method public getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 156
    iget-object v0, p0, Lcom/fimi/player/FimiMediaMeta;->mMediaMeta:Landroid/os/Bundle;
