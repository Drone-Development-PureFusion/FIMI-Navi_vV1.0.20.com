...
.method private static moveToTiffEntryWithTag(Ljava/io/InputStream;IZI)I
    ...
    :cond_0
    invoke-static {p0, v8, p2}, Lcom/facebook/imageutils/StreamProcessor;->readPackedInt(Ljava/io/InputStream;IZ)I
...
.method private static readTiffHeader(Ljava/io/InputStream;ILcom/facebook/imageutils/TiffUtil$TiffHeader;)I
    ...
    .restart local p1    # "length":I
    :cond_0
    invoke-static {p0, v4, v2}, Lcom/facebook/imageutils/StreamProcessor;->readPackedInt(Ljava/io/InputStream;IZ)I

    move-result v1

    iput v1, p2, Lcom/facebook/imageutils/TiffUtil$TiffHeader;->byteOrder:I
    ...
    :goto_1
    iput-boolean v1, p2, Lcom/facebook/imageutils/TiffUtil$TiffHeader;->isLittleEndian:Z

    .line 113
    iget-boolean v1, p2, Lcom/facebook/imageutils/TiffUtil$TiffHeader;->isLittleEndian:Z

    invoke-static {p0, v4, v1}, Lcom/facebook/imageutils/StreamProcessor;->readPackedInt(Ljava/io/InputStream;IZ)I

    move-result v1

    iput v1, p2, Lcom/facebook/imageutils/TiffUtil$TiffHeader;->firstIfdOffset:I

    .line 114
    add-int/lit8 p1, p1, -0x4

    .line 115
    iget v1, p2, Lcom/facebook/imageutils/TiffUtil$TiffHeader;->firstIfdOffset:I
