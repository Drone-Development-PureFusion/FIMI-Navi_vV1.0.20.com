...
.method private updateStatsHelper(Landroid/os/StatFs;Ljava/io/File;)Landroid/os/StatFs;
    ...
    .line 286
    .end local p1    # "statfs":Landroid/os/StatFs;
    ...
    .restart local p1    # "statfs":Landroid/os/StatFs;
    :cond_1
    if-nez p1, :cond_2
    ...
    invoke-static {v2}, Lcom/facebook/common/statfs/StatFsHelper;->createStatFs(Ljava/lang/String;)Landroid/os/StatFs;
    ...
    invoke-virtual {p1, v2}, Landroid/os/StatFs;->restat(Ljava/lang/String;)V
    :try_end_0
