...
.method private getTransition(Landroid/support/transition/Scene;)Landroid/support/transition/Transition;
    ...
    .line 142
    iget-object v5, p0, Landroid/support/transition/TransitionManager;->mScenePairTransitions:Landroid/support/v4/util/ArrayMap;
    ...
    .end local v3    # "transition":Landroid/support/transition/Transition;
    .local v4, "transition":Landroid/support/transition/Transition;
    move-object v5, v3
    ...
    .line 152
    .end local v4    # "transition":Landroid/support/transition/Transition;
    :cond_0
    iget-object v5, p0, Landroid/support/transition/TransitionManager;->mSceneTransitions:Landroid/support/v4/util/ArrayMap;
    ...
    .end local v3    # "transition":Landroid/support/transition/Transition;
    .restart local v4    # "transition":Landroid/support/transition/Transition;
    goto :goto_0

    .end local v4    # "transition":Landroid/support/transition/Transition;
    .restart local v3    # "transition":Landroid/support/transition/Transition;
    :cond_1
    sget-object v5, Landroid/support/transition/TransitionManager;->sDefaultTransition:Landroid/support/transition/Transition;
