...
public abstract class ServerSocketListener<T extends Client> implements ServerListener<T> {
    ...
    public T acceptClient() throws IOException {
        ...
        return mo1621createClient(socketAddressToString(accept.getRemoteSocketAddress()), accept);
    }
    ...
    protected abstract T mo1621createClient(String str, Socket socket) throws IOException;
