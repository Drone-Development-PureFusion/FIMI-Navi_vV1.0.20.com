...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    synchronized void rebuildJournal() throws IOException {
        ...
        writer.mo1902writeUtf8(MAGIC).mo1891writeByte(10);
        writer.mo1902writeUtf8("1").mo1891writeByte(10);
        writer.mo1892writeDecimalLong(this.appVersion).mo1891writeByte(10);
        writer.mo1892writeDecimalLong(this.valueCount).mo1891writeByte(10);
        writer.mo1891writeByte(10);
        for (Entry entry : this.lruEntries.values()) {
            if (entry.currentEditor != null) {
                writer.mo1902writeUtf8(DIRTY).mo1891writeByte(32);
                writer.mo1902writeUtf8(entry.key);
                writer.mo1891writeByte(10);
            } else {
                writer.mo1902writeUtf8(CLEAN).mo1891writeByte(32);
                writer.mo1902writeUtf8(entry.key);
    ...
    public synchronized Snapshot get(String key) throws IOException {
        ...
        if (entry == null || !entry.readable) {
            ...
            if (snapshot == null) {
                ...
                this.journalWriter.mo1902writeUtf8(READ).mo1891writeByte(32).mo1902writeUtf8(key).mo1891writeByte(10);
        ...
        synchronized (this) {
            ...
            if ((expectedSequenceNumber == -1 || (entry != null && entry.sequenceNumber == expectedSequenceNumber)) && (entry == null || entry.currentEditor == null)) {
                if (this.mostRecentTrimFailed || this.mostRecentRebuildFailed) {
                    ...
                    this.journalWriter.mo1902writeUtf8(DIRTY).mo1891writeByte(32).mo1902writeUtf8(key).mo1891writeByte(10);
    ...
    synchronized void completeEdit(Editor editor, boolean success) throws IOException {
        ...
        if (entry.readable | success) {
            entry.readable = true;
            this.journalWriter.mo1902writeUtf8(CLEAN).mo1891writeByte(32);
            this.journalWriter.mo1902writeUtf8(entry.key);
            entry.writeLengths(this.journalWriter);
            this.journalWriter.mo1891writeByte(10);
            if (success) {
            ...
            this.journalWriter.mo1902writeUtf8(REMOVE).mo1891writeByte(32);
            this.journalWriter.mo1902writeUtf8(entry.key);
            this.journalWriter.mo1891writeByte(10);
        }
        this.journalWriter.flush();
    ...
    boolean removeEntry(Entry entry) throws IOException {
        ...
        this.redundantOpCount++;
        this.journalWriter.mo1902writeUtf8(REMOVE).mo1891writeByte(32).mo1902writeUtf8(entry.key).mo1891writeByte(10);
        this.lruEntries.remove(entry.key);
        if (journalRebuildRequired()) {
            this.executor.execute(this.cleanupRunnable);
            return true;
    ...
    public final class Entry {
        ...
        Entry(String key) {
            ...
            StringBuilder fileBuilder = new StringBuilder(key).append(CoreConstants.DOT);
        ...
        void writeLengths(BufferedSink writer) throws IOException {
            ...
            for (long length : this.lengths) {
                writer.mo1891writeByte(32).mo1892writeDecimalLong(length);
            }
        }
