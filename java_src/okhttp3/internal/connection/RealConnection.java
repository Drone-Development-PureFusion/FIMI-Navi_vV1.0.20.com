...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Removed duplicated region for block: B:20:0x0081 A[Catch: IOException -> 0x00ce, TRY_LEAVE, TryCatch #1 {IOException -> 0x00ce, blocks: (B:18:0x0079, B:20:0x0081, B:22:0x00b1, B:45:0x00aa), top: B:17:0x0079 }] */
    /* JADX WARN: Removed duplicated region for block: B:27:0x0099  */
    /* JADX WARN: Removed duplicated region for block: B:33:0x011a  */
    /* JADX WARN: Removed duplicated region for block: B:43:? A[RETURN, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:45:0x00aa A[Catch: IOException -> 0x00ce, TRY_ENTER, TryCatch #1 {IOException -> 0x00ce, blocks: (B:18:0x0079, B:20:0x0081, B:22:0x00b1, B:45:0x00aa), top: B:17:0x0079 }] */
    /*
    ...
    */
    ...
    public String toString() {
        return "Connection{" + this.route.address().url().host() + ":" + this.route.address().url().port() + ", proxy=" + this.route.proxy() + " hostAddress=" + this.route.socketAddress() + " cipherSuite=" + (this.handshake != null ? this.handshake.cipherSuite() : "none") + " protocol=" + this.protocol + CoreConstants.CURLY_RIGHT;
    }
}
