...
final class DistinguishedNameParser {
    ...
    public DistinguishedNameParser(X500Principal principal) {
        this.f1465dn = principal.getName("RFC2253");
        this.length = this.f1465dn.length();
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f1465dn);
        }
        this.end = this.pos;
    ...
    private int getByte(int position) {
        ...
        if (position + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f1465dn);
        }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f1465dn.toCharArray();
