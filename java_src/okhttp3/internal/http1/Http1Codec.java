...
public final class Http1Codec implements HttpCodec {
    ...
    public void writeRequest(Headers headers, String requestLine) throws IOException {
        ...
        this.sink.mo1902writeUtf8(requestLine).mo1902writeUtf8("\r\n");
        int size = headers.size();
        for (int i = 0; i < size; i++) {
            this.sink.mo1902writeUtf8(headers.name(i)).mo1902writeUtf8(": ").mo1902writeUtf8(headers.value(i)).mo1902writeUtf8("\r\n");
        }
        this.sink.mo1902writeUtf8("\r\n");
        this.state = 1;
    }
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            if (byteCount != 0) {
                Http1Codec.this.sink.mo1893writeHexadecimalUnsignedLong(byteCount);
                Http1Codec.this.sink.mo1902writeUtf8("\r\n");
                Http1Codec.this.sink.write(source, byteCount);
                Http1Codec.this.sink.mo1902writeUtf8("\r\n");
            }
        }
        ...
        public synchronized void close() throws IOException {
            if (!this.closed) {
                this.closed = true;
                Http1Codec.this.sink.mo1902writeUtf8("0\r\n\r\n");
                Http1Codec.this.detachTimeout(this.timeout);
                Http1Codec.this.state = 3;
            }
        }
