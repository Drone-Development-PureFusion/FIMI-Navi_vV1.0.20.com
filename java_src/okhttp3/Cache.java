...
import okhttp3.internal.p017io.FileSystem;
...
public final class Cache implements Closeable, Flushable {
    ...
    CacheRequest put(Response response) {
        ...
        } else if (!requestMethod.equals(HttpProxyConstants.GET) || HttpHeaders.hasVaryAll(response)) {
            return null;
        } else {
    ...
    public static final class Entry {
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            sink.mo1902writeUtf8(this.url).mo1891writeByte(10);
            sink.mo1902writeUtf8(this.requestMethod).mo1891writeByte(10);
            sink.mo1892writeDecimalLong(this.varyHeaders.size()).mo1891writeByte(10);
            int size = this.varyHeaders.size();
            for (int i = 0; i < size; i++) {
                sink.mo1902writeUtf8(this.varyHeaders.name(i)).mo1902writeUtf8(": ").mo1902writeUtf8(this.varyHeaders.value(i)).mo1891writeByte(10);
            }
            sink.mo1902writeUtf8(new StatusLine(this.protocol, this.code, this.message).toString()).mo1891writeByte(10);
            sink.mo1892writeDecimalLong(this.responseHeaders.size() + 2).mo1891writeByte(10);
            int size2 = this.responseHeaders.size();
            for (int i2 = 0; i2 < size2; i2++) {
                sink.mo1902writeUtf8(this.responseHeaders.name(i2)).mo1902writeUtf8(": ").mo1902writeUtf8(this.responseHeaders.value(i2)).mo1891writeByte(10);
            }
            sink.mo1902writeUtf8(SENT_MILLIS).mo1902writeUtf8(": ").mo1892writeDecimalLong(this.sentRequestMillis).mo1891writeByte(10);
            sink.mo1902writeUtf8(RECEIVED_MILLIS).mo1902writeUtf8(": ").mo1892writeDecimalLong(this.receivedResponseMillis).mo1891writeByte(10);
            if (isHttps()) {
                sink.mo1891writeByte(10);
                sink.mo1902writeUtf8(this.handshake.cipherSuite().javaName()).mo1891writeByte(10);
                writeCertList(sink, this.handshake.peerCertificates());
                writeCertList(sink, this.handshake.localCertificates());
                sink.mo1902writeUtf8(this.handshake.tlsVersion().javaName()).mo1891writeByte(10);
            }
            sink.close();
        }
        ...
        private List<Certificate> readCertificateList(BufferedSource source) throws IOException {
            ...
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    bytes.mo1888write(ByteString.decodeBase64(line));
        ...
        private void writeCertList(BufferedSink sink, List<Certificate> certificates) throws IOException {
            try {
                sink.mo1892writeDecimalLong(certificates.size()).mo1891writeByte(10);
                int size = certificates.size();
                for (int i = 0; i < size; i++) {
                    byte[] bytes = certificates.get(i).getEncoded();
                    String line = ByteString.m32of(bytes).base64();
                    sink.mo1902writeUtf8(line).mo1891writeByte(10);
                }
