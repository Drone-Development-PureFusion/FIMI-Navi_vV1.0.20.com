...
public final class GzipSink implements Sink {
    ...
    private void writeHeader() {
        ...
        buffer.mo1898writeShort(8075);
        buffer.mo1891writeByte(8);
        buffer.mo1891writeByte(0);
        buffer.mo1894writeInt(0);
        buffer.mo1891writeByte(0);
        buffer.mo1891writeByte(0);
    }

    private void writeFooter() throws IOException {
        this.sink.mo1895writeIntLe((int) this.crc.getValue());
        this.sink.mo1895writeIntLe((int) this.deflater.getBytesRead());
    }
