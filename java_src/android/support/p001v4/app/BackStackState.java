...
public final class BackStackState implements Parcelable {
    public static final Parcelable.Creator<BackStackState> CREATOR = new Parcelable.Creator<BackStackState>() { // from class: android.support.v4.app.BackStackState.1
        ...
        public BackStackState mo1502createFromParcel(Parcel in) {
        ...
        public BackStackState[] mo1503newArray(int size) {
    ...
    public BackStackState(BackStackRecord bse) {
        ...
        for (int opNum = 0; opNum < numOps; opNum++) {
            BackStackRecord.C0150Op op = bse.mOps.get(opNum);
            int pos2 = pos + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fm) {
        ...
        while (pos < this.mOps.length) {
            BackStackRecord.C0150Op op = new BackStackRecord.C0150Op();
            int pos2 = pos + 1;
