...
public final class RemoteInput extends RemoteInputCompatBase.RemoteInput {
    ...
    static {
        ...
        FACTORY = new RemoteInputCompatBase.RemoteInput.Factory() { // from class: android.support.v4.app.RemoteInput.1
            ...
            public /* bridge */ /* synthetic */ RemoteInputCompatBase.RemoteInput mo1520build(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z, Bundle bundle, Set set) {
                return mo1520build(str, charSequence, charSequenceArr, z, bundle, (Set<String>) set);
            }

            @Override // android.support.p001v4.app.RemoteInputCompatBase.RemoteInput.Factory
            /* renamed from: build */
            public RemoteInput mo1520build(String resultKey, CharSequence label, CharSequence[] choices, boolean allowFreeFormInput, Bundle extras, Set<String> allowedDataTypes) {
                return new RemoteInput(resultKey, label, choices, allowFreeFormInput, extras, allowedDataTypes);
            }

            @Override // android.support.p001v4.app.RemoteInputCompatBase.RemoteInput.Factory
            /* renamed from: newArray */
            public RemoteInput[] mo1521newArray(int size) {
