...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    ArrayList<C0150Op> mOps = new ArrayList<>();
    ...
    /* loaded from: classes.dex */
    public static final class C0150Op {
        int cmd;
        int enterAnim;
        int exitAnim;
        Fragment fragment;
        ...
        C0150Op(int cmd, Fragment fragment) {
            this.cmd = cmd;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0150Op op = this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
                        cmdStr = ActionConst.NULL;
                        break;
                    case 1:
                        cmdStr = "ADD";
                        break;
    ...
    private void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0150Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0150Op(3, fragment));
        return this;
    }

    @Override // android.support.p001v4.app.FragmentTransaction
    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0150Op(4, fragment));
        return this;
    }

    @Override // android.support.p001v4.app.FragmentTransaction
    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0150Op(5, fragment));
        return this;
    }

    @Override // android.support.p001v4.app.FragmentTransaction
    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0150Op(6, fragment));
        return this;
    }

    @Override // android.support.p001v4.app.FragmentTransaction
    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0150Op(7, fragment));
        return this;
    }

    @Override // android.support.p001v4.app.FragmentTransaction
    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0150Op(8, fragment));
        return this;
    }
            ...
            if (container != 0 && container != lastContainer) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        C0150Op thatOp = record.mOps.get(thoseOpIndex);
            ...
            switch (op.cmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new C0150Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                C0150Op removeOp = new C0150Op(3, old);
                ...
                case 6:
                    ...
                    if (op.fragment == oldPrimaryNav) {
                        this.mOps.add(opNum, new C0150Op(9, op.fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    } else {
                ...
                case 8:
                    this.mOps.add(opNum, new C0150Op(9, oldPrimaryNav));
                    opNum++;
    ...
    private static boolean isFragmentPostponed(C0150Op op) {
