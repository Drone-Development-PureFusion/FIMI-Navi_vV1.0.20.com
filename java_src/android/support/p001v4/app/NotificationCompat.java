...
public class NotificationCompat {
    ...
    static class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        @Override // android.support.p001v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p001v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
            Bundle extras;
    ...
    static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
        ...
        @Override // android.support.p001v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p001v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
    ...
    static class NotificationCompatApi20Impl extends NotificationCompatApi19Impl {
        ...
        @Override // android.support.p001v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p001v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
    ...
    static class NotificationCompatApi21Impl extends NotificationCompatApi20Impl {
        ...
        @Override // android.support.p001v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p001v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
    ...
    static class NotificationCompatApi24Impl extends NotificationCompatApi21Impl {
        ...
        @Override // android.support.p001v4.app.NotificationCompat.NotificationCompatApi21Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p001v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
        ...
        @Override // android.support.p001v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p001v4.app.NotificationCompat.NotificationCompatImpl
        public Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> parcelables) {
    ...
    static class NotificationCompatApi26Impl extends NotificationCompatApi24Impl {
        ...
        @Override // android.support.p001v4.app.NotificationCompat.NotificationCompatApi24Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi21Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p001v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p001v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C0004R.C0007id.notification_background, "setBackgroundResource", C0004R.C0006drawable.notification_bg_low);
                    contentView.setInt(C0004R.C0007id.icon, "setBackgroundResource", C0004R.C0006drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C0004R.C0007id.notification_background, "setBackgroundResource", C0004R.C0006drawable.notification_bg);
                    contentView.setInt(C0004R.C0007id.icon, "setBackgroundResource", C0004R.C0006drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0004R.C0007id.icon, 0);
                    contentView.setImageViewBitmap(C0004R.C0007id.icon, this.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C0004R.C0007id.icon, 8);
                }
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    ...
                    if (Build.VERSION.SDK_INT >= 21) {
                        ...
                        contentView.setImageViewBitmap(C0004R.C0007id.right_icon, smallBit);
                    } else {
                        contentView.setImageViewBitmap(C0004R.C0007id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    contentView.setViewVisibility(C0004R.C0007id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0004R.C0007id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    int backgroundSize2 = res.getDimensionPixelSize(C0004R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0004R.dimen.notification_big_circle_margin);
                    int iconSize2 = res.getDimensionPixelSize(C0004R.dimen.notification_small_icon_size_as_large);
                    ...
                    contentView.setImageViewBitmap(C0004R.C0007id.icon, smallBit2);
                } else {
                    contentView.setImageViewBitmap(C0004R.C0007id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0004R.C0007id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0004R.C0007id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide = Build.VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0004R.C0007id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0004R.C0007id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                int tooBig = res.getInteger(C0004R.integer.status_bar_notification_info_maxnum);
                if (this.mBuilder.mNumber > tooBig) {
                    contentView.setTextViewText(C0004R.C0007id.info, res.getString(C0004R.string.status_bar_notification_info_overflow));
                } else {
                    NumberFormat f = NumberFormat.getIntegerInstance();
                    contentView.setTextViewText(C0004R.C0007id.info, f.format(this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0004R.C0007id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0004R.C0007id.info, 8);
            }
            if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C0004R.C0007id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0004R.C0007id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0004R.C0007id.text2, 0);
                    showLine2 = true;
                } else {
                    contentView.setViewVisibility(C0004R.C0007id.text2, 8);
                }
            }
            if (showLine2 && Build.VERSION.SDK_INT >= 16) {
                if (fitIn1U) {
                    float subTextSize = res.getDimensionPixelSize(C0004R.dimen.notification_subtext_size);
                    contentView.setTextViewTextSize(C0004R.C0007id.text, 0, subTextSize);
                }
                contentView.setViewPadding(C0004R.C0007id.line1, 0, 0, 0, 0);
            }
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (this.mBuilder.mUseChronometer && Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0004R.C0007id.chronometer, 0);
                    contentView.setLong(C0004R.C0007id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(C0004R.C0007id.chronometer, "setStarted", true);
                } else {
                    contentView.setViewVisibility(C0004R.C0007id.time, 0);
                    contentView.setLong(C0004R.C0007id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                hasRightSide = true;
            }
            contentView.setViewVisibility(C0004R.C0007id.right_side, hasRightSide ? 0 : 8);
            contentView.setViewVisibility(C0004R.C0007id.line3, showLine3 ? 0 : 8);
            return contentView;
        }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            int i = C0004R.C0006drawable.notification_icon_background;
            if (color == 0) {
                color = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0004R.C0007id.notification_main_column);
            outerView.addView(C0004R.C0007id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0004R.C0007id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0004R.C0007id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0004R.C0007id.title, 8);
            outerView.setViewVisibility(C0004R.C0007id.text2, 8);
            outerView.setViewVisibility(C0004R.C0007id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0004R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0004R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            remoteViews.removeAllViews(C0004R.C0007id.actions);
            ...
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0004R.C0007id.actions, button);
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
            }
            remoteViews.setViewVisibility(C0004R.C0007id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0004R.C0007id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            button.setImageViewBitmap(C0004R.C0007id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0004R.C0005color.notification_action_color_filter)));
            button.setTextViewText(C0004R.C0007id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0004R.C0007id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0004R.C0007id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static class Action extends NotificationCompatBase.Action {
        ...
        public static final NotificationCompatBase.Action.Factory FACTORY = new NotificationCompatBase.Action.Factory() { // from class: android.support.v4.app.NotificationCompat.Action.1
            ...
            public Action[] mo1515newArray(int length) {
        ...
        public RemoteInput[] mo1514getRemoteInputs() {
            return this.mRemoteInputs;
        }

        @Override // android.support.p001v4.app.NotificationCompatBase.Action
        /* renamed from: getDataOnlyRemoteInputs */
        public RemoteInput[] mo1513getDataOnlyRemoteInputs() {
        ...
        public static final class Builder {
            ...
            public Builder(Action action) {
                this(action.icon, action.title, action.actionIntent, new Bundle(action.mExtras), action.mo1514getRemoteInputs(), action.getAllowGeneratedReplies());
            }
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m1516clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m1519clone() {
            WearableExtender that = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends NotificationCompatBase.UnreadConversation {
            static final NotificationCompatBase.UnreadConversation.Factory FACTORY = new NotificationCompatBase.UnreadConversation.Factory() { // from class: android.support.v4.app.NotificationCompat.CarExtender.UnreadConversation.1
                @Override // android.support.p001v4.app.NotificationCompatBase.UnreadConversation.Factory
                /* renamed from: build */
                public UnreadConversation mo1518build(String[] messages, RemoteInputCompatBase.RemoteInput remoteInput, PendingIntent replyPendingIntent, PendingIntent readPendingIntent, String[] participants, long latestTimestamp) {
            ...
            @Override // android.support.p001v4.app.NotificationCompatBase.UnreadConversation
            ...
            public RemoteInput mo1517getRemoteInput() {
