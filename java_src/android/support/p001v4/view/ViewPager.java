...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v4.view.ViewPager.SavedState.1
            ...
            public SavedState mo1553createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo1552createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo1554newArray(int size) {
    ...
    public boolean canScrollHorizontally(int direction) {
        ...
        int scrollX = getScrollX();
        if (direction < 0) {
            if (scrollX <= ((int) (width * this.mFirstOffset))) {
                z = false;
            }
            return z;
        } else if (direction <= 0) {
            ...
            if (scrollX >= ((int) (width * this.mLastOffset))) {
                z = false;
            }
            return z;
        }
