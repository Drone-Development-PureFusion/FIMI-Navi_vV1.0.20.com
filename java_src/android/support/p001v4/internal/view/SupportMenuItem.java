...
public interface SupportMenuItem extends MenuItem {
    ...
    MenuItem mo1577setActionView(int i);

    @Override // android.view.MenuItem
    /* renamed from: setActionView */
    MenuItem mo1578setActionView(View view);
    ...
    SupportMenuItem mo1579setContentDescription(CharSequence charSequence);
    ...
    MenuItem mo1580setShowAsActionFlags(int i);

    SupportMenuItem setSupportActionProvider(ActionProvider actionProvider);

    @Override // android.view.MenuItem
    /* renamed from: setTooltipText */
    SupportMenuItem mo1581setTooltipText(CharSequence charSequence);
}
