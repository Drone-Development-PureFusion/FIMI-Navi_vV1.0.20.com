...
public class ImageViewCompat {
    ...
    static class BaseViewCompatImpl implements ImageViewCompatImpl {
        ...
        @Override // android.support.p001v4.widget.ImageViewCompat.ImageViewCompatImpl
    ...
    static class LollipopViewCompatImpl extends BaseViewCompatImpl {
        ...
        @Override // android.support.p001v4.widget.ImageViewCompat.BaseViewCompatImpl, android.support.p001v4.widget.ImageViewCompat.ImageViewCompatImpl
        public ColorStateList getImageTintList(ImageView view) {
