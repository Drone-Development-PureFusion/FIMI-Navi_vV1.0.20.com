...
public final class DrawableCompat {
    ...
    static class DrawableCompatApi17Impl extends DrawableCompatBaseImpl {
        ...
        @Override // android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public boolean setLayoutDirection(Drawable drawable, int layoutDirection) {
    ...
    static class DrawableCompatApi21Impl extends DrawableCompatApi19Impl {
        ...
        @Override // android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatApi19Impl, android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public Drawable wrap(Drawable drawable) {
            if (!(drawable instanceof TintAwareDrawable)) {
    ...
    static class DrawableCompatApi23Impl extends DrawableCompatApi21Impl {
        ...
        @Override // android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatApi17Impl, android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public boolean setLayoutDirection(Drawable drawable, int layoutDirection) {
        ...
        @Override // android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatApi21Impl, android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatApi19Impl, android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public Drawable wrap(Drawable drawable) {
            return drawable;
        }

        @Override // android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatApi21Impl, android.support.p001v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public void clearColorFilter(Drawable drawable) {
            drawable.clearColorFilter();
        }
    }
