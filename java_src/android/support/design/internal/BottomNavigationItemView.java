...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0016R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0016R.C0019drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0016R.C0020id.icon);
        this.mSmallLabel = (TextView) findViewById(C0016R.C0020id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0016R.C0020id.largeLabel);
    }
