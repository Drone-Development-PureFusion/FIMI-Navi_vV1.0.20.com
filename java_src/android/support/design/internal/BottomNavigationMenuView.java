...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attrs) {
        ...
        this.mSet.mo1498setDuration(ACTIVE_ANIMATION_DURATION_MS);
        this.mSet.mo1499setInterpolator((TimeInterpolator) new FastOutSlowInInterpolator());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSpec = View.MeasureSpec.makeMeasureSpec(this.mItemHeight, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(View.MeasureSpec.makeMeasureSpec(this.mTempChildWidths[i3], NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), heightSpec);
                ViewGroup.LayoutParams params = child.getLayoutParams();
                params.width = child.getMeasuredWidth();
                totalWidth += child.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(totalWidth, View.MeasureSpec.makeMeasureSpec(totalWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), 0), View.resolveSizeAndState(this.mItemHeight, heightSpec, 0));
    }
