...
public class SnackbarContentLayout extends LinearLayout implements BaseTransientBottomBar.ContentViewCallback {
    ...
    protected void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C0016R.C0020id.snackbar_text);
        this.mActionView = (Button) findViewById(C0016R.C0020id.snackbar_action);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mMaxWidth > 0 && getMeasuredWidth() > this.mMaxWidth) {
            widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mMaxWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        }
