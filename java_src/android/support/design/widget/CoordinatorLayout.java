...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    static Behavior parseBehavior(Context context, AttributeSet attrs, String name) {
        ...
        if (name.startsWith(".")) {
            ...
            fullName = !TextUtils.isEmpty(WIDGET_PACKAGE_NAME) ? WIDGET_PACKAGE_NAME + CoreConstants.DOT + name : name;
        }
        try {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = View.resolveSizeAndState(widthUsed, widthMeasureSpec, (-16777216) & childState);
    ...
    */
    ...
    public LayoutParams mo1473generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo1474generateLayoutParams(ViewGroup.LayoutParams p) {
    ...
    public LayoutParams mo1472generateDefaultLayoutParams() {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.design.widget.CoordinatorLayout.SavedState.1
            ...
            public SavedState mo1476createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo1475createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo1477newArray(int size) {
