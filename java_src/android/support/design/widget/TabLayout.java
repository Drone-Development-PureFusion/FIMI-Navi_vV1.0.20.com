...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0345R.styleable.TextAppearance);
        try {
            this.mTabTextSize = ta.getDimensionPixelSize(C0345R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0345R.styleable.TextAppearance_android_textColor);
            ta.recycle();
            ...
            if (a.hasValue(C0016R.styleable.TabLayout_tabSelectedTextColor)) {
                int selected = a.getColor(C0016R.styleable.TabLayout_tabSelectedTextColor, 0);
            ...
            this.mTabTextMultiLineSize = res.getDimensionPixelSize(C0016R.dimen.design_tab_text_size_2line);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (View.MeasureSpec.getMode(heightMeasureSpec)) {
            case Integer.MIN_VALUE:
                heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(idealHeight, View.MeasureSpec.getSize(heightMeasureSpec)), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                break;
            case 0:
                heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(idealHeight, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                break;
        }
        ...
        if (getChildCount() == 1) {
            ...
            if (remeasure) {
                ...
                int childWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
    ...
    public class TabView extends LinearLayout {
        ...
        final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C0016R.layout.design_layout_tab_icon, (ViewGroup) this, false);
                    addView(iconView, 0);
                    this.mIconView = iconView;
                }
                if (this.mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0016R.layout.design_layout_tab_text, (ViewGroup) this, false);
                    addView(textView);
    ...
    public class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.support.design.widget.TabLayout.SlidingTabStrip.1
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                ...
                animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.design.widget.TabLayout.SlidingTabStrip.2
