...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0016R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, a.getDimensionPixelSize(C0016R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C0016R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C0016R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C0016R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C0016R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        a.recycle();
    ...
    public LayoutParams mo1453generateDefaultLayoutParams() {
        return new LayoutParams(-1, -2);
    }

    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo1456generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.widget.LinearLayout, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo1457generateLayoutParams(ViewGroup.LayoutParams p) {
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[1] = (!this.mCollapsible || !this.mCollapsed) ? -C0016R.attr.state_collapsed : C0016R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            if (a.hasValue(C0016R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(C0016R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        public static class SavedState extends AbsSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.design.widget.AppBarLayout.Behavior.SavedState.1
                ...
                public SavedState mo1459createFromParcel(Parcel source, ClassLoader loader) {
                    return new SavedState(source, loader);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: createFromParcel */
                public SavedState mo1458createFromParcel(Parcel source) {
                    return new SavedState(source, null);
                }

                @Override // android.os.Parcelable.Creator
                /* renamed from: newArray */
                public SavedState[] mo1460newArray(int size) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        /* bridge */ /* synthetic */ View mo1461findFirstDependency(List list) {
            return mo1461findFirstDependency((List<View>) list);
        }
        ...
        public boolean onRequestChildRectangleOnScreen(CoordinatorLayout parent, View child, Rect rectangle, boolean immediate) {
            AppBarLayout header = mo1461findFirstDependency(parent.getDependencies(child));
            if (header != null) {
        ...
        AppBarLayout mo1461findFirstDependency(List<View> views) {
            int z = views.size();
            for (int i = 0; i < z; i++) {
