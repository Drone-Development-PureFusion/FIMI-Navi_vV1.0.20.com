...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        ...
        this.mView = (SnackbarBaseLayout) inflater.inflate(C0016R.layout.design_layout_snackbar, this.mTargetParent, false);
    ...
    void animateViewIn() {
        ...
        Animation anim = android.view.animation.AnimationUtils.loadAnimation(this.mView.getContext(), C0016R.C0017anim.design_snackbar_in);
    ...
    private void animateViewOut(final int event) {
        ...
        Animation anim = android.view.animation.AnimationUtils.loadAnimation(this.mView.getContext(), C0016R.C0017anim.design_snackbar_out);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250L);
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            if (a.hasValue(C0016R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, a.getDimensionPixelSize(C0016R.styleable.SnackbarLayout_elevation, 0));
            }
            a.recycle();
            setClickable(true);
        }
