...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0345R.attr.imageButtonStyle);
    }
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        return this.mChecked ? mergeDrawableStates(super.onCreateDrawableState(DRAWABLE_STATE_CHECKED.length + extraSpace), DRAWABLE_STATE_CHECKED) : super.onCreateDrawableState(extraSpace);
    }
}
