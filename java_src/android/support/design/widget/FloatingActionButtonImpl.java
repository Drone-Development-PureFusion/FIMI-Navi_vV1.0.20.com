...
public class FloatingActionButtonImpl {
    ...
    public CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0016R.C0018color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0016R.C0018color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0016R.C0018color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0016R.C0018color.design_fab_stroke_end_outer_color));
