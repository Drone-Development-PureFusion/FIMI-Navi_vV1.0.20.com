...
class FloatingActionButtonLollipop extends FloatingActionButtonImpl {
    ...
    public FloatingActionButtonLollipop(VisibilityAwareImageButton view, ShadowViewDelegate shadowViewDelegate) {
    ...
    void onElevationsChanged(float elevation, float pressedTranslationZ) {
        if (Build.VERSION.SDK_INT == 21) {
            ...
            animators.add(ObjectAnimator.ofFloat(this.mView, "elevation", elevation).setDuration(0L));
            if (Build.VERSION.SDK_INT >= 22 && Build.VERSION.SDK_INT <= 24) {
                animators.add(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, this.mView.getTranslationZ()).setDuration(100L));
            }
            animators.add(ObjectAnimator.ofFloat(this.mView, View.TRANSLATION_Z, 0.0f).setDuration(100L));
