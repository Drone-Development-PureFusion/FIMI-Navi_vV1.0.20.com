...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0016R.styleable.NavigationView_elevation)) {
            ViewCompat.setElevation(this, a.getDimensionPixelSize(C0016R.styleable.NavigationView_elevation, 0));
        }
        ...
        itemTextColor = a.hasValue(C0016R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(C0016R.styleable.NavigationView_itemTextColor) : itemTextColor;
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        switch (View.MeasureSpec.getMode(widthSpec)) {
            case Integer.MIN_VALUE:
                widthSpec = View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(widthSpec), this.mMaxWidth), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                break;
            case 0:
                widthSpec = View.MeasureSpec.makeMeasureSpec(this.mMaxWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                break;
        }
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0345R.attr.colorPrimary, value, true)) {
            return null;
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.design.widget.NavigationView.SavedState.1
            ...
            public SavedState mo1479createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo1478createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo1480newArray(int size) {
