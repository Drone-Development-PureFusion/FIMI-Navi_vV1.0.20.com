...
class TransitionUtils {
    ...
    public static View copyViewImage(ViewGroup sceneRoot, View view, View parent) {
        ...
        int widthSpec = View.MeasureSpec.makeMeasureSpec(right - left, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
        int heightSpec = View.MeasureSpec.makeMeasureSpec(bottom - top, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
