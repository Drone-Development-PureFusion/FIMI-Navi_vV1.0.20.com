...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition transitionClone = transition.m1486clone();
            transitionClone.mo1500setSceneRoot(sceneRoot);
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            if (TransitionManager.sPendingTransitions.remove(this.mSceneRoot)) {
                ...
                this.mTransition.mo1487addListener(new TransitionListenerAdapter() { // from class: android.support.transition.TransitionManager.MultiListener.1
    ...
    /* renamed from: go */
    public static void m1441go(@NonNull Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m1440go(@NonNull Scene scene, @Nullable Transition transition) {
