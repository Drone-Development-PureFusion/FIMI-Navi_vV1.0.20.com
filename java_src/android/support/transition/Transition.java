...
public abstract class Transition implements Cloneable {
    ...
    public Transition mo1498setDuration(long duration) {
    ...
    public Transition mo1501setStartDelay(long startDelay) {
    ...
    public Transition mo1499setInterpolator(@Nullable TimeInterpolator interpolator) {
    ...
    public Transition mo1489addTarget(@NonNull View target) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo1488addTarget(@IdRes int targetId) {
        if (targetId > 0) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo1491addTarget(@NonNull String targetName) {
    ...
    @NonNull
    /* renamed from: addTarget */
    public Transition mo1490addTarget(@NonNull Class targetType) {
        if (this.mTargetTypes == null) {
    ...
    public Transition mo1495removeTarget(@NonNull View target) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo1494removeTarget(@IdRes int targetId) {
        if (targetId > 0) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo1497removeTarget(@NonNull String targetName) {
        if (this.mTargetNames != null) {
    ...
    @NonNull
    /* renamed from: removeTarget */
    public Transition mo1496removeTarget(@NonNull Class target) {
        if (this.mTargetTypes != null) {
    ...
    public Transition mo1487addListener(@NonNull TransitionListener listener) {
    ...
    public Transition mo1493removeListener(@NonNull TransitionListener listener) {
        if (this.mListeners != null) {
    ...
    public Transition mo1500setSceneRoot(ViewGroup sceneRoot) {
