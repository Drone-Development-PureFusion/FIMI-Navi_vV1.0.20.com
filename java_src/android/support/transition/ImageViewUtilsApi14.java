...
class ImageViewUtilsApi14 implements ImageViewUtilsImpl {
    ...
    public void startAnimateTransform(ImageView view) {
        ...
        view.setTag(C0124R.C0127id.save_scale_type, scaleType);
        if (scaleType == ImageView.ScaleType.MATRIX) {
            view.setTag(C0124R.C0127id.save_image_matrix, view.getImageMatrix());
        } else {
    ...
    public void reserveEndAnimateTransform(final ImageView view, Animator animator) {
        animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.transition.ImageViewUtilsApi14.1
            ...
            public void onAnimationEnd(Animator animation) {
                ImageView.ScaleType scaleType = (ImageView.ScaleType) view.getTag(C0124R.C0127id.save_scale_type);
                view.setScaleType(scaleType);
                view.setTag(C0124R.C0127id.save_scale_type, null);
                if (scaleType == ImageView.ScaleType.MATRIX) {
                    view.setImageMatrix((Matrix) view.getTag(C0124R.C0127id.save_image_matrix));
                    view.setTag(C0124R.C0127id.save_image_matrix, null);
                }
