...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0345R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0345R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0345R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0345R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0345R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0345R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0345R.styleable.ActionMode_closeItemLayout, C0345R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            ...
            inflater.inflate(C0345R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0345R.C0349id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0345R.C0349id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        View closeButton = this.mClose.findViewById(C0345R.C0349id.action_mode_close_button);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mCustomView != null) {
            ...
            int customWidthMode = lp2.width != -2 ? NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE : Integer.MIN_VALUE;
            int customWidth = lp2.width >= 0 ? Math.min(lp2.width, availableWidth) : availableWidth;
            int customHeightMode = lp2.height != -2 ? NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE : Integer.MIN_VALUE;
