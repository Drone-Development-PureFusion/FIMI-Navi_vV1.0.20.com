...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0350R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0350R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0350R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0350R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                StateListDrawable verticalThumbDrawable = (StateListDrawable) a2.getDrawable(C0350R.styleable.RecyclerView_fastScrollVerticalThumbDrawable);
                Drawable verticalTrackDrawable = a2.getDrawable(C0350R.styleable.RecyclerView_fastScrollVerticalTrackDrawable);
                StateListDrawable horizontalThumbDrawable = (StateListDrawable) a2.getDrawable(C0350R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable);
                Drawable horizontalTrackDrawable = a2.getDrawable(C0350R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return !className.contains(".") ? RecyclerView.class.getPackage().getName() + CoreConstants.DOT + className : className;
    }
        ...
        if (this.mLayout == null) {
            ...
            if (!skipMeasure && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
    ...
    */
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public abstract VH mo1873onCreateViewHolder(ViewGroup viewGroup, int i);
        ...
        public final VH createViewHolder(ViewGroup parent, int viewType) {
            ...
            VH holder = mo1873onCreateViewHolder(parent, viewType);
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE;
            this.mHeightMode = NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE;
        }
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE;
                } else {
                    resultSize = 0;
                    resultMode = 0;
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0350R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0350R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0350R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0350R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0350R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE));
        }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0350R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0350R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0350R.dimen.fastscroll_margin));
    }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v7.widget.RecyclerView.SavedState.1
            ...
            public SavedState mo1595createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo1594createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo1596newArray(int size) {
