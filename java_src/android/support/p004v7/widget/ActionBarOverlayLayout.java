...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0345R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = ScribeConfig.DEFAULT_SEND_INTERVAL_SECONDS;
    ...
    public LayoutParams mo1583generateDefaultLayoutParams() {
        return new LayoutParams(-1, -1);
    }

    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo1584generateLayoutParams(AttributeSet attrs) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0345R.C0349id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0345R.C0349id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0345R.C0349id.action_bar));
        }
    }
