...
public class ContentFrameLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (tvw != null && tvw.type != 0) {
                ...
                if (w > 0) {
                    ...
                    widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(w - (this.mDecorPadding.left + this.mDecorPadding.right), widthSize), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (tvh != null && tvh.type != 0) {
                ...
                if (h > 0) {
                    ...
                    heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(h - (this.mDecorPadding.top + this.mDecorPadding.bottom), heightSize), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                }
            }
        }
        ...
        int widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(width, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
        if (!fixedWidth && widthMode == Integer.MIN_VALUE) {
            ...
            if (tv != null && tv.type != 0) {
                ...
                if (width < min) {
                    widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(min, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                    measure = true;
                }
            }
        }
