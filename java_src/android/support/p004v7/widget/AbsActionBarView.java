...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (context.getTheme().resolveAttribute(C0345R.attr.actionBarPopupTheme, tv, true) && tv.resourceId != 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0345R.styleable.ActionBar, C0345R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0345R.styleable.ActionBar_height, 0));
        a.recycle();
