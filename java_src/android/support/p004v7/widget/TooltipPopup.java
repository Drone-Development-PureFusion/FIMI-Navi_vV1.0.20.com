...
class TooltipPopup {
    ...
    public TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0345R.layout.tooltip, (ViewGroup) null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0345R.C0349id.message);
        ...
        this.mLayoutParams.windowAnimations = C0345R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, WindowManager.LayoutParams outParams) {
        ...
        int offsetAbove;
        int statusBarHeight;
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0345R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra = this.mContext.getResources().getDimensionPixelOffset(C0345R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0345R.dimen.tooltip_y_offset_touch : C0345R.dimen.tooltip_y_offset_non_touch);
        ...
        if (this.mTmpDisplayFrame.left < 0 && this.mTmpDisplayFrame.top < 0) {
            ...
            int resourceId = res.getIdentifier("status_bar_height", "dimen", SyndicatedSdkImpressionEvent.CLIENT_NAME);
            if (resourceId != 0) {
