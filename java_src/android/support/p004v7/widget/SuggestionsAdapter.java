...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    @Override // android.support.p001v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.Adapter
    ...
    @Override // android.support.p001v4.widget.ResourceCursorAdapter, android.support.p001v4.widget.CursorAdapter
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        View v = super.newView(context, cursor, parent);
        v.setTag(new ChildViewCache(v));
        ImageView iconRefine = (ImageView) v.findViewById(C0345R.C0349id.edit_query);
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0345R.C0349id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0345R.attr.textColorSearchUrl, colorValue, true);
    ...
    @Override // android.support.p001v4.widget.CursorAdapter, android.widget.Adapter
    ...
    @Override // android.support.p001v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.SpinnerAdapter
