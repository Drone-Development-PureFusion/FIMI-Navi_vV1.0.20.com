...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0345R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0345R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        int layoutResId = a.getResourceId(C0345R.styleable.SearchView_layout, C0345R.layout.abc_search_view);
        inflater.inflate(layoutResId, (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0345R.C0349id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0345R.C0349id.search_edit_frame);
        this.mSearchPlate = findViewById(C0345R.C0349id.search_plate);
        this.mSubmitArea = findViewById(C0345R.C0349id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0345R.C0349id.search_button);
        this.mGoButton = (ImageView) findViewById(C0345R.C0349id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0345R.C0349id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0345R.C0349id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0345R.C0349id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0345R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0345R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0345R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0345R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0345R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0345R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0345R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0345R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0345R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0345R.styleable.SearchView_suggestionRowLayout, C0345R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0345R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0345R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0345R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0345R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0345R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0345R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0345R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        boolean focusable = a.getBoolean(C0345R.styleable.SearchView_android_focusable, true);
        setFocusable(focusable);
        a.recycle();
        this.mVoiceWebSearchIntent = new Intent("android.speech.action.WEB_SEARCH");
        this.mVoiceWebSearchIntent.addFlags(NTLMConstants.FLAG_UNIDENTIFIED_11);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(NTLMConstants.FLAG_UNIDENTIFIED_11);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(width, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), View.MeasureSpec.makeMeasureSpec(height, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE));
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0345R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0345R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void onActionViewExpanded() {
        if (!this.mExpandedInActionView) {
            ...
            this.mSearchSrcTextView.setImeOptions(this.mCollapsedImeOptions | NTLMConstants.FLAG_UNIDENTIFIED_8);
            this.mSearchSrcTextView.setText("");
            setIconified(false);
        }
    }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: android.support.v7.widget.SearchView.SavedState.1
            ...
            public SavedState mo1598createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo1597createFromParcel(Parcel in) {
                return new SavedState(in, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo1599newArray(int size) {
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0345R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0345R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0345R.attr.autoCompleteTextViewStyle);
        }
