...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
        ...
        if (needsExpansion) {
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                if (lp5.expanded) {
                    ...
                    child4.measure(View.MeasureSpec.makeMeasureSpec(width, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), itemHeightSpec);
                }
            }
        }
    ...
    public static int measureChildForCells(View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        ...
        child.measure(View.MeasureSpec.makeMeasureSpec(targetWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), childHeightSpec);
        return cellsUsed;
    }
    ...
    public LayoutParams mo1587generateDefaultLayoutParams() {
    ...
    public LayoutParams mo1588generateLayoutParams(AttributeSet attrs) {
    ...
    @Override // android.support.p004v7.widget.LinearLayoutCompat, android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public LayoutParams mo1589generateLayoutParams(ViewGroup.LayoutParams p) {
        if (p != null) {
        ...
        return mo1587generateDefaultLayoutParams();
    }
    ...
    public LayoutParams generateOverflowButtonLayoutParams() {
        LayoutParams result = mo1587generateDefaultLayoutParams();
