...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0345R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0345R.attr.actionDropDownStyle);
    ...
    public class TabView extends LinearLayoutCompat {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean forList) {
            super(context, null, C0345R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0345R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), heightMeasureSpec);
            }
        }
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0345R.attr.actionBarTabTextStyle);
