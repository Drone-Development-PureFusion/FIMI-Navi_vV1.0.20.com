    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0345R.C0349id.topPanel) {
                    topPanel = child;
                } else if (id == C0345R.C0349id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0345R.C0349id.contentPanel && id != C0345R.C0349id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
        ...
        if (buttonPanel != null) {
            ...
            int childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(buttonHeight, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
