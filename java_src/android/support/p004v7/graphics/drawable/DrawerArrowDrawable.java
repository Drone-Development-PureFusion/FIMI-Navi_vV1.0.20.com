...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0345R.styleable.DrawerArrowToggle, C0345R.attr.drawerArrowStyle, C0345R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0345R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C0345R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C0345R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize(Math.round(a.getDimension(C0345R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0345R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = Math.round(a.getDimension(C0345R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = Math.round(a.getDimension(C0345R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C0345R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
    ...
    public void setProgress(@FloatRange(from = 0.0d, m1443to = 1.0d) float progress) {
