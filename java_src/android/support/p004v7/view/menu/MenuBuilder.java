...
public class MenuBuilder implements SupportMenu {
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        boolean z = true;
        if (!shortcutsVisible || this.mResources.getConfiguration().keyboard == 1 || !this.mResources.getBoolean(C0345R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent)) {
            z = false;
        }
    ...
    void findItemsWithShortcutForKey(List<MenuItemImpl> items, int keyCode, KeyEvent event) {
        ...
        if (isKeyCodeMapped || keyCode == 67) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                boolean isModifiersExactMatch = (69647 & modifierState) == (69647 & shortcutModifiers);
