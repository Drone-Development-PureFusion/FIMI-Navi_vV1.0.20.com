...
public class MenuAdapter extends BaseAdapter {
    static final int ITEM_LAYOUT = C0345R.layout.abc_popup_menu_item_layout;
    ...
    public MenuItemImpl mo1576getItem(int position) {
        ArrayList<MenuItemImpl> items = this.mOverflowOnly ? this.mAdapterMenu.getNonActionItems() : this.mAdapterMenu.getVisibleItems();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        itemView.initialize(mo1576getItem(position), 0);
        return convertView;
    }
