...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public MenuItem setShowAsActionFlags(int actionEnum) {
        ((SupportMenuItem) this.mWrappedObject).mo1580setShowAsActionFlags(actionEnum);
        return this;
    }
    ...
    public MenuItem setActionView(View view) {
        ...
        ((SupportMenuItem) this.mWrappedObject).mo1578setActionView(view);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setActionView(int resId) {
        ((SupportMenuItem) this.mWrappedObject).mo1577setActionView(resId);
        View actionView = ((SupportMenuItem) this.mWrappedObject).getActionView();
        if (actionView instanceof CollapsibleActionView) {
            ((SupportMenuItem) this.mWrappedObject).mo1578setActionView(new CollapsibleActionViewWrapper(actionView));
        }
        return this;
    }
    ...
    public MenuItem setContentDescription(CharSequence contentDescription) {
        ((SupportMenuItem) this.mWrappedObject).mo1579setContentDescription(contentDescription);
        return this;
    }
    ...
    public MenuItem setTooltipText(CharSequence tooltipText) {
        ((SupportMenuItem) this.mWrappedObject).mo1581setTooltipText(tooltipText);
        return this;
    }
    ...
    /* loaded from: classes.dex */
    public class ActionProviderWrapper extends android.support.p001v4.view.ActionProvider {
