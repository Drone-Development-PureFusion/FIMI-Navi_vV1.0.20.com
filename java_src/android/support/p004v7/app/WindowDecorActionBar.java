...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new ViewPropertyAnimatorUpdateListener() { // from class: android.support.v7.app.WindowDecorActionBar.3
        @Override // android.support.p001v4.view.ViewPropertyAnimatorUpdateListener
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0345R.C0349id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0345R.C0349id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0345R.C0349id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0345R.C0349id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0345R.styleable.ActionBar, C0345R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0345R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0345R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    @Override // android.support.p004v7.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            currentTheme.resolveAttribute(C0345R.attr.actionBarWidgetTheme, outValue, true);
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        @Override // android.support.p004v7.app.ActionBar.Tab
