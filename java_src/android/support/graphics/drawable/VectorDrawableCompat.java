...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VFullPath extends VPath {
        ...
        private Paint.Cap getStrokeLineCap(int id, Paint.Cap defValue) {
            switch (id) {
                case 0:
                    Paint.Cap defValue2 = Paint.Cap.BUTT;
                    return defValue2;
                case 1:
                    Paint.Cap defValue3 = Paint.Cap.ROUND;
                    return defValue3;
                case 2:
                    Paint.Cap defValue4 = Paint.Cap.SQUARE;
                    return defValue4;
                default:
                    return defValue;
            }
        ...
        private Paint.Join getStrokeLineJoin(int id, Paint.Join defValue) {
            switch (id) {
                case 0:
                    Paint.Join defValue2 = Paint.Join.MITER;
                    return defValue2;
                case 1:
                    Paint.Join defValue3 = Paint.Join.ROUND;
                    return defValue3;
                case 2:
                    Paint.Join defValue4 = Paint.Join.BEVEL;
                    return defValue4;
                default:
                    return defValue;
            }
