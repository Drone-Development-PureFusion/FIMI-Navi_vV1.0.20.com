...
/* renamed from: com.fimi.app.ui.SplashActivity */
...
public class SplashActivity extends BaseActivity {
    ...
    /* JADX WARN: Type inference failed for: r3v10, types: [com.fimi.app.ui.SplashActivity$2] */
    @Override // com.fimi.kernel.base.BaseActivity
    public void doTrans() {
        ...
        ThreadUtils.execute(new Runnable() { // from class: com.fimi.app.ui.SplashActivity.1
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 0) {
                    if (Constants.productType == ProductEnum.X9) {
                        Intent it = (Intent) Router.invoke(SplashActivity.this.mContext, "service://x9.recordupload");
                        SplashActivity.this.mContext.startService(it);
                    } else if (Constants.productType == ProductEnum.GH2) {
                        Intent it2 = (Intent) Router.invoke(SplashActivity.this.mContext, "service://gh2.recordupload");
    ...
    public void getFwDetail() {
        ...
        x9FwManager.getX9FwNetDetail(new DisposeDataHandle(new DisposeDataListener() { // from class: com.fimi.app.ui.SplashActivity.3
