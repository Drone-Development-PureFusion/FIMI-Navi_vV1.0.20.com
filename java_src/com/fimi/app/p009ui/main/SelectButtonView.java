...
/* renamed from: com.fimi.app.ui.main.SelectButtonView */
...
public class SelectButtonView extends FrameLayout {
    ...
    public void initView(int length) {
        ...
        for (int i = 0; i < length; i++) {
            LinearLayout.LayoutParams btnLayoutParams = new LinearLayout.LayoutParams(DensityUtil.dip2px(this.mContext, 13.0f), DensityUtil.dip2px(this.mContext, 3.0f));
