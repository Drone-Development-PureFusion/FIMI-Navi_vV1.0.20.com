...
public class GglMapCustomMarkerView extends AbsMapCustomMarkerView {
    public BitmapDescriptor createCustomMarkerViewForP2P(Context context, int res, float heightVale, int npos) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_custom_mark_view_for_point, (ViewGroup) null);
        TextView heightView = (TextView) view.findViewById(C0885R.C0889id.point_heightValue);
        String s = X8NumberUtil.getDistanceNumberString(heightVale, 0, true);
        heightView.setText(s);
        ImageView imageView = (ImageView) view.findViewById(C0885R.C0889id.markerIcon);
        if (res != 0) {
    ...
    public BitmapDescriptor createCustomMarkerView(Context context, int res, float heightVale, int npos) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_custom_mark_view, (ViewGroup) null);
        TextView heightView = (TextView) view.findViewById(C0885R.C0889id.point_heightValue);
        TextView tvPos = (TextView) view.findViewById(C0885R.C0889id.tv_pos);
        tvPos.setText("" + npos);
        String s = X8NumberUtil.getDistanceNumberString(heightVale, 0, true);
        heightView.setText(s);
        ImageView imageView = (ImageView) view.findViewById(C0885R.C0889id.markerIcon);
    ...
    @Override // com.fimi.app.x8s.map.view.AbsMapCustomMarkerView
    /* renamed from: createCustomMarkerView2 */
    public BitmapDescriptor mo1770createCustomMarkerView2(Context context, int res, int nPos) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_custom_mark_view2, (ViewGroup) null);
        TextView heightView = (TextView) view.findViewById(C0885R.C0889id.point_heightValue);
    ...
    @Override // com.fimi.app.x8s.map.view.AbsMapCustomMarkerView
    /* renamed from: createCustomMarkerView */
    public BitmapDescriptor mo1769createCustomMarkerView(Context context, int res) {
        return BitmapDescriptorFactory.fromResource(res);
    }

    @Override // com.fimi.app.x8s.map.view.AbsMapCustomMarkerView
    /* renamed from: createInreterstMarkerView0 */
    public BitmapDescriptor mo1771createInreterstMarkerView0(Context context, int res) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_custom_mark_view3, (ViewGroup) null);
        return BitmapDescriptorFactory.fromBitmap(loadBitmapFromView(view, context));
    }

    @Override // com.fimi.app.x8s.map.view.AbsMapCustomMarkerView
    /* renamed from: createCurrentPointView */
    public BitmapDescriptor mo1768createCurrentPointView(Context context, int res, int actionRes, int nPos) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_custom_mark_view4, (ViewGroup) null);
        ImageView imageView = (ImageView) view.findViewById(C0885R.C0889id.img_point);
        if (res != 0) {
            imageView.setBackgroundResource(res);
        }
        ImageView imageView2 = (ImageView) view.findViewById(C0885R.C0889id.img_action);
        if (res != 0) {
            imageView2.setBackgroundResource(actionRes);
        }
        TextView heightView = (TextView) view.findViewById(C0885R.C0889id.tv_index);
        heightView.setText("" + nPos);
        return BitmapDescriptorFactory.fromBitmap(loadBitmapFromView(view, context));
    }
    ...
    public BitmapDescriptor createMapPointNoAngleNoPioView(Context context, int res, float heightVale, int npos, boolean isSelect, boolean isRelation) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_marker_no_pio_view, (ViewGroup) null);
        X8MapPointMarkerViewGroup imageView = (X8MapPointMarkerViewGroup) view.findViewById(C0885R.C0889id.myview);
    ...
    public BitmapDescriptor createMapPioView(Context context, int res, float heightVale, int npos, boolean isSelect, boolean isRelation) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_marker_with_pio_view, (ViewGroup) null);
        X8MapPointMarkerViewGroup imageView = (X8MapPointMarkerViewGroup) view.findViewById(C0885R.C0889id.myview);
    ...
    public BitmapDescriptor createPointEventNoPioView(Context context, int actionRes, int angleRes, float heightVale, int npos, float angle, boolean isSelect, boolean isRelation) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_marker_event_no_pio_view, (ViewGroup) null);
        X8MapPointMarkerViewGroup imageView = (X8MapPointMarkerViewGroup) view.findViewById(C0885R.C0889id.myview);
    ...
    public BitmapDescriptor createPointEventWithPioView(Context context, int actionRes, int angleRes, float heightVale, int npos, float angle, boolean isSelect, boolean isRelation) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_marker_event_with_pio_view, (ViewGroup) null);
        X8MapPointMarkerViewGroup imageView = (X8MapPointMarkerViewGroup) view.findViewById(C0885R.C0889id.myview);
    ...
    public BitmapDescriptor createPointWithSmallArrow(Context context, int res, float angle, boolean isShow) {
        View view = LayoutInflater.from(context).inflate(C0885R.layout.x8_map_marker_arrow_view, (ViewGroup) null);
        ImageView imageView = (ImageView) view.findViewById(C0885R.C0889id.markerIcon);
        if (res != 0) {
            imageView.setBackgroundResource(res);
