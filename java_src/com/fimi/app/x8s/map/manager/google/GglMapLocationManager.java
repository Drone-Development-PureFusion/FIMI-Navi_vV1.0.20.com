...
public class GglMapLocationManager extends LocationCallback implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public GglMapLocationManager(GoogleMap googleMap, Context context) {
        ...
        this.markerOptions.icon(BitmapDescriptorFactory.fromResource(C0885R.C0888drawable.location_map));
    ...
    public void onLocationResult(LocationResult result) {
        ...
        if (this.locationMarker == null) {
            if (result.getLastLocation() != null) {
                ...
                this.locationMarker = this.mGoogleMap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(C0885R.C0888drawable.location_map)).anchor(0.5f, 0.5f));
    ...
    public void addHomeLocation(LatLng latLng) {
        if (this.home == null) {
            this.home = this.mGoogleMap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(C0885R.C0888drawable.home_point)).anchor(0.5f, 1.0f));
        } else {
    ...
    public void addDeviceLocation(LatLng latLng) {
        if (this.deviceMarker == null) {
            this.deviceMarker = this.mGoogleMap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(C0885R.C0888drawable.icon_fly_handpiece_location)).anchor(0.5f, 0.5f));
        } else {
