...
public class GglMapAiSurroundManager extends AbsAiSurroundManager {
    ...
    public void setAiSurroundMark(double latitude, double logitude) {
        ...
        if (this.pointMarker == null) {
            ...
            BitmapDescriptor mBitmapDescriptor = gdCustemMarkerView.mo1769createCustomMarkerView(this.context, C0885R.C0888drawable.x8_img_ai_follow_point2);
            this.f117mp = new MapPointLatLng();
            ...
            this.pointMarker.setTag(this.f117mp);
            return;
        }
    ...
    public void drawAiLimit(double lat, double lng, double radiu) {
        if (this.limitCircle == null) {
            CircleOptions circle = new CircleOptions().center(new LatLng(lat, lng)).radius(radiu).strokePattern(PATTERN_POLYLINE_DOTTED).strokeColor(this.context.getResources().getColor(C0885R.C0887color.x8_drone_inface_line)).fillColor(this.fillColor).strokeWidth(this.strokeWidth);
    ...
    public void addEllipse(double lat, double lng, float horizontalDistance, float startNosePoint) {
        ...
        this.mPolygon.setStrokeColor(this.context.getResources().getColor(C0885R.C0887color.x8_drone_inface_line));
    }

    @Override // com.fimi.app.x8s.map.interfaces.AbsAiSurroundManager
    public void drawAiSurroundCircle(double lat, double lnt, double radiu) {
        if (this.surroundCircle == null) {
            CircleOptions circle = new CircleOptions().center(new LatLng(lat, lnt)).radius(radiu).strokeColor(this.context.getResources().getColor(C0885R.C0887color.x8_drone_inface_line)).fillColor(this.fillColor).strokeWidth(this.strokeWidth);
    ...
    public void addPolylinescircle(boolean cw, double lat, double lng, double lat1, double lng2, int radius, int maxRadius) {
        ...
        this.line.setColor(this.context.getResources().getColor(C0885R.C0887color.x8_drone_inface_line));
    }
