...
public class GglMapAiPoint2PointManager extends AbsAiPoint2PointManager implements GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener {
    ...
    public void setMarkerViewInfo(float height) {
        ...
        if (this.pointMarker != null) {
            this.f116mp.altitude = height;
            GglMapCustomMarkerView gdCustemMarkerView = new GglMapCustomMarkerView();
            if (this.f116mp.isSelect) {
                res = C0885R.C0888drawable.x8_img_ai_follow_point;
            } else {
                res = C0885R.C0888drawable.x8_img_ai_follow_point2;
            }
            BitmapDescriptor mBitmapDescriptor = gdCustemMarkerView.createCustomMarkerViewForP2P(this.context, res, this.f116mp.altitude, this.f116mp.nPos);
    ...
    public MapPointLatLng getMapPointLatLng() {
        if (this.pointMarker != null) {
            ...
            this.f116mp.longitude = mFlatlng.longitude;
            this.f116mp.latitude = mFlatlng.latitude;
        }
        return this.f116mp;
    }
    ...
    public void onMapClickForAiP2P(LatLng latLng) {
        if (this.gglMapLocationManager.getHomeLocation() != null) {
            ...
            if (0.0f <= distance && distance <= 1000.0f) {
                ...
                String t = String.format(this.context.getString(C0885R.string.x8_ai_fly_follow_point_to_point_far), X8NumberUtil.getDistanceNumberString(1000.0f, 0, true));
    ...
    public void calcDistance() {
        if (this.pointMarker != null) {
            ...
            this.f116mp.distance = distanceDes;
        }
    }

    public void addPointLatLng(LatLng latLng, float distance, LatLng deviceLocation) {
        if (this.pointMarker == null) {
            this.f116mp = new MapPointLatLng();
            this.f116mp.altitude = 5.0f;
            ...
            if (droneState.isConnect()) {
                ...
                if (h > 5) {
                    this.f116mp.altitude = h;
                }
            }
            GglMapCustomMarkerView gdCustemMarkerView = new GglMapCustomMarkerView();
            BitmapDescriptor mBitmapDescriptor = gdCustemMarkerView.createCustomMarkerViewForP2P(this.context, C0885R.C0888drawable.x8_img_ai_follow_point2, this.f116mp.altitude, this.f116mp.nPos);
            ...
            this.pointMarker.setTag(this.f116mp);
        } else {
            this.pointMarker.setPosition(latLng);
        }
        drawPointLine(deviceLocation);
        this.f116mp.distance = distance;
        if (this.point2PointMarkerSelectListener != null) {
            this.point2PointMarkerSelectListener.onMarkerSelect(true, this.f116mp.altitude, this.f116mp, false);
        }
        this.isFollow = true;
    }
    ...
    public void drawPointLine(LatLng latLngDevice) {
        if (this.pointMarker != null) {
            ...
            if (this.polyline == null) {
                ...
                polylineOptions.color(this.context.getResources().getColor(C0885R.C0887color.x8_drone_inface_line)).zIndex(50.0f);
