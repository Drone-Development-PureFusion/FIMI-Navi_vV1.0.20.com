...
public class GglMapAiLineManager extends AbsAiLineManager implements GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener, GoogleMap.OnMarkerDragListener {
    ...
    public void setAiLineMarkByHistory(List<X8AiLinePointLatlngInfo> points, int mapTpye) {
        ...
        for (X8AiLinePointLatlngInfo point : points) {
            ...
            if (point.getYawMode() == 0) {
                res = C0885R.C0888drawable.x8_ai_line_point_no_angle2;
            } else {
                res = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
            }
            BitmapDescriptor mBitmapDescriptor = this.gdCustemMarkerView.mo1770createCustomMarkerView2(this.context, res, this.mMarkerList.size() + 1);
    ...
    public void onMarkerDragStart(Marker marker) {
        int res = C0885R.C0888drawable.x8_img_ai_line_inreterst_max2;
    ...
    public void onMarkerDragEnd(Marker marker) {
        int res = C0885R.C0888drawable.x8_img_ai_line_inreterst_max1;
        MapPointLatLng mp = (MapPointLatLng) marker.getTag();
    ...
    public void addSmallMakerByMap1(Marker marker1, Marker marker2) {
        ...
        for (int i = 0; i < latLng.length; i++) {
            ...
            BitmapDescriptor mBitmapDescriptor = this.gdCustemMarkerView.createPointWithSmallArrow(this.context, C0885R.C0888drawable.x8_ai_line_point_small1, mpl.showAngle, true);
    ...
    public void updateSmallMarkerAngle(MapPointLatLng target) {
        ...
        if (index != 0) {
            ...
            if (this.arrowMarkerList.size() >= n + 1) {
                ...
                BitmapDescriptor mBitmapDescriptor = this.gdCustemMarkerView.createPointWithSmallArrow(this.context, C0885R.C0888drawable.x8_ai_line_point_small1, mpl1.showAngle, true);
                ...
                BitmapDescriptor mBitmapDescriptor2 = this.gdCustemMarkerView.createPointWithSmallArrow(this.context, C0885R.C0888drawable.x8_ai_line_point_small1, mpl2.showAngle, true);
    ...
    public int getCurrentPointActionRes(int action) {
        switch (action) {
            case -1:
                return -1;
            case 0:
                int id = C0885R.C0888drawable.x8_img_ai_line_action_na1;
                return id;
            case 1:
                int id2 = C0885R.C0888drawable.x8_img_ai_line_action_hover1;
                return id2;
            case 2:
                int id3 = C0885R.C0888drawable.x8_img_ai_line_action_record1;
                return id3;
            case 3:
                int id4 = C0885R.C0888drawable.x8_img_ai_line_action_4x_slow1;
                return id4;
            case 4:
                int id5 = C0885R.C0888drawable.x8_img_ai_line_action_one_photo1;
                return id5;
            case 5:
                int id6 = C0885R.C0888drawable.x8_img_ai_line_action_5s_photo1;
                return id6;
            case 6:
                int id7 = C0885R.C0888drawable.x8_img_ai_line_action_three_photo1;
                return id7;
            default:
                return 0;
        }
        ...
        if (!isFullSize()) {
            if (this.gglMapLocationManager.getDevLocation() != null) {
                ...
                if (distanceHome <= 1000.0f) {
                    ...
                    String t = String.format(this.context.getString(C0885R.string.x8_ai_fly_lines_point_magin), X8NumberUtil.getDistanceNumberString(10.0f, 0, true));
                    X8ToastUtil.showToast(this.context, t, 0);
                    return;
                }
                String t2 = String.format(this.context.getString(C0885R.string.x8_ai_fly_follow_point_to_point_far), X8NumberUtil.getDistanceNumberString(1000.0f, 0, true));
                X8ToastUtil.showToast(this.context, t2, 0);
                return;
            }
            return;
        }
        X8ToastUtil.showToast(this.context, this.context.getString(C0885R.string.x8_ai_fly_lines_point_max), 0);
    }
    ...
    public void changePointMarker(Marker marker, MapPointLatLng mpl, boolean isRelation) {
        ...
        if (mpl.isMapPoint) {
            if (mpl.isIntertestPoint) {
                if (mpl.isSelect) {
                    res2 = C0885R.C0888drawable.x8_img_ai_line_inreterst_max2;
                } else {
                    res2 = C0885R.C0888drawable.x8_img_ai_line_inreterst_max1;
                }
                ...
                if (mpl.isSelect) {
                    res = C0885R.C0888drawable.x8_ai_line_point_with_angle2;
                } else {
                    res = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
                }
    ...
    public void changeAngleOrOnAngle(Marker marker, MapPointLatLng mpl, boolean isRelation) {
        ...
        if (mpl.yawMode == 1 || mpl.yawMode == 2) {
            ...
            if (mpl.isSelect) {
                res2 = C0885R.C0888drawable.x8_ai_line_point_no_angle2;
            } else {
                res2 = C0885R.C0888drawable.x8_ai_line_point_no_angle1;
            }
        ...
        if (mpl.isMapPoint) {
            if (mpl.isIntertestPoint) {
                ...
                if (mpl.mInrertestPoint != null) {
                    anchorY2 = 0.5f;
                    if (mpl.isSelect) {
                        res6 = C0885R.C0888drawable.x8_ai_line_point_with_angle2;
                    } else if (isRun) {
                        res6 = C0885R.C0888drawable.x8_ai_line_point_run_angle1;
                    } else {
                        res6 = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
                    }
                    ...
                    if (mpl.isSelect) {
                        res5 = C0885R.C0888drawable.x8_ai_line_point_no_angle2;
                    } else if (isRun) {
                        res5 = C0885R.C0888drawable.x8_ai_line_point_run_no_angle1;
                    } else {
                        res5 = C0885R.C0888drawable.x8_ai_line_point_no_angle1;
                    }
                ...
                if (mpl.mInrertestPoint != null) {
                    anchorY = 0.5f;
                    if (mpl.isSelect) {
                        res4 = C0885R.C0888drawable.x8_ai_line_point_with_angle2;
                    } else if (isRun) {
                        res4 = C0885R.C0888drawable.x8_ai_line_point_run_angle1;
                    } else {
                        res4 = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
                    }
                    ...
                    anchorY = 0.64285713f;
                    if (mpl.isSelect) {
                        res3 = C0885R.C0888drawable.x8_ai_line_point_with_angle2;
                    } else if (isRun) {
                        res3 = C0885R.C0888drawable.x8_ai_line_point_run_angle1;
                    } else {
                        res3 = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
                    }
            ...
            if (mpl.isSelect) {
                ...
                res2 = C0885R.C0888drawable.x8_ai_line_point_run_no_angle1;
            } else {
                res2 = C0885R.C0888drawable.x8_ai_line_point_no_angle1;
            }
            ...
            if (mpl.isSelect) {
                ...
                res = C0885R.C0888drawable.x8_ai_line_point_run_angle1;
            } else {
                res = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
            }
    ...
    public void changeViewByRunning(Marker marker, MapPointLatLng mpl) {
        ...
        if (!mpl.isIntertestPoint) {
            if (mpl.mInrertestPoint != null) {
                if (mpl.yawMode == 0) {
                    res2 = C0885R.C0888drawable.x8_ai_line_point_with_angle2;
                } else {
                    res2 = C0885R.C0888drawable.x8_ai_line_point_with_angle2;
                }
    ...
    public void changeLineSmallMarkerByRunning(Marker marker1, Marker marker2, float angle, int type) {
        int res = 0;
        if (type == 0) {
            res = C0885R.C0888drawable.x8_ai_line_point_small1;
        } else if (type == 1) {
            res = C0885R.C0888drawable.x8_ai_line_point_small3;
        } else if (type == 2) {
            res = C0885R.C0888drawable.x8_ai_line_point_small2;
        }
    ...
    public Marker addPointMarker(boolean isMapPoint, LatLng latLng, MapPointLatLng mpl, float h, float angle) {
        ...
        float anchorY;
        if (isMapPoint) {
            mBitmapDescriptor = this.gdCustemMarkerView.createMapPointNoAngleNoPioView(this.context, C0885R.C0888drawable.x8_ai_line_point_no_angle1, h, mpl.nPos, mpl.isSelect, false);
            mpl.altitude = h;
            ...
            mpl.angle = angle;
            mpl.showAngle = angle;
            int res = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
    ...
    public Marker addInterestMarkerByHistory(MapPointLatLng mpl) {
        int res;
        if (mpl.isSelect) {
            res = C0885R.C0888drawable.x8_img_ai_line_inreterst_max2;
        } else {
            res = C0885R.C0888drawable.x8_img_ai_line_inreterst_max1;
        }
    ...
    public Marker addPointMarkerByHistory(MapPointLatLng mpl) {
        ...
        if (this.lineMarkerSelectListener.getOration() == 0) {
            if (mpl.mInrertestPoint != null) {
                ...
                mBitmapDescriptor = this.gdCustemMarkerView.createMapPointNoAngleNoPioView(this.context, C0885R.C0888drawable.x8_ai_line_point_no_angle1, mpl.altitude, mpl.nPos, mpl.isSelect, false);
                anchorY = 0.64285713f;
            }
        } else {
            int res2 = C0885R.C0888drawable.x8_ai_line_point_with_angle1;
