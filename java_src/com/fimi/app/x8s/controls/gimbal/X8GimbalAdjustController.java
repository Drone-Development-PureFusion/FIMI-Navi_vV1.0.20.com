...
public class X8GimbalAdjustController {
    ...
    public X8GimbalAdjustController(View rootView) {
        this.btnGet = (Button) rootView.findViewById(C0885R.C0889id.btn_get);
        this.btnSave = (Button) rootView.findViewById(C0885R.C0889id.btn_save);
        this.relayoutPitch = (GimbalAdjustRelayout) rootView.findViewById(C0885R.C0889id.rl_pitch);
        this.relayoutPitch.getTvGimbalModel().setText("Pitch");
        this.relayoutRoll = (GimbalAdjustRelayout) rootView.findViewById(C0885R.C0889id.rl_roll);
        this.relayoutRoll.getTvGimbalModel().setText("Roll");
        this.rlYaw = (GimbalAdjustRelayout) rootView.findViewById(C0885R.C0889id.rl_yaw);
        this.rlYaw.getTvGimbalModel().setText("Yaw");
        this.mContext = rootView.getContext();
        this.btnCalibrate = (Button) rootView.findViewById(C0885R.C0889id.btn_calibrate);
        if (!Constants.isFactoryApp()) {
            rootView.findViewById(C0885R.C0889id.rl_gc_calibrate).setVisibility(8);
        }
        initClickAction();
    }
