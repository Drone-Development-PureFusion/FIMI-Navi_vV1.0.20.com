...
public class X8MainRightMenuController extends AbsX8Controllers implements View.OnClickListener {
    ...
    public IX8PanoramicInformationListener ix8PanoramicInformationListener = new IX8PanoramicInformationListener() { // from class: com.fimi.app.x8s.controls.X8MainRightMenuController.8
        ...
        public void onPanoramicInformationChange(AckPanoramaPhotographType ackPanoramaPhotographType) {
            ...
            if (ackPanoramaPhotographType.getCurrentNum() >= 1) {
                ...
                X8MainRightMenuController.this.tvPanoramaNumber.setText(String.format(X8MainRightMenuController.this.getString(C0885R.string.x8_panorama_number), Byte.valueOf(ackPanoramaPhotographType.getCurrentNum()), Byte.valueOf(ackPanoramaPhotographType.getTotalNum())));
            }
        }
    };
    ...
    public void initViews(View rootView) {
        ...
        this.handleView = rootView.findViewById(C0885R.C0889id.main_right_menu);
        this.imbCameraTools = (ImageButton) rootView.findViewById(C0885R.C0889id.imb_camera_tools);
        this.imbSwitchPhotoVideo = (X8ModuleSwitcher) rootView.findViewById(C0885R.C0889id.imb_switch_photo_video_module);
        this.imbPhotoVideo = (X8ShutterImageView) rootView.findViewById(C0885R.C0889id.imb_photo_video);
        this.imbMedia = (ImageButton) rootView.findViewById(C0885R.C0889id.imb_meida);
        this.mTvRecordTime = (StrokeTextView) rootView.findViewById(C0885R.C0889id.tv_record_time);
        this.tvPanoramaNumber = (StrokeTextView) rootView.findViewById(C0885R.C0889id.tv_panorama_number);
        this.mIvHotDot = (ImageView) rootView.findViewById(C0885R.C0889id.iv_record_hot_dot);
    }
    ...
    public void onPhotoVideoShutter() {
        if (this.autoCameraStateADV == null || this.autoCameraStateADV.getInfo() == 3) {
            X8ToastUtil.showToast(this.rootView.getContext(), this.rootView.getContext().getString(C0885R.string.x8_camera_rtp8), 1);
    ...
    private void takePhoto() {
        if (this.autoCameraStateADV.getMode() == 20) {
            if (StateManager.getInstance().getCamera().isTakingPanoramicPhotos()) {
                ...
                X8ToastUtil.showToast(this.context, this.rootView.getContext().getString(C0885R.string.x8_take_photo_not_insky_tip), 1);
                return;
            }
        }
    ...
    private void stopRecord() {
        this.cameraManager.stopVideo(new UiCallBackListener() { // from class: com.fimi.app.x8s.controls.X8MainRightMenuController.7
            ...
            public void onComplete(CmdResult cmdResult, Object o) {
                if (cmdResult.isSuccess()) {
                    X8MainRightMenuController.this.imbMedia.setBackgroundResource(C0885R.C0888drawable.x8_main_btn_media_select);
                }
            }
        });
    }
    ...
    public void showCameraState(AutoCameraStateADV cameraStateADV) {
        ...
        if (cameraStateADV != null) {
            ...
            if (status == 6) {
                X8ToastUtil.showToast(this.rootView.getContext(), this.rootView.getContext().getString(C0885R.string.x8_camera_error), 1);
                return;
            }
            if (status == 5) {
                X8ToastUtil.showToast(this.rootView.getContext(), this.rootView.getContext().getString(C0885R.string.x8_camera_take_success), 1);
            } else if (status == 9) {
                X8ToastUtil.showToast(this.context, getString(C0885R.string.x8_camera_captured_successfully), 1);
                return;
            } else if (status == 16) {
                X8ToastUtil.showToast(this.context, getString(C0885R.string.x8_camera_rtp10), 1);
                return;
            }
            ...
            if (CameraParamStatus.modelStatus == CameraParamStatus.CameraModelStatus.takePhoto) {
                if (this.curMode != CameraParamStatus.modelStatus || (this.curModeType != model && !getPanoramicStart())) {
                    ...
                    this.imbSwitchPhotoVideo.setCurrentIndex(0);
                    this.imbMedia.setBackgroundResource(C0885R.C0888drawable.x8_main_btn_media_select);
                ...
                if (this.autoCameraStateADV.isDelayedPhotography() || getPanoramicStart()) {
                    if (this.imbSwitchPhotoVideo.isClickable()) {
                        ...
                        this.imbMedia.setBackgroundResource(C0885R.C0888drawable.x8_main_btn_media_unclickable);
        ...
        if (paramsValue != null && (object = paramsValue.getCurParamsJson()) != null) {
            ...
            if (video_resolution == null || "".equals(video_resolution) || system_type == null || "".equals(system_type)) {
                ...
                if (system_type.equals("PAL")) {
                    this.pivTake = true;
                    this.imbMedia.setBackgroundResource(C0885R.C0888drawable.x8_piv_btn_selector);
                }
