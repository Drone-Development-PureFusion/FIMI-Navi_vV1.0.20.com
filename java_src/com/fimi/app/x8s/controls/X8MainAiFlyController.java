...
public class X8MainAiFlyController extends AbsX8MenuBoxControllers implements View.OnClickListener {
    ...
    public void initViews(View rootView) {
        this.rlAiFly = rootView.findViewById(C0885R.C0889id.x8_rl_main_ai_fly);
        this.aiFlyBlank = rootView.findViewById(C0885R.C0889id.x8_rl_main_ai_fly_blank);
        this.contentView = rootView.findViewById(C0885R.C0889id.rl_main_ai_fly_content);
        this.stubAiFlyAllItems = (ViewStub) rootView.findViewById(C0885R.C0889id.stub_ai_fly_items);
        this.confirmContent = rootView.findViewById(C0885R.C0889id.x8_main_ai_confirm_content);
    ...
    public void setAllEnabled() {
        ...
        this.imgAiTakeLandOff.setBackgroundResource(C0885R.C0888drawable.x8_btn_ai_takeoff_selector);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == C0885R.C0889id.img_ai_take_land_off) {
            openTakeOffOrLandingUi();
        } else if (id == C0885R.C0889id.img_ai_return_home) {
            openReturnUi();
        } else if (id == C0885R.C0889id.img_ai_point_to_point) {
            openPoint2PointConfirmContent();
        } else if (id == C0885R.C0889id.img_ai_rout) {
            openLinesUi();
        } else if (id == C0885R.C0889id.img_ai_auto_photo) {
            openAutoPhotoUi();
        } else if (id == C0885R.C0889id.img_ai_follow) {
            openAiFollowConfirmContent();
        } else if (id != C0885R.C0889id.img_ai_follow_to_hostpot) {
            if (id == C0885R.C0889id.img_ai_surround_to_point) {
                openSurroundPointUi();
            } else if (id == C0885R.C0889id.x8_rl_main_ai_fly_blank) {
                closeAiUi(true, true);
            } else if (id == C0885R.C0889id.img_ai_tripod) {
                openAiTtipod();
            } else if (id == C0885R.C0889id.img_ai_aerial_photograph) {
                openAiAerialPhotograph();
            } else if (id == C0885R.C0889id.img_ai_fixed_wing) {
                openAiFixedwing();
            } else if (id == C0885R.C0889id.img_ai_heading_lock) {
                openAiHeadingLock();
            } else if (id == C0885R.C0889id.img_ai_screw) {
                openAiScrew();
            } else if (id == C0885R.C0889id.img_ai_sar) {
                openAiSar();
            } else {
                if (id == C0885R.C0889id.img_ai_fly_gravitation) {
                }
            }
        }
    }
    ...
    public void initAllItems() {
        if (this.menuState == X8AiFlyMenuEnum.ALL_ITEMS) {
            if (this.rlAiFlyItems == null) {
                ...
                this.rlAiFlyItems = view.findViewById(C0885R.C0889id.x8_rl_main_ai_fly_items);
                this.imgAiTakeLandOff = (ImageView) view.findViewById(C0885R.C0889id.img_ai_take_land_off);
                this.svAiItems = (ScrollView) view.findViewById(C0885R.C0889id.sv_ai_items);
                this.imgAiReturnHome = (ImageView) view.findViewById(C0885R.C0889id.img_ai_return_home);
                this.imgAiPointToPoint = (ImageView) view.findViewById(C0885R.C0889id.img_ai_point_to_point);
                this.imgAiRout = (ImageView) view.findViewById(C0885R.C0889id.img_ai_rout);
                this.imgAiAutoPhoto = (ImageView) view.findViewById(C0885R.C0889id.img_ai_auto_photo);
                this.imgAiFollow = (ImageView) view.findViewById(C0885R.C0889id.img_ai_follow);
                this.imgAiFollowToHostpot = (ImageView) view.findViewById(C0885R.C0889id.img_ai_follow_to_hostpot);
                this.imgAiSurroundToPoint = (ImageView) view.findViewById(C0885R.C0889id.img_ai_surround_to_point);
                this.imgAiTtipod = (ImageView) view.findViewById(C0885R.C0889id.img_ai_tripod);
                this.imgAiAerialPhotograph = (ImageView) view.findViewById(C0885R.C0889id.img_ai_aerial_photograph);
                this.imgAiFixedwing = (ImageView) view.findViewById(C0885R.C0889id.img_ai_fixed_wing);
                this.imgAiHeadingLock = (ImageView) view.findViewById(C0885R.C0889id.img_ai_heading_lock);
                this.imgAiSrcew = (ImageView) view.findViewById(C0885R.C0889id.img_ai_screw);
                this.imgFlyGravitation = (ImageView) view.findViewById(C0885R.C0889id.img_ai_fly_gravitation);
                this.imgAiSar = (ImageView) view.findViewById(C0885R.C0889id.img_ai_sar);
                this.tvAiTakeLandOff = (TextView) view.findViewById(C0885R.C0889id.tv_ai_take_land_off);
                this.tvAiReturnHome = (TextView) view.findViewById(C0885R.C0889id.tv_ai_return_home);
                this.tvAiRout = (TextView) view.findViewById(C0885R.C0889id.tv_ai_rout);
                this.tvAiFollow = (TextView) view.findViewById(C0885R.C0889id.tv_ai_follow);
                this.tvAiSurroundToPoint = (TextView) view.findViewById(C0885R.C0889id.tv_ai_surround_to_point);
                this.tvAiPointToPoint = (TextView) view.findViewById(C0885R.C0889id.tv_ai_point_to_point);
                this.tvAiAutoPhoto = (TextView) view.findViewById(C0885R.C0889id.tv_ai_auto_photo);
                this.tvAiScrew = (TextView) view.findViewById(C0885R.C0889id.tv_ai_screw);
                this.tvAiGravitation = (TextView) view.findViewById(C0885R.C0889id.tv_ai_fly_gravitation);
                this.tvAiSar = (TextView) view.findViewById(C0885R.C0889id.tv_ai_sar);
                this.tvAerialShot = (TextView) view.findViewById(C0885R.C0889id.tv_ai_aerial_photograph);
                this.tvTripod = (TextView) view.findViewById(C0885R.C0889id.tv_ai_tripod);
                this.tvHeadLock = (TextView) view.findViewById(C0885R.C0889id.tv_ai_heading_lock);
                this.tvFixedwing = (TextView) view.findViewById(C0885R.C0889id.tv_ai_fixed_wing);
    ...
    public void onFcHeart(AutoFcHeart fcHeart, boolean isLowPow) {
        ...
        if (state.isInSky() && this.rlAiFlyItems != null) {
            this.tvAiTakeLandOff.setText(C0885R.string.x8_ai_fly_land_off);
            this.imgAiTakeLandOff.setBackgroundResource(C0885R.C0888drawable.x8_btn_ai_landing);
        ...
        if (state.isOnGround() && this.rlAiFlyItems != null) {
            if (state.isCanFly()) {
                this.tvAiTakeLandOff.setText(C0885R.string.x8_ai_fly_take_off);
                this.imgAiTakeLandOff.setBackgroundResource(C0885R.C0888drawable.x8_btn_ai_takeoff_selector);
