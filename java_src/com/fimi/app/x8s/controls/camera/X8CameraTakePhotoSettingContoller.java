...
public class X8CameraTakePhotoSettingContoller extends AbsX8Controllers implements CameraParamListener, JsonUiCallBackListener {
    ...
    public void initViews(View rootView) {
        ...
        this.handleView = rootView.findViewById(C0885R.C0889id.x8_mode_setting_layout);
        this.paramViewStub = (ViewStub) rootView.findViewById(C0885R.C0889id.param_default_layout);
        this.subViewStub = (ViewStub) rootView.findViewById(C0885R.C0889id.sub_param_layout);
    ...
    public void gotoSubItem(String key, String value, RecyclerView.ViewHolder viewHolder) {
        ...
        if (this.cameraManager != null && this.tokenEnable) {
            if (key.equals(CameraJsonCollection.KEY_RECORD_MODE)) {
                String[] recordArray = this.context.getResources().getStringArray(C0885R.array.x8_timelapse_record_array);
                this.itemEntity.setOptions(new ArrayList());
                for (String mode : recordArray) {
                    this.itemEntity.getOptions().add(mode);
                }
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_record_mode));
                ...
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_record_mode));
                this.subParamsController.setSubParam(this.itemEntity);
            } else if (key.equals("capture_mode")) {
                String[] timelapseCaptureArray = this.context.getResources().getStringArray(C0885R.array.x8_timelapse_capture_array);
                this.itemEntity.setOptions(new ArrayList());
                for (String timelapseCapture : timelapseCaptureArray) {
                    this.itemEntity.getOptions().add(timelapseCapture);
                }
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_photo_mode));
                matchPhotoMode(this.itemEntity.getOptions(), this.itemEntity.getOptionMap());
                this.itemEntity.setParamKey("capture_mode");
                this.itemEntity.setParamValue(this.paramMap.get("capture_mode"));
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_photo_mode));
                this.subParamsController.setSubParam(this.itemEntity);
            } else if (key.equals("photo_size")) {
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_photo_size));
                String[] sizeArray = this.context.getResources().getStringArray(C0885R.array.x8_photo_size_array);
                this.itemEntity.setParamKey("photo_size");
                this.itemEntity.setOptions(new ArrayList());
                for (String size : sizeArray) {
                    this.itemEntity.getOptions().add(size);
                }
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_photo_size));
                ...
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_photo_format));
                String[] sizeArray2 = this.context.getResources().getStringArray(C0885R.array.x8_photo_format_array);
                this.itemEntity.setParamKey("photo_format");
                this.itemEntity.setOptions(new ArrayList());
                for (String size2 : sizeArray2) {
                    this.itemEntity.getOptions().add(size2);
                }
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_photo_format));
                ...
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_camera_awb));
                String[] sizeArray3 = this.context.getResources().getStringArray(C0885R.array.x8_awb_array);
                this.itemEntity.setParamKey("awb");
                this.itemEntity.setOptions(new ArrayList());
                for (String size3 : sizeArray3) {
                    this.itemEntity.getOptions().add(size3);
                }
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_camera_awb));
                ...
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_camera_metering));
            } else if (key.equals(CameraJsonCollection.KEY_DIGITAL_EFFECT)) {
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_camera_digita));
                String[] sizeArray4 = this.context.getResources().getStringArray(C0885R.array.x8_colours_array);
                ...
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_camera_digita));
                ...
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_camera_style));
                String[] styleArray = this.context.getResources().getStringArray(C0885R.array.x8_photo_style_array);
                ...
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_record_quality));
                String[] sizeArray5 = this.context.getResources().getStringArray(C0885R.array.x8_record_quality_array);
                this.itemEntity.setParamKey("video_quality");
                this.itemEntity.setOptions(new ArrayList());
                for (String size4 : sizeArray5) {
                    this.itemEntity.getOptions().add(size4);
                }
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_record_quality));
                ...
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_video_resolution));
                this.cameraManager.getCameraKeyOptions("video_resolution", this);
            } else if (key.equals("system_type")) {
                this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_video_type));
                String[] sizeArray6 = this.context.getResources().getStringArray(C0885R.array.x8_system_type_array);
                this.itemEntity.setParamKey("system_type");
                this.itemEntity.setOptions(new ArrayList());
                for (String size5 : sizeArray6) {
                    this.itemEntity.getOptions().add(size5);
                }
                this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_video_type));
            ...
            String[] recordArray2 = this.context.getResources().getStringArray(C0885R.array.x8_timelapse_record_array);
            this.itemEntity.setOptions(new ArrayList());
            ...
            String[] timelapseCaptureArray2 = this.context.getResources().getStringArray(C0885R.array.x8_timelapse_capture_array);
            this.itemEntity.setOptions(new ArrayList());
            ...
            String[] sizeArray7 = this.context.getResources().getStringArray(C0885R.array.x8_photo_size_array);
            this.itemEntity.setOptions(new ArrayList());
            ...
            String[] formatArray = this.context.getResources().getStringArray(C0885R.array.x8_photo_format_array);
            this.itemEntity.setOptions(new ArrayList());
            ...
            String[] awbArray = this.context.getResources().getStringArray(C0885R.array.x8_awb_array);
            this.itemEntity.setOptions(new ArrayList());
            ...
            String[] meterArray = this.context.getResources().getStringArray(C0885R.array.x8_meter_array);
            this.itemEntity.setOptions(new ArrayList());
            for (String meter : meterArray) {
                this.itemEntity.getOptions().add(meter);
            }
            this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_camera_metering));
            this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_camera_metering));
            this.subParamsController.setSubParam(this.itemEntity);
        } else if (key.equals(CameraJsonCollection.KEY_DIGITAL_EFFECT)) {
            String[] colorArray = this.context.getResources().getStringArray(C0885R.array.x8_colours_array);
            this.itemEntity.setOptions(new ArrayList());
            ...
            this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_camera_style));
            String[] styleArray2 = this.context.getResources().getStringArray(C0885R.array.x8_photo_style_array);
            this.itemEntity.setParamKey(CameraJsonCollection.KEY_CAMERA_STYLE);
            this.itemEntity.setOptions(new ArrayList());
            this.itemEntity.getOptions().add(0, this.itemEntity.getTitleName());
            ...
            String[] qualityArray = this.context.getResources().getStringArray(C0885R.array.x8_record_quality_array);
            this.itemEntity.setOptions(new ArrayList());
            ...
            String[] resolutionArray = this.context.getResources().getStringArray(C0885R.array.x8_ntsc_resolution_array);
            this.itemEntity.setOptions(new ArrayList());
            for (String resolutio : resolutionArray) {
                this.itemEntity.getOptions().add(resolutio);
            }
            this.itemEntity.getOptions().add(0, this.context.getResources().getString(C0885R.string.x8_video_resolution));
            matchVideoResolution(this.itemEntity.getOptions(), this.itemEntity.getOptionMap());
            this.itemEntity.setParamKey("video_resolution");
            this.itemEntity.setTitleName(this.context.getResources().getString(C0885R.string.x8_video_resolution));
            this.subParamsController.setSubParam(this.itemEntity);
        } else if (key.equals("system_type")) {
            String[] typeArray = this.context.getResources().getStringArray(C0885R.array.x8_system_type_array);
            this.itemEntity.setOptions(new ArrayList());
                ...
                switch (paramsJson.getMsg_id()) {
                    case 9:
                        ...
                        if (paramType.equals(CameraJsonCollection.KEY_SHUTTER_TIME)) {
                            ...
                            String[] modeArray = this.context.getResources().getStringArray(C0885R.array.x8_record_mode_array);
                            mlist.clear();
                            mlist.add(0, this.itemEntity.getTitleName());
                            ...
                            String[] modeArray2 = this.context.getResources().getStringArray(C0885R.array.x8_photo_mode_array);
                            mlist.clear();
                            mlist.add(0, this.itemEntity.getTitleName());
                        ...
                        if (paramType.equals(CameraJsonCollection.KEY_METERMING_MODE) && options != null && options.size() > 0) {
                            for (int m = options.size() - 1; m >= 0; m--) {
                                ...
                                if (val.equalsIgnoreCase(this.context.getResources().getString(C0885R.string.x8_meter_roi))) {
                                    options.remove(m);
                                } else if (val.equalsIgnoreCase(this.context.getResources().getString(C0885R.string.x8_colours_flog)) && !StateManager.getInstance().isIs4KResolution()) {
                                    options.remove(m);
                                }
                            }
                        }
        ...
        if (this.itemEntity.getParamKey().equals("awb")) {
            for (String optionKey : options) {
                if (optionKey.equals(CameraJsonCollection.KEY_DE_CONTROL_AUTO)) {
                    optionMap.put(optionKey, this.context.getResources().getString(C0885R.string.x8_awb_auto));
                } else if (optionKey.equals("incandescent")) {
                    optionMap.put(optionKey, this.context.getResources().getString(C0885R.string.x8_awb_incandescent));
                } else if (optionKey.equals("d4000")) {
                    optionMap.put(optionKey, this.context.getResources().getString(C0885R.string.x8_awb_d4000));
                } else if (optionKey.equals("sunny")) {
                    optionMap.put(optionKey, this.context.getResources().getString(C0885R.string.x8_awb_sunny));
                } else if (optionKey.equals("cloudy")) {
                    optionMap.put(optionKey, this.context.getResources().getString(C0885R.string.x8_awb_cloudy));
                } else if (optionKey.equals("shadw")) {
                    optionMap.put(optionKey, this.context.getResources().getString(C0885R.string.x8_awb_shadow));
                }
            }
            ...
            for (String optionKey2 : options) {
                if (optionKey2.equals("spot")) {
                    optionMap.put(optionKey2, this.context.getResources().getString(C0885R.string.x8_meter_spot));
                } else if (optionKey2.equals("center")) {
                    optionMap.put(optionKey2, this.context.getResources().getString(C0885R.string.x8_meter_center));
                } else if (optionKey2.equals("average")) {
                    optionMap.put(optionKey2, this.context.getResources().getString(C0885R.string.x8_meter_average));
                }
            }
            ...
            for (String optionKey3 : options) {
                if (optionKey3.equals("General")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_general));
                } else if (optionKey3.equals("Vivid")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_vivid));
                } else if (optionKey3.equals("art")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_art));
                } else if (optionKey3.equals("black/white")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_black_white));
                } else if (optionKey3.equals("film")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_film));
                } else if (optionKey3.equals("sepia")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_sepia));
                } else if (optionKey3.equals("F-LOG")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_flog));
                } else if (optionKey3.equals("punk")) {
                    optionMap.put(optionKey3, this.context.getResources().getString(C0885R.string.x8_colours_punk));
                }
            }
        } else if (this.itemEntity.getParamKey().equals("video_quality")) {
            for (String optionKey4 : options) {
                if (optionKey4.equals("sfine")) {
                    optionMap.put(optionKey4, this.context.getResources().getString(C0885R.string.x8_record_quality_sfine));
                } else if (optionKey4.equals("fine")) {
                    optionMap.put(optionKey4, this.context.getResources().getString(C0885R.string.x8_record_quality_fine));
                } else if (optionKey4.equals("normal")) {
                    optionMap.put(optionKey4, this.context.getResources().getString(C0885R.string.x8_record_quality_normal));
                }
            }
