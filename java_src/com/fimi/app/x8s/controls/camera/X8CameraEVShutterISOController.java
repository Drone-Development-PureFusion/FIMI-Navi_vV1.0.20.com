...
public class X8CameraEVShutterISOController extends AbsX8Controllers implements CameraEVParamListener, JsonCallBackListener, X8RulerView.RulerListener, View.OnClickListener {
    ...
    public X8CameraEVShutterISOController(View rootView) {
        ...
        this.isoRecycler.addItemDecoration(new RecyclerDividerItemDecoration(this.mContext, 0, (int) this.mContext.getResources().getDimension(C0885R.dimen.camera_iso_divider), 17170445));
        this.isoOptions = Arrays.asList(this.mContext.getResources().getStringArray(C0885R.array.x8_iso_options));
        ...
        this.shutterRecycler.addItemDecoration(new RecyclerDividerItemDecoration(this.mContext, 0, (int) this.mContext.getResources().getDimension(C0885R.dimen.camera_shutter_divider), 17170445));
        this.shutterOptions = Arrays.asList(this.mContext.getResources().getStringArray(C0885R.array.x8_shutter_options));
    ...
    public void initViews(View rootView) {
        this.handleView = rootView.findViewById(C0885R.C0889id.camera_params_setting);
        this.tabHost = (X8TabHost) rootView.findViewById(C0885R.C0889id.camera_tab);
        this.isoRecycler = (RecyclerView) rootView.findViewById(C0885R.C0889id.iso_recycler);
        this.shutterRecycler = (RecyclerView) rootView.findViewById(C0885R.C0889id.shutter_recycler);
        this.rulerView = (X8RulerView) rootView.findViewById(C0885R.C0889id.rulerView);
        this.tvEv = (TextView) rootView.findViewById(C0885R.C0889id.ev_value);
        this.shutterView = (RelativeLayout) rootView.findViewById(C0885R.C0889id.shutter_layout);
        this.tvIso = (TextView) rootView.findViewById(C0885R.C0889id.iso_title);
        this.tvShutter = (TextView) rootView.findViewById(C0885R.C0889id.shutter_title);
        this.isoView = (RelativeLayout) rootView.findViewById(C0885R.C0889id.iso_layout);
        this.evView = (RelativeLayout) rootView.findViewById(C0885R.C0889id.ev_layout);
        this.ev_add_btn = (TextView) rootView.findViewById(C0885R.C0889id.ev_add_btn);
        this.ev_reduct_btn = (TextView) rootView.findViewById(C0885R.C0889id.ev_reduce_btn);
    ...
    public void updateRuler(float scaleValue) {
        if (this.cameraManager != null) {
            if (scaleValue < 0.0f) {
                ...
                this.scaleValue = this.mContext.getResources().getString(C0885R.string.x8_camera_ev_add) + String.valueOf(scaleValue);
            } else {
                this.scaleValue = String.valueOf(" " + scaleValue);
            }
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == C0885R.C0889id.ev_add_btn) {
        ...
        } else if (i == C0885R.C0889id.ev_reduce_btn && this.scaleValue != null && !"".equals(this.scaleValue)) {
