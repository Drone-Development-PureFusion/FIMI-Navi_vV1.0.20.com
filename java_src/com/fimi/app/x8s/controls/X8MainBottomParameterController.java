...
public class X8MainBottomParameterController extends AbsX8Controllers {
    ...
    Handler mHandler = new Handler() { // from class: com.fimi.app.x8s.controls.X8MainBottomParameterController.1
    ...
    public void showTFCardStatus(int changeShowStatus) {
        ...
        if (this.cameraStateADV != null && StateManager.getInstance().getCamera() != null && StateManager.getInstance().getCamera().isConnect()) {
            switch (this.cameraStateADV.getInfo()) {
                case 0:
                    imgRes = C0885R.C0888drawable.x8_tf_card_nomal;
                    textColor = -1;
                    text = this.tfCardCapt;
                    break;
                case 1:
                    imgRes = C0885R.C0888drawable.x8_tf_card_low_fulling;
                    textColor = -1;
                    if (changeShowStatus == 0) {
                        text = getString(C0885R.string.x8_tf_low);
                        break;
                    } else {
                        text = this.tfCardCapt;
                        break;
                ...
                case 2:
                    imgRes = C0885R.C0888drawable.x8_tf_card_exception;
                    textColor = SupportMenu.CATEGORY_MASK;
                    if (changeShowStatus == 0 || this.tfCardCapt.equalsIgnoreCase(getString(C0885R.string.x8_na))) {
                        text = getString(C0885R.string.x8_tf_exception);
                        break;
                    } else {
                        text = this.tfCardCapt;
                        break;
                    ...
                    break;
                case 3:
                    imgRes = C0885R.C0888drawable.x8_tf_card_no;
                    textColor = SupportMenu.CATEGORY_MASK;
                    text = getString(C0885R.string.x8_tf_no_exit);
                    break;
                case 4:
                    imgRes = C0885R.C0888drawable.x8_tf_card_low_fulling;
                    textColor = SupportMenu.CATEGORY_MASK;
                    ...
                    break;
                case 5:
                    imgRes = C0885R.C0888drawable.x8_tf_fulled;
                    textColor = SupportMenu.CATEGORY_MASK;
                    text = this.tfCardCapt;
                    break;
                case 6:
    ...
    public void showSportState(GimbalState state) {
        ...
        this.mIvCloud.setBackgroundResource(C0885R.C0888drawable.x8_main_cloud_angle);
    }

    @Override // com.fimi.app.x8s.interfaces.IControllers
    public void defaultVal() {
        this.mIvCloud.setBackgroundResource(C0885R.C0888drawable.x8_main_cloud_angle_unconnect);
        this.mIvEv.setBackgroundResource(C0885R.C0888drawable.x8_main_ev_unconnect);
        this.mIvISO.setBackgroundResource(C0885R.C0888drawable.x8_main_iso_unconnect);
        this.mIvShutter.setBackgroundResource(C0885R.C0888drawable.x8_main_shutter_unconnect);
        this.mIvSDK.setBackgroundResource(C0885R.C0888drawable.x8_main_sdk_unconnect);
        this.mImgColor.setBackgroundResource(C0885R.C0888drawable.x8_main_bottom_camera_color_unconnect);
        this.mIvRecord.setSelected(false);
        this.mTvCloud.setText(C0885R.string.x8_na);
        this.mTvEv.setText(C0885R.string.x8_na);
        this.mTvISO.setText(C0885R.string.x8_na);
        this.mTvShutter.setText(C0885R.string.x8_na);
        this.mTvColor.setText(C0885R.string.x8_na);
        this.mTvSDK.setTextColor(-1);
        this.mTvSDK.setText(C0885R.string.x8_na);
        this.mTvRecord.setText(C0885R.string.x8_na);
    }

    @Override // com.fimi.app.x8s.interfaces.IControllers
    public void initViews(View rootView) {
        this.context = rootView.getContext();
        this.handleView = rootView.findViewById(C0885R.C0889id.main_bottom_parameter);
        this.root_layout = (PercentRelativeLayout) this.handleView;
        this.mIvCloud = (ImageView) rootView.findViewById(C0885R.C0889id.iv_bottom_cloud);
        this.mTvCloud = (TextView) rootView.findViewById(C0885R.C0889id.tv_bottom_cloud);
        this.mIvEv = (ImageView) rootView.findViewById(C0885R.C0889id.iv_bottom_ev);
        this.mTvEv = (TextView) rootView.findViewById(C0885R.C0889id.tv_bottom_ev);
        this.mIvISO = (ImageView) rootView.findViewById(C0885R.C0889id.iv_bottom_iso);
        this.mTvISO = (TextView) rootView.findViewById(C0885R.C0889id.tv_bottom_iso);
        this.mIvShutter = (ImageView) rootView.findViewById(C0885R.C0889id.iv_bottom_shutter);
        this.mTvShutter = (TextView) rootView.findViewById(C0885R.C0889id.tv_bottom_shutter);
        this.mImgColor = (ImageView) rootView.findViewById(C0885R.C0889id.iv_bottom_color);
        this.mTvColor = (TextView) rootView.findViewById(C0885R.C0889id.tv_bottom_color);
        this.mIvSDK = (ImageView) rootView.findViewById(C0885R.C0889id.iv_bottom_sdk);
        this.mTvSDK = (TextView) rootView.findViewById(C0885R.C0889id.tv_bottom_sdk);
        this.mIvRecord = (ImageView) rootView.findViewById(C0885R.C0889id.iv_bottom_record);
        this.mTvRecord = (TextView) rootView.findViewById(C0885R.C0889id.tv_bottom_record);
    }
    ...
    private void updateTFCardStorage(AutoCameraStateADV cameraStateADV) {
        ...
        if (totalSpace.equals("0.0")) {
            this.tfCardCapt = getString(C0885R.string.x8_na);
        } else {
    ...
    private void setColor(String paramValue) {
        if (paramValue.equals("General")) {
            String paramValue2 = this.context.getResources().getString(C0885R.string.x8_colours_general);
            this.mImgColor.setBackgroundResource(C0885R.C0888drawable.x8_main_bottom_camera_color);
            this.mTvColor.setText(paramValue2);
            return;
        }
        if (paramValue.equals("Vivid")) {
            paramValue = this.context.getResources().getString(C0885R.string.x8_colours_vivid);
        } else if (paramValue.equals("art")) {
            paramValue = this.context.getResources().getString(C0885R.string.x8_colours_art);
        } else if (paramValue.equals("black/white")) {
            paramValue = this.context.getResources().getString(C0885R.string.x8_colours_black_white);
        } else if (paramValue.equals("film")) {
            paramValue = this.context.getResources().getString(C0885R.string.x8_colours_film);
        } else if (paramValue.equals("sepia")) {
            paramValue = this.context.getResources().getString(C0885R.string.x8_colours_sepia);
        } else if (paramValue.equals("F-LOG")) {
            paramValue = this.context.getResources().getString(C0885R.string.x8_colours_flog);
        } else if (paramValue.equals("punk")) {
            paramValue = this.context.getResources().getString(C0885R.string.x8_colours_punk);
        }
        this.mImgColor.setBackgroundResource(C0885R.C0888drawable.x8_main_bottom_camera_color_not_default);
    ...
    public void updateEvTextValue(String ev) {
        ...
        if (evValue == 0.0f) {
            this.mIvEv.setBackgroundResource(C0885R.C0888drawable.x8_main_ev_connect);
        } else {
            this.mIvEv.setBackgroundResource(C0885R.C0888drawable.x8_main_ev_connect_not_default);
        }
    }
        ...
        if (iso != null) {
            if (!iso.isEmpty() || !"".equals(iso)) {
                ...
                if (iso.equalsIgnoreCase(CameraJsonCollection.KEY_DE_CONTROL_AUTO)) {
                    this.mIvISO.setBackgroundResource(C0885R.C0888drawable.x8_main_iso_connect);
                } else {
                    this.mIvISO.setBackgroundResource(C0885R.C0888drawable.x8_main_iso_connect_not_defualt);
                }
            }
        }
    }
    ...
    public void updateShutter(String shutter) {
        if (shutter.equalsIgnoreCase(CameraJsonCollection.KEY_DE_CONTROL_AUTO)) {
            ...
            this.mIvShutter.setBackgroundResource(C0885R.C0888drawable.x8_main_shutter_connect);
            return;
        }
        this.mTvShutter.setText(shutter.substring(0, shutter.length() - 1));
        this.mIvShutter.setBackgroundResource(C0885R.C0888drawable.x8_main_shutter_connect_not_default);
    }
    ...
    public void updateCameraModelValue() {
        ...
        if (CameraParamStatus.modelStatus == CameraParamStatus.CameraModelStatus.record || CameraParamStatus.modelStatus == CameraParamStatus.CameraModelStatus.recording) {
            ...
            if (modelValue != null && !"".equals(modelValue)) {
                ...
                this.mIvRecord.setBackgroundResource(C0885R.C0888drawable.x8_bottom_record_btn_select);
            } else {
                return;
            }
        } else {
            ...
            if (modelValue2 != null && !"".equals(modelValue2)) {
                ...
                this.mIvRecord.setBackgroundResource(C0885R.C0888drawable.x8_bottom_photo_btn_select);
            } else {
                return;
            }
        }
