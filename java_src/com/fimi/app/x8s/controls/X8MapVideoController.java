...
public class X8MapVideoController implements View.OnClickListener, IControllers, VideodDataListener, NoFlyLinstener {
    ...
    public void initViews(View rootView) {
        ...
        this.rlSwitchScreen = (RelativeLayout) rootView.findViewById(C0885R.C0889id.rl_switchscreen);
        this.rlFullScreen = (RelativeLayout) rootView.findViewById(C0885R.C0889id.rl_fullscreen);
        this.rlSmallScreen = (RelativeLayout) rootView.findViewById(C0885R.C0889id.rl_smallscreen);
        this.rlShotScreen = (RelativeLayout) rootView.findViewById(C0885R.C0889id.rl_fullscreen_shot);
        this.rlSmallScreen.setVisibility(0);
        this.mapVideoCardView = (X8MapVideoCardView) rootView.findViewById(C0885R.C0889id.cv_map_video);
        this.fimiVideoView = new FimiH264Video(rootView.getContext());
        this.tvVedioFrame = (TextView) rootView.findViewById(C0885R.C0889id.tv_vedio_frame);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == C0885R.C0889id.rl_switchscreen) {
            switchMapVideo();
        }
    }
