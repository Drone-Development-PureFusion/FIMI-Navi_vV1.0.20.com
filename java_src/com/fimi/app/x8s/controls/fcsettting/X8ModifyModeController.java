...
public class X8ModifyModeController extends AbsX8MenuBoxControllers implements X8DoubleCustomDialog.onDialogButtonClickListener {
    ...
    private FormatState mFormatState = FormatState.IDLE;
    private Handler mHandler = new Handler() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifyModeController.1
        @Override // android.os.Handler
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            switch (C131714.f114x659966be[X8ModifyModeController.this.mFormatState.ordinal()]) {
                case 2:
    ...
    /* loaded from: classes.dex */
    static /* synthetic */ class C131714 {

        /* renamed from: $SwitchMap$com$fimi$app$x8s$controls$fcsettting$X8ModifyModeController$FormatState */
        static final /* synthetic */ int[] f114x659966be = new int[FormatState.values().length];

        static {
            try {
                f114x659966be[FormatState.IDLE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f114x659966be[FormatState.SEND_FORMAT_LOG.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f114x659966be[FormatState.SEND_FORMAT_UPGRADE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f114x659966be[FormatState.GET_FORMAT.ordinal()] = 4;
    ...
    public void initViews(View rootView) {
        ...
        this.handleView = inflater.inflate(C0885R.layout.x8_main_general_item_modify_layout, (ViewGroup) rootView, true);
        this.back_btn = (ImageView) this.handleView.findViewById(C0885R.C0889id.btn_return);
        this.sensorLayout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_sensor_layout);
        this.mGimbalSensorLayout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_gimbal_sensor_layout);
        this.calibration_btn = (Button) this.handleView.findViewById(C0885R.C0889id.x8_btn_calibration);
        this.checkLayout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_check_layout);
        this.blackBoxLayout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_blackbox_layout);
        this.topLayout = (PercentRelativeLayout) this.handleView.findViewById(C0885R.C0889id.layout_top);
        this.itemLayout = (PercentRelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_modify_item_layout);
        this.blackBoxLogLayout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_blackbox_layout1);
        this.x8AircraftCalibrationLayout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_aircraft_calibration_layout);
        this.mFormatStorage = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.x8_format_storage_layout);
        this.mIvFormatStorage = (ImageView) this.handleView.findViewById(C0885R.C0889id.iv_format_storage);
        this.mTvFormatDec = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_format_storage_dec);
        this.mTvFormatTitle = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_format_storage_title);
        this.mPbFormat = (ProgressBar) this.handleView.findViewById(C0885R.C0889id.pb_format_storage);
        this.nextContentLayout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.rl_next_content);
    }
        ...
        this.calibration_btn.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifyModeController.2
            ...
            public void onClick(View view) {
                ...
                if (X8ModifyModeController.this.calibrationViewStub == null) {
                    X8ModifyModeController.this.calibrationViewStub = (ViewStub) X8ModifyModeController.this.handleView.findViewById(C0885R.C0889id.x8_calibration_view);
        ...
        this.mGimbalSensorLayout.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifyModeController.4
            ...
            public void onClick(View view) {
                if (X8ModifyModeController.this.gimbalSensorViewStub == null) {
                    X8ModifyModeController.this.gimbalSensorViewStub = (ViewStub) X8ModifyModeController.this.handleView.findViewById(C0885R.C0889id.x8_gimbal_sensor_view);
        ...
        this.sensorLayout.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifyModeController.5
            ...
            public void onClick(View v) {
                if (X8ModifyModeController.this.sensorViewStub == null) {
                    X8ModifyModeController.this.sensorViewStub = (ViewStub) X8ModifyModeController.this.handleView.findViewById(C0885R.C0889id.x8_sensor_view);
    ...
    public void showExitDialog() {
        if (this.dialog == null) {
            String t = this.rootView.getContext().getString(C0885R.string.x8_modify_format_storage_dialog_title);
            String m = this.rootView.getContext().getString(C0885R.string.x8_modify_format_storage_dialog_dec);
    ...
    private void onFormatStorage() {
        this.mTvFormatTitle.setText(this.rootView.getContext().getString(C0885R.string.x8_modify_format_storage1));
    ...
    public void recoverFormatState() {
        this.mTvFormatTitle.setText(this.rootView.getContext().getString(C0885R.string.x8_modify_format_storage));
        ...
        this.fcCtrlManager.setFormatStorage(X8Format.FormatType.FORMAT_SENIOR.ordinal(), X8Format.FormatDevid.FORMAT_DEVID_LOG.ordinal(), new UiCallBackListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifyModeController.10
            ...
            public void onComplete(CmdResult cmdResult, Object o) {
                if (!cmdResult.isSuccess) {
                    X8ToastUtil.showToast(X8ModifyModeController.this.rootView.getContext(), X8ModifyModeController.this.rootView.getContext().getString(C0885R.string.x8_modify_format_storage_fail), 1);
            ...
            public void onComplete(CmdResult cmdResult, Object o) {
                ...
                if (o != null) {
                    ...
                    if (state.getProcess() == 100) {
                        X8ToastUtil.showToast(X8ModifyModeController.this.rootView.getContext(), X8ModifyModeController.this.rootView.getContext().getString(C0885R.string.x8_modify_format_storage_success), 1);
                        X8ModifyModeController.this.mFormatState = FormatState.IDLE;
    ...
    public void onDroneConnected(boolean b) {
        if (b) {
            ...
            if (droneState.isOnGround()) {
                ...
                this.mIvFormatStorage.setBackgroundResource(C0885R.C0888drawable.x8_param_goto_icon_seletor);
                this.mTvFormatTitle.setAlpha(1.0f);
            } else {
                this.mFormatStorage.setClickable(false);
                this.mIvFormatStorage.setBackgroundResource(C0885R.C0888drawable.x8_camera_goto_icon_press);
