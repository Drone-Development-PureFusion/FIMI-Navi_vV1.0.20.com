...
public class X8FcSensitivitySettingController extends AbsX8MenuBoxControllers implements View.OnClickListener, X8CustomSeekBar.onSeekValueSetListener {
    ...
    public void initViews(View rootView) {
        ...
        this.contentView = inflater.inflate(C0885R.layout.x8_main_fc_sensitivity_setting, (ViewGroup) rootView, true);
        this.content_layout = (PercentLinearLayout) this.contentView.findViewById(C0885R.C0889id.content_layout);
        ...
        this.sbAttitudeSens = (X8CustomSeekBar) this.contentView.findViewById(C0885R.C0889id.sb_attitude_sens);
        this.sbBrakeSens = (X8CustomSeekBar) this.contentView.findViewById(C0885R.C0889id.sb_brake_sens);
        this.sbYawTrip = (X8CustomSeekBar) this.contentView.findViewById(C0885R.C0889id.sb_yaw_trip);
        this.sbYawSens = (X8CustomSeekBar) this.contentView.findViewById(C0885R.C0889id.sb_yaw_sens);
        Resources resources = this.contentView.getContext().getResources();
        this.sbAttitudeSens.initData(resources.getString(C0885R.string.x8_fc_sensitivity_attitude_sens), 10, 100);
        this.sbBrakeSens.initData(resources.getString(C0885R.string.x8_fc_sensitivity_brake_sens), 10, 100);
        this.sbYawTrip.initData(resources.getString(C0885R.string.x8_fc_sensitivity_yaw_trip), 10, 100);
        this.sbYawSens.initData(resources.getString(C0885R.string.x8_fc_sensitivity_yaw_sens), 10, 100);
    ...
    public void onSeekValueSet(int viewId, final int value) {
        if (viewId == C0885R.C0889id.sb_attitude_sens) {
        ...
        } else if (viewId == C0885R.C0889id.sb_brake_sens) {
        ...
        } else if (viewId == C0885R.C0889id.sb_yaw_trip) {
        ...
        } else if (viewId == C0885R.C0889id.sb_yaw_sens) {
