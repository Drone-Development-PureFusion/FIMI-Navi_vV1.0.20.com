...
public class X8RCCalibrationController extends AbsX8MenuBoxControllers implements View.OnClickListener, UiCallBackListener {
    ...
    ArrayList<MidView.clipType> leftClips = new ArrayList<>();
    ArrayList<MidView.clipType> rightClips = new ArrayList<>();
    ...
    private void breakOutDone() {
        this.dialog = new X8DoubleCustomDialog(this.context, this.context.getString(C0885R.string.x8_rc_exit_calibration), this.context.getString(C0885R.string.x8_rc_exit_tip), new X8DoubleCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8RCCalibrationController.1
    ...
    private void gotoModel(RcStatus rcStatus) {
        if (this.curStatus != rcStatus) {
            ...
            if (this.curStatus == RcStatus.error) {
                this.control_layout.setBackground(new BitmapDrawable(ImageUtils.getBitmapByPath(this.control_layout.getContext(), C0885R.C0888drawable.x8_rc_unable_bg)));
            } else if (rcStatus == RcStatus.rollerModel) {
                this.control_layout.setBackground(new BitmapDrawable(ImageUtils.getBitmapByPath(this.control_layout.getContext(), C0885R.C0888drawable.x8_rc_roller_bg)));
            } else {
                this.control_layout.setBackground(new BitmapDrawable(ImageUtils.getBitmapByPath(this.control_layout.getContext(), C0885R.C0888drawable.x8_rc_roller_bg)));
            }
            if (rcStatus == RcStatus.ideal) {
                ...
                this.tipTV.setText(getString(C0885R.string.x8_rc_lead_tip));
                ...
                this.tipTV.setText(getString(C0885R.string.x8_rc_joy_tip));
                ...
                this.tipTV.setText(getString(C0885R.string.x8_rc_roller_tip));
                this.leftDownRoller.setVisibility(0);
                this.leftUpRoller.setVisibility(0);
                this.leftClips.clear();
                this.rightClips.clear();
                ...
                this.tipTV.setText(getString(C0885R.string.x8_rc_mid_tip));
                this.lefMidView.setAlpha(1.0f);
                this.rightMidView.setAlpha(1.0f);
                ...
                this.rtImage.setImageResource(C0885R.C0888drawable.x8_calibration_success_icon);
                this.rtTip.setText(getString(C0885R.string.x8_compass_result_success));
                this.rtBtn.setText(C0885R.string.x8_compass_reuslt_success_confirm);
            } else if (rcStatus == RcStatus.fail) {
                this.rt_layout.setVisibility(0);
                this.rc_layout.setVisibility(8);
                this.rtTip.setText(getString(C0885R.string.x8_compass_result_failed));
                this.rtBtn.setText(C0885R.string.x8_compass_reuslt_failed_confirm);
                this.rtImage.setImageResource(C0885R.C0888drawable.x8_calibration_fail_icon);
                this.errorTip.setText(getString(C0885R.string.x8_compass_result_failed_tip));
                ...
                this.rtTip.setText(getString(C0885R.string.x8_compass_result_failed));
                this.rtBtn.setText(C0885R.string.x8_compass_reuslt_failed_confirm);
                this.errorTip.setText(getString(C0885R.string.x8_rc_calibration_tip));
                this.errorTip.setVisibility(0);
    ...
    public void initViews(View rootView) {
        ...
        this.handleView = inflater.inflate(C0885R.layout.x8_rc_calibration_layout, (ViewGroup) rootView, true);
        this.leftUpRoller = (RcRollerView) this.handleView.findViewById(C0885R.C0889id.left_up);
        this.leftDownRoller = (RcRollerView) this.handleView.findViewById(C0885R.C0889id.left_down);
        this.lefMidView = (MidView) this.handleView.findViewById(C0885R.C0889id.mid_left);
        this.rightMidView = (MidView) this.handleView.findViewById(C0885R.C0889id.mid_right);
        this.lefMidView.setAlpha(0.4f);
        this.rightMidView.setAlpha(0.4f);
        this.cali_btn = (Button) this.handleView.findViewById(C0885R.C0889id.btn_calibration);
        this.cali_btn.setOnClickListener(this);
        this.leftMidTop = (ImageView) this.handleView.findViewById(C0885R.C0889id.left_top_icon);
        this.leftMidBottom = (ImageView) this.handleView.findViewById(C0885R.C0889id.left_bottom_icon);
        this.leftMidLeft = (ImageView) this.handleView.findViewById(C0885R.C0889id.left_left_icon);
        this.leftMidRight = (ImageView) this.handleView.findViewById(C0885R.C0889id.left_right_icon);
        this.rightMidTop = (ImageView) this.handleView.findViewById(C0885R.C0889id.right_top_icon);
        this.rightMidBottom = (ImageView) this.handleView.findViewById(C0885R.C0889id.right_bottom_icon);
        this.rightMidLeft = (ImageView) this.handleView.findViewById(C0885R.C0889id.right_left_icon);
        this.rightMidRight = (ImageView) this.handleView.findViewById(C0885R.C0889id.right_right_icon);
        this.backBtn = (ImageView) this.handleView.findViewById(C0885R.C0889id.img_return);
        this.backBtn.setOnClickListener(this);
        this.tipTV = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_tip);
        this.rt_layout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.rl_rc_calibration_result);
        this.errorTip = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_error_tip);
        this.rtTip = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_result_tip);
        this.rtBtn = (Button) this.handleView.findViewById(C0885R.C0889id.btn_rt);
        this.rtBtn.setOnClickListener(this);
        this.rc_layout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.rc_calibration_content);
        this.control_layout = (RelativeLayout) this.handleView.findViewById(C0885R.C0889id.control_layout);
        this.leftDownRoller.setOnClickListener(this);
        this.rtImage = (ImageView) rootView.findViewById(C0885R.C0889id.img_result);
    }
    ...
    public void openUi() {
        ...
        if (this.droneOkay) {
            this.tipTV.setText(getString(C0885R.string.x8_rc_plane_connect));
            ...
            this.tipTV.setText(getString(C0885R.string.x8_rc_no_connect_tip));
            gotoModel(RcStatus.error);
        }
    }
    ...
    public void onDroneConnected(boolean b) {
        ...
        if (b && StateManager.getInstance().getX8Drone().isInSky()) {
            this.tipTV.setText(getString(C0885R.string.x8_rc_plane_inSky));
            gotoModel(RcStatus.error);
            return;
        }
        if (this.droneOkay != b) {
