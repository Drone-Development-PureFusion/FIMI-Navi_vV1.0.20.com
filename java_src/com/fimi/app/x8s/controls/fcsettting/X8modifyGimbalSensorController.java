...
public class X8modifyGimbalSensorController extends AbsX8MenuBoxControllers {
    ...
    Handler mHandler = new Handler() { // from class: com.fimi.app.x8s.controls.fcsettting.X8modifyGimbalSensorController.2
    ...
    public void initViews(View rootView) {
        this.handleView = rootView.findViewById(C0885R.C0889id.x8_rl_main_mdify_gimbal_sensor_layout);
        this.back_btn = (ImageView) this.handleView.findViewById(C0885R.C0889id.btn_return);
        this.mGyroX = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_x);
        this.mGyroY = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_y);
        this.mGyroZ = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_z);
        this.mGyroK = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_k);
        this.mAccelerationX = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_acceleration_x);
        this.mAccelerationY = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_acceleration_y);
        this.mAccelerationZ = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_acceleration_z);
        this.mAccelerationK = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_acceleration_k);
        this.mGyroVarianceX = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_variance_x);
        this.mGyroVarianceY = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_variance_y);
        this.mGyroVarianceZ = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_variance_z);
        this.mGyroVarianceK = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_gyro_variance_k);
        this.mEleMachinery1X = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery1_x);
        this.mEleMachinery1Y = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery1_y);
        this.mEleMachinery1Z = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery1_z);
        this.mEleMachinery1K = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery1_k);
        this.mEleMachinery2X = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery2_x);
        this.mEleMachinery2Y = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery2_y);
        this.mEleMachinery2Z = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery2_z);
        this.mEleMachinery2K = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery2_k);
        this.mEleMachinery3X = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery3_x);
        this.mEleMachinery3Y = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery3_y);
        this.mEleMachinery3Z = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery3_z);
        this.mEleMachinery3K = (TextView) this.handleView.findViewById(C0885R.C0889id.gimbal_electric_machinery3_k);
    }
