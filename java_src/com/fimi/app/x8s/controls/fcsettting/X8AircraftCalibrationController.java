...
public class X8AircraftCalibrationController extends AbsX8MenuBoxControllers implements X8DoubleCustomDialog.onDialogButtonClickListener {
    ...
    private boolean[] indicatorArray = {false, false, false, false, false, false};
    ...
    private Handler mHandler = new Handler() { // from class: com.fimi.app.x8s.controls.fcsettting.X8AircraftCalibrationController.1
        ...
        public void handleMessage(Message msg) {
            ...
            if (X8AircraftCalibrationController.this.timeoutCounter > 30) {
                X8ToastUtil.showToast(X8AircraftCalibrationController.this.handleView.getContext(), X8AircraftCalibrationController.this.handleView.getContext().getString(C0885R.string.x8_cloud_gimbal_tip_9), 1);
    ...
    public void initViews(View rootView) {
        this.handleView = rootView.findViewById(C0885R.C0889id.x8_rl_main_mdify_calibration_layout);
        this.back_btn = (ImageView) this.handleView.findViewById(C0885R.C0889id.btn_calibration_return);
        this.mTvCalibrationTitle = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_calibration_title);
        this.mPreViewStub = (ViewStub) this.handleView.findViewById(C0885R.C0889id.vs_aircraft_calibration_pre);
        this.mCalibrationPreView = this.mPreViewStub.inflate();
        this.mCalibrationPreView.setVisibility(8);
        this.mDisconnectViewStub = (ViewStub) this.handleView.findViewById(C0885R.C0889id.vs_aircraft_calibration_disconnect);
        this.mCalibrationDisconnectView = this.mDisconnectViewStub.inflate();
        this.mCalibrationDisconnectView.setVisibility(0);
        this.mViewStepStub = (ViewStub) this.handleView.findViewById(C0885R.C0889id.vs_aircraft_calibration_step);
        this.mCalibrationStepView = this.mViewStepStub.inflate();
        this.mCalibrationStepView.setVisibility(8);
        this.mFailureViewStub = (ViewStub) this.handleView.findViewById(C0885R.C0889id.vs_aircraft_calibration_failure);
        this.mCalibrationFailureView = this.mFailureViewStub.inflate();
        this.mCalibrationFailureView.setVisibility(8);
        this.mSuccessedViewStub = (ViewStub) this.handleView.findViewById(C0885R.C0889id.vs_aircraft_calibration_successed);
        this.mCalibrationSuccessedView = this.mSuccessedViewStub.inflate();
        this.mCalibrationSuccessedView.setVisibility(8);
        this.mBtnStartCalibration = (Button) this.handleView.findViewById(C0885R.C0889id.btn_start_calibration_toggle);
        this.mBtnFailureCalibration = (Button) this.handleView.findViewById(C0885R.C0889id.btn_failure_calibration_toggle);
        this.mBtnSuccessCalibration = (Button) this.handleView.findViewById(C0885R.C0889id.btn_success_calibration_toggle);
        this.mIvCalibrationStepPicture = (ImageView) this.handleView.findViewById(C0885R.C0889id.iv_calibration_step_picture);
        this.mTvCalibrationStepDescribe = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_calibration_step1_describe);
        this.mCalibrationIndicator = (X8AircrftCalibrationIndicatorView) this.handleView.findViewById(C0885R.C0889id.view_aircrft_Calibration_Indicator);
        this.mTvCalibrationFailureDescribe = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_calibration_failure_describe);
        this.mTvCalibrationDisconnectionDescribe = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_calibration_disconnection_describe);
    }
            ...
            public void onClick(View v) {
                if (X8AircraftCalibrationController.this.isCaltAccSixPoint) {
                    if (X8AircraftCalibrationController.this.dialog == null) {
                        String t = X8AircraftCalibrationController.this.rootView.getResources().getString(C0885R.string.x8_modify_aircraft_calibration);
                        String m = X8AircraftCalibrationController.this.rootView.getResources().getString(C0885R.string.x8_modify_aircraft_calibration_exit);
    ...
    public void handleCalibrationStart() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration));
    ...
    public void handleCalibrationDisconnect() {
        ...
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(0);
        this.mTvCalibrationDisconnectionDescribe.setText(getIdString(C0885R.string.x8_modify_start_calibration_describe2));
        this.mCalibrationStepView.setVisibility(8);
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }
    ...
    private void handleInsky() {
        ...
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(0);
        this.mTvCalibrationDisconnectionDescribe.setText(getIdString(C0885R.string.x8_modify_start_calibration_describe4));
        this.mCalibrationStepView.setVisibility(8);
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }
    ...
    private void handleCalibrationStep1() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration3));
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(8);
        this.mCalibrationStepView.setVisibility(0);
        this.mIvCalibrationStepPicture.setImageBitmap(ImageUtils.getBitmapByPath(this.rootView.getContext(), C0885R.C0888drawable.x8_calibrate_drone_step1));
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }

    private void handleCalibrationStep2() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration4));
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(8);
        this.mCalibrationStepView.setVisibility(0);
        this.mIvCalibrationStepPicture.setImageBitmap(ImageUtils.getBitmapByPath(this.rootView.getContext(), C0885R.C0888drawable.x8_calibrate_drone_step2));
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }

    private void handleCalibrationStep3() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration5));
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(8);
        this.mCalibrationStepView.setVisibility(0);
        this.mIvCalibrationStepPicture.setImageBitmap(ImageUtils.getBitmapByPath(this.rootView.getContext(), C0885R.C0888drawable.x8_calibrate_drone_step3));
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }

    private void handleCalibrationStep4() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration6));
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(8);
        this.mCalibrationStepView.setVisibility(0);
        this.mIvCalibrationStepPicture.setImageBitmap(ImageUtils.getBitmapByPath(this.rootView.getContext(), C0885R.C0888drawable.x8_calibrate_drone_step4));
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }

    private void handleCalibrationStep5() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration2));
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(8);
        this.mCalibrationStepView.setVisibility(0);
        this.mIvCalibrationStepPicture.setImageBitmap(ImageUtils.getBitmapByPath(this.rootView.getContext(), C0885R.C0888drawable.x8_calibrate_drone_step5));
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }

    private void handleCalibrationStep6() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration1));
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(8);
        this.mCalibrationStepView.setVisibility(0);
        this.mIvCalibrationStepPicture.setImageBitmap(ImageUtils.getBitmapByPath(this.rootView.getContext(), C0885R.C0888drawable.x8_calibrate_drone_step6));
        this.mCalibrationFailureView.setVisibility(8);
        this.mCalibrationSuccessedView.setVisibility(8);
    }

    private void handleCalibrationHorizonal() {
        this.mTvCalibrationTitle.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration_horizonal));
        this.mCalibrationPreView.setVisibility(8);
        this.mCalibrationDisconnectView.setVisibility(8);
        this.mCalibrationStepView.setVisibility(0);
        this.mIvCalibrationStepPicture.setImageBitmap(ImageUtils.getBitmapByPath(this.rootView.getContext(), C0885R.C0888drawable.x8_calibrate_drone_step6));
    ...
    public void handleCalibrationFailure(int point) {
        ...
        this.mCalibrationSuccessedView.setVisibility(8);
        if (point == 1) {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration1_failure));
        } else if (point == 2) {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration2_failure));
        } else if (point == 3) {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration3_failure));
        } else if (point == 4) {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration4_failure));
        } else if (point == 5) {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration5_failure));
        } else if (point == 6) {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration6_failure));
        } else if (point == 7) {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration_horizonal_failure));
        } else {
            this.mTvCalibrationFailureDescribe.setText(getIdString(C0885R.string.x8_modify_aircraft_calibration1_failure));
        }
    }
