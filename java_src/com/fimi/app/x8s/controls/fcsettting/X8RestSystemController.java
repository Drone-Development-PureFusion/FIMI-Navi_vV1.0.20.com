...
public class X8RestSystemController implements Handler.Callback {
    ...
    public void showRestParamDialog() {
        if (this.x8DoubleCustomDialog == null) {
            this.x8DoubleCustomDialog = new X8DoubleCustomDialog(this.mContext, this.mContext.getString(C0885R.string.x8_general_version_rest_paramters), this.mContext.getString(C0885R.string.x8_general_rest_paramters_content), this.mContext.getString(C0885R.string.x8_general_rest), new X8DoubleCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8RestSystemController.1
    ...
    public boolean handleMessage(Message message) {
        if (this.restSystemParamResult.isAppResult() && this.restSystemParamResult.isFcResult() && this.restSystemParamResult.isRcResult()) {
            X8ToastUtil.showToast(this.mContext, this.mContext.getString(C0885R.string.x8_general_rest_paramters_success), 0);
        } else {
            X8ToastUtil.showToast(this.mContext, this.mContext.getString(C0885R.string.x8_general_rest_paramters_fail), 0);
        }
