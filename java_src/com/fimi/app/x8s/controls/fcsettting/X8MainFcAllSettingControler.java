...
public class X8MainFcAllSettingControler extends AbsX8MenuBoxControllers implements View.OnClickListener {
    ...
    private IX8DroneStateListener mIX8DroneStateListener = new IX8DroneStateListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.2
    ...
    public IX8FcItemListener mX8FcItemListener = new IX8FcItemListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.4
    ...
    public IX8RcItemControllerListener mX8RcItemControllerListener = new IX8RcItemControllerListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.5
    ...
    public IX8FiveKeyDefineListener mx8FiveKeyCalibrationListener = new IX8FiveKeyDefineListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.6
    ...
    public IX8CalibrationListener mX8CalibrationListener = new IX8CalibrationListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.7
    ...
    public IX8CalibrationListener mx8RockerCalibrationListener = new IX8CalibrationListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.8
        @Override // com.fimi.app.x8s.interfaces.IX8CalibrationListener
        public void onCalibrationReturn() {
            X8MainFcAllSettingControler.this.closeSecondUi();
        }
    ...
    private IX8GimbalSettingListener gimbalSettingListener = new IX8GimbalSettingListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.9
    ...
    public IX8FirmwareUpgradeControllerListener mX8FwUpgradeCtrlListener = new IX8FirmwareUpgradeControllerListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.12
    ...
    private IX8GeneraModifyModeControllerListener modifyModeControllerListener = new IX8GeneraModifyModeControllerListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.13
    ...
    public X8MainFcAllSettingControler(View rootView, Activity activity) {
        ...
        this.rlFcAllSetting = rootView.findViewById(C0885R.C0889id.x8_rl_main_fc_all_setting);
        this.contentView = rootView.findViewById(C0885R.C0889id.rl_main_fc_all_setting_content);
        this.firstContentView = rootView.findViewById(C0885R.C0889id.x8_all_setting_first_content);
        this.secondContentView = rootView.findViewById(C0885R.C0889id.x8_all_setting_second_content);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == C0885R.C0889id.x8_rl_main_fc_all_setting && this.isCanClose && !(this.mCurrentSecondController instanceof X8RCMatchCodeController) && !(this.mCurrentSecondController instanceof X8CloudCalibrationController) && !(this.mCurrentSecondController instanceof X8RCCalibrationController)) {
    ...
    public void showFlightlog() {
        ...
        this.loginDialogRestart = new X8DoubleCustomDialog(context, context.getString(C0885R.string.x8_modify_black_box_login_title), context.getString(C0885R.string.x8_playback_login_hint), context.getString(C0885R.string.x8_modify_black_box_login_go), new X8DoubleCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8MainFcAllSettingControler.10
    ...
    public boolean isRunningTask() {
        ...
        boolean ret = this.mCurrentSecondController.isRunningTask();
        return ret;
    }
}
