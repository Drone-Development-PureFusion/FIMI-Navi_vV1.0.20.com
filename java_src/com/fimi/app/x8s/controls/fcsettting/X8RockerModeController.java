...
public class X8RockerModeController extends AbsX8MenuBoxControllers implements View.OnClickListener {
    ...
    public void showApDialog(final int index) {
        X8DoubleCustomDialog modelDialog = new X8DoubleCustomDialog(this.rootView.getContext(), getString(C0885R.string.x8_rc_setting_model_dialog_title), getString(C0885R.string.x8_rc_setting_model_dialog_content), new X8DoubleCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8RockerModeController.1
    ...
    public void initViews(View rootView) {
        ...
        this.contentView = inflater.inflate(C0885R.layout.x8_main_rc_item_rocker_mode, (ViewGroup) rootView, true);
        this.imgReturn = (ImageView) this.contentView.findViewById(C0885R.C0889id.img_return);
        this.thSwitchRocker = (X8TabItem) this.contentView.findViewById(C0885R.C0889id.th_switch_rockers);
        this.imgRockerLeft = (ImageView) this.contentView.findViewById(C0885R.C0889id.img_rocker_left);
        this.imgRockerRight = (ImageView) this.contentView.findViewById(C0885R.C0889id.img_rocker_right);
        this.tvLeftSideLeft = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_left_side_left);
        this.tvLeftSideRight = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_left_side_right);
        this.tvLeftSideUp = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_left_side_up);
        this.tvLeftSideDown = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_left_side_down);
        this.tvRightSideLeft = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_right_side_left);
        this.tvRightSideRight = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_right_side_right);
        this.tvRightSideUp = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_right_side_up);
        this.tvRightSideDown = (TextView) this.contentView.findViewById(C0885R.C0889id.tv_right_side_down);
    ...
    public void switchRocker(int rocker) {
        ...
        switch (rocker) {
            case 0:
                this.tvLeftSideLeft.setText(C0885R.string.x8_rc_setting_rc_rocker_to_left_turn);
                this.tvLeftSideRight.setText(C0885R.string.x8_rc_setting_rc_rocker_to_right_turn);
                this.tvLeftSideUp.setText(C0885R.string.x8_rc_setting_rc_rocker_to_forward);
                this.tvLeftSideDown.setText(C0885R.string.x8_rc_setting_rc_rocker_to_back_off);
                this.tvRightSideLeft.setText(C0885R.string.x8_rc_setting_rc_rocker_to_left);
                this.tvRightSideRight.setText(C0885R.string.x8_rc_setting_rc_rocker_to_right);
                this.tvRightSideUp.setText(C0885R.string.x8_rc_setting_rc_rocker_to_up);
                this.tvRightSideDown.setText(C0885R.string.x8_rc_setting_rc_rocker_to_down);
                return;
            case 1:
                this.tvLeftSideLeft.setText(C0885R.string.x8_rc_setting_rc_rocker_to_left_turn);
                this.tvLeftSideRight.setText(C0885R.string.x8_rc_setting_rc_rocker_to_right_turn);
                this.tvLeftSideUp.setText(C0885R.string.x8_rc_setting_rc_rocker_to_up);
                this.tvLeftSideDown.setText(C0885R.string.x8_rc_setting_rc_rocker_to_down);
                this.tvRightSideLeft.setText(C0885R.string.x8_rc_setting_rc_rocker_to_left);
                this.tvRightSideRight.setText(C0885R.string.x8_rc_setting_rc_rocker_to_right);
                this.tvRightSideUp.setText(C0885R.string.x8_rc_setting_rc_rocker_to_forward);
                this.tvRightSideDown.setText(C0885R.string.x8_rc_setting_rc_rocker_to_back_off);
                return;
            case 2:
                this.tvLeftSideLeft.setText(C0885R.string.x8_rc_setting_rc_rocker_to_left);
                this.tvLeftSideRight.setText(C0885R.string.x8_rc_setting_rc_rocker_to_right);
                this.tvLeftSideUp.setText(C0885R.string.x8_rc_setting_rc_rocker_to_forward);
                this.tvLeftSideDown.setText(C0885R.string.x8_rc_setting_rc_rocker_to_back_off);
                this.tvRightSideLeft.setText(C0885R.string.x8_rc_setting_rc_rocker_to_left_turn);
                this.tvRightSideRight.setText(C0885R.string.x8_rc_setting_rc_rocker_to_right_turn);
                this.tvRightSideUp.setText(C0885R.string.x8_rc_setting_rc_rocker_to_up);
                this.tvRightSideDown.setText(C0885R.string.x8_rc_setting_rc_rocker_to_down);
                return;
            default:
