...
public class X8RcItemController extends AbsX8Controllers implements View.OnClickListener {
    ...
    int currAPModel = 0;
    IX8RcRockerListener rcCtrlModelListener = new IX8RcRockerListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8RcItemController.3
    ...
    public void initViews(View rootView) {
        this.stubFcItem = (ViewStub) rootView.findViewById(C0885R.C0889id.stub_rc_item);
        FIVE_KEY_DATA_ARRAY = rootView.getContext().getResources().getStringArray(C0885R.array.x8_five_key_define_option);
    }

    public void showApDialog(final int index) {
        X8DoubleCustomDialog apDialog = new X8DoubleCustomDialog(this.rootView.getContext(), getString(C0885R.string.x8_rc_setting_ap_dialog_title), getString(C0885R.string.x8_rc_setting_ap_dialog_content), new X8DoubleCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8RcItemController.1
    ...
    public void showRcCtrlModel(int result) {
        switch (result) {
            case 1:
                this.btnRockerMode.setText(C0885R.string.x8_rc_setting_america_rocker);
                return;
            case 2:
                this.btnRockerMode.setText(C0885R.string.x8_rc_setting_japanese_rocker);
                return;
            case 3:
                this.btnRockerMode.setText(C0885R.string.x8_rc_setting_chinese_rocker);
                return;
            default:
                return;
        }
    ...
    public void showItem() {
        if (this.rlFcItem == null) {
            ...
            this.rlFcItem = view.findViewById(C0885R.C0889id.x8_rl_main_rc_item);
            this.thApModule = (X8TabItem) this.rlFcItem.findViewById(C0885R.C0889id.th_ap_module);
            this.btnRcCalibration = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_rc_calibration);
            this.btnRockerMode = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_rocker_mode);
            this.btnRcCode = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_rc_code);
            this.btnFiveKeyUp = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_five_key_up);
            this.btnFiveKeyDown = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_five_key_down);
            this.btnFiveKeyLeft = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_five_key_left);
            this.btnFiveKeyRight = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_five_key_right);
            this.btnFiveKeyCenter = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_five_key_center);
            this.x8RcBtnRestParams = (Button) this.rlFcItem.findViewById(C0885R.C0889id.x8_rc_btn_rest_params);
    ...
    private void setViewEnabled(boolean isEnabled) {
        ...
        Button button = this.btnFiveKeyCenter;
        if (!isEnabled) {
            f = 0.4f;
        }
        button.setAlpha(f);
        ...
        this.fcCtrlManager.setRcCtrlMode(new UiCallBackListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8RcItemController.6
            ...
            public void onComplete(CmdResult cmdResult, Object o) {
                if (cmdResult.isSuccess()) {
                    ...
                    X8ToastUtil.showToast(X8RcItemController.this.mConext, X8RcItemController.this.mConext.getString(C0885R.string.x8_rc_reset_params_successd), 1);
                    return;
                }
                X8ToastUtil.showToast(X8RcItemController.this.mConext, X8RcItemController.this.mConext.getString(C0885R.string.x8_rc_reset_params_hint_failed), 1);
            }
        }, (byte) 1);
    }
