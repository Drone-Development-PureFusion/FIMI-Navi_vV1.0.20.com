...
public class X8FiveKeyHintController extends AbsX8MenuBoxControllers implements SeekBar.OnSeekBarChangeListener {
    ...
    public void initViews(View rootView) {
        this.parentView = rootView.findViewById(C0885R.C0889id.main_all_setting_five_key);
        this.tvFiveKeyShowType = (TextView) this.parentView.findViewById(C0885R.C0889id.tv_five_key_show_type);
        this.sbarFiveKey = (SeekBar) this.parentView.findViewById(C0885R.C0889id.sbar_five_key);
    ...
    public void openUi() {
        ...
        if (fiveKeyShowTypeStr.contains(getString(C0885R.string.x8_camera_contrast))) {
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
        if (this.currentValue != i) {
            ...
            if (this.currentValue >= 0 && this.currentValue <= 256) {
                String fiveKeyShowTypeStr = this.tvFiveKeyShowType.getText().toString();
                if (fiveKeyShowTypeStr.contains(getString(C0885R.string.x8_camera_contrast))) {
                    this.tvFiveKeyShowType.setText(String.format(getString(C0885R.string.x8_rc_setting_five_key_show_type), getString(C0885R.string.x8_camera_contrast), Integer.valueOf(i)));
                ...
                this.tvFiveKeyShowType.setText(String.format(getString(C0885R.string.x8_rc_setting_five_key_show_type), getString(C0885R.string.x8_camera_saturation), Integer.valueOf(i)));
                if (!AbAppUtil.isFastClick(400)) {
