...
public class X8FcItemController extends AbsX8Controllers implements View.OnClickListener {
    ...
    public final int RC_LOST_ACTION_RETURN = 0;
    public final int RC_LOST_ACTION_HOVER = 1;
    public final int RC_LOST_ACTION_LAND = 2;
    X8ValueSeakBarView.OnProgressConfirmListener speedConfirmListener = new X8ValueSeakBarView.OnProgressConfirmListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.1
    ...
    X8ValueSeakBarView.OnProgressConfirmListener limitConfirmListener = new X8ValueSeakBarView.OnProgressConfirmListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.2
        @Override // com.fimi.app.x8s.widget.X8ValueSeakBarView.OnProgressConfirmListener
        public void onConfirm(float value) {
            X8FcItemController.this.setFlyDistance(value);
        }
    };
    X8ValueSeakBarView.OnProgressConfirmListener heightConfirmListener = new X8ValueSeakBarView.OnProgressConfirmListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.4
        @Override // com.fimi.app.x8s.widget.X8ValueSeakBarView.OnProgressConfirmListener
        public void onConfirm(final float value) {
    ...
    X8ValueSeakBarView.OnProgressConfirmListener flyHeightConfirmListener = new X8ValueSeakBarView.OnProgressConfirmListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.5
        @Override // com.fimi.app.x8s.widget.X8ValueSeakBarView.OnProgressConfirmListener
        public void onConfirm(float value) {
            if (value > 120.0f) {
    ...
    public void initViews(View rootView) {
        this.stubFcItem = (ViewStub) rootView.findViewById(C0885R.C0889id.stub_fc_item);
            ...
            this.swbNoviceMode.setOnSwitchListener(new SwitchButton.OnSwitchListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.13
                ...
                public void onSwitch(View view, boolean on) {
                    ...
                    if (X8FcItemController.this.isInSky) {
                        X8ToastUtil.showToast(X8FcItemController.this.mConext, X8FcItemController.this.mConext.getString(C0885R.string.x8_fc_item_novice_mode_disable_message), 1);
                    } else if (on) {
    ...
    public void onSetHomeEvent(final int type) {
        ...
        if (!StateManager.getInstance().getX8Drone().isGPSMode()) {
            X8ToastUtil.showToast(this.rootView.getContext(), getString(C0885R.string.x8_general_return_gps_failed), 0);
            ...
            if (type == 0) {
                ...
                if (latLng == null) {
                    X8ToastUtil.showToast(this.rootView.getContext(), getString(C0885R.string.x8_general_return_person_failed), 0);
                    return;
                } else {
                    lat = latLng[0];
                    lng = latLng[1];
            ...
            this.fcManager.setHomePoint(h, lat, lng, type, accuracy, new UiCallBackListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.22
                ...
                public void onComplete(CmdResult cmdResult, Object o) {
                    if (type == 0) {
                        if (cmdResult.isSuccess()) {
                            X8ToastUtil.showToast(X8FcItemController.this.rootView.getContext(), X8FcItemController.this.getString(C0885R.string.x8_general_return_drone), 0);
                        } else if (o == null) {
                            X8ToastUtil.showToast(X8FcItemController.this.rootView.getContext(), X8FcItemController.this.getString(C0885R.string.x8_general_return_failed), 0);
                        }
                    } else if (cmdResult.isSuccess()) {
                        X8ToastUtil.showToast(X8FcItemController.this.rootView.getContext(), X8FcItemController.this.getString(C0885R.string.x8_general_return_person), 0);
                    } else if (o == null) {
                        X8ToastUtil.showToast(X8FcItemController.this.rootView.getContext(), X8FcItemController.this.getString(C0885R.string.x8_general_return_failed), 0);
                    }
                }
    ...
    public void onDroneConnected(boolean b) {
        ...
        if (this.isShow) {
            ...
            button.setEnabled(z);
            this.x8FcResetParams.setAlpha((!isOngroud || !b) ? 0.4f : 1.0f);
        }
    }
    ...
    public void showItem() {
        if (this.rlFcItem == null) {
            ...
            this.rlFcItem = view.findViewById(C0885R.C0889id.x8_rl_main_fc_item);
            this.vsbSpeedLimit = (X8ValueSeakBarView) this.rlFcItem.findViewById(C0885R.C0889id.vsb_speed_limit);
            this.vsbSpeedLimit.switchUnityWithSpeedLimit();
            this.vsbSpeedLimit.setConfirmListener(this.speedConfirmListener);
            this.vsbDistanceLimit = (X8ValueSeakBarView) this.rlFcItem.findViewById(C0885R.C0889id.vsb_distance_limit);
            ...
            this.swbNoviceMode = (SwitchButton) this.rlFcItem.findViewById(C0885R.C0889id.swb_novice_mode);
            this.swbSportMode = (SwitchButton) this.rlFcItem.findViewById(C0885R.C0889id.swb_sport_mode);
            this.llFeelingSetting = (LinearLayout) this.rlFcItem.findViewById(C0885R.C0889id.ll_feeling_setting);
            this.vsbRTHeightLimit = (X8ValueSeakBarView) this.rlFcItem.findViewById(C0885R.C0889id.vsb_return_height_limit);
            this.vsbRTHeightLimit.setConfirmListener(this.heightConfirmListener);
            this.vsbFlyHeightLimit = (X8ValueSeakBarView) this.rlFcItem.findViewById(C0885R.C0889id.vsb_height_limit);
            this.vsbFlyHeightLimit.setConfirmListener(this.flyHeightConfirmListener);
            this.imgMagneticField = (ImageView) this.rlFcItem.findViewById(C0885R.C0889id.img_magnetic_field);
            this.btnCompassCalibration = (Button) this.rlFcItem.findViewById(C0885R.C0889id.btn_compass_calibration);
            this.vsbLightLimit = (X8ValueSeakBarView) this.rlFcItem.findViewById(C0885R.C0889id.vsb_device_light);
            this.thDisconnectMeasure = (X8TabHost) this.rlFcItem.findViewById(C0885R.C0889id.th_disconnect_measure);
            this.swbAccurateLanding = (SwitchButton) this.rlFcItem.findViewById(C0885R.C0889id.swb_accurate_landing);
            this.fcExpSetting = (ImageView) this.rlFcItem.findViewById(C0885R.C0889id.fc_rocker_exp_setting);
            this.fcSensitivitySetting = (ImageView) this.rlFcItem.findViewById(C0885R.C0889id.fc_rocker_sensitivity_setting);
            this.iBtnReturnDrone = (ImageButton) this.rlFcItem.findViewById(C0885R.C0889id.btn_return_drone);
            this.iBtnReturnPerson = (ImageButton) this.rlFcItem.findViewById(C0885R.C0889id.btn_return_person);
            this.fcExpSetting.setOnClickListener(this);
            this.fcSensitivitySetting.setOnClickListener(this);
            this.tvAutoSetHome = (TextView) this.rlFcItem.findViewById(C0885R.C0889id.tv_auto_set_home);
            this.swbAutoSetHome = (SwitchButton) this.rlFcItem.findViewById(C0885R.C0889id.swb_auto_set_home);
            this.swbFollowReturn = (SwitchButton) this.rlFcItem.findViewById(C0885R.C0889id.swb_set_follow_return);
            this.x8FcResetParams = (Button) this.rlFcItem.findViewById(C0885R.C0889id.x8_fc_btn_rest_params);
    ...
    public void initParams() {
        ...
        this.fcCtrlManager.getAccurateLanding(new UiCallBackListener<AckAccurateLanding>() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.31
            ...
            public void onComplete(CmdResult cmdResult, AckAccurateLanding ackAccurateLanding) {
                boolean z2 = true;
                if (cmdResult.isSuccess()) {
                    SwitchButton switchButton2 = X8FcItemController.this.swbAccurateLanding;
                    if (ackAccurateLanding.getState() != 1) {
                        z2 = false;
                    }
                    switchButton2.setSwitchState(z2);
                }
            }
        });
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == C0885R.C0889id.btn_compass_calibration) {
            this.listener.onCalibrationItemClick();
        } else if (id == C0885R.C0889id.fc_rocker_exp_setting) {
            this.listener.onFcExpSettingClick();
        } else if (id == C0885R.C0889id.fc_rocker_sensitivity_setting) {
            this.listener.onFcSensitivitySettingClick();
        } else if (id == C0885R.C0889id.tv_auto_set_home) {
            showDialog();
        } else if (id == C0885R.C0889id.x8_fc_btn_rest_params) {
            showRestParamDialog();
        }
    }
        ...
        this.fcCtrlManager.restSystemParams(new UiCallBackListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8FcItemController.32
            ...
            public void onComplete(CmdResult cmdResult, Object o) {
                if (cmdResult.isSuccess()) {
                    ...
                    X8ToastUtil.showToast(X8FcItemController.this.mConext, X8FcItemController.this.mConext.getString(C0885R.string.x8_general_rest_paramters_success), 1);
                ...
                X8ToastUtil.showToast(X8FcItemController.this.mConext, X8FcItemController.this.mConext.getString(C0885R.string.x8_fc_reset_params_hint_failed), 1);
            }
        });
    }
    ...
    public void showDialog() {
        ...
        if (0 == 0) {
            String t = this.rootView.getContext().getString(C0885R.string.x8_fc_item_auto_set_home_title);
            String m = this.rootView.getContext().getString(C0885R.string.x8_fc_item_auto_set_home_tip);
    ...
    public void showChangeHomeDialog(final int type) {
        if (type == 0) {
            String t = this.rootView.getContext().getString(C0885R.string.x8_switch_home2_title);
            String m = this.rootView.getContext().getString(C0885R.string.x8_switch_home2_drone_msg);
            ...
            String t2 = this.rootView.getContext().getString(C0885R.string.x8_switch_home2_title);
            String m2 = this.rootView.getContext().getString(C0885R.string.x8_switch_home2_phone_title);
    ...
    public void showModeSeniorDialog() {
        if (this.dialog == null) {
            String title = this.rootView.getContext().getString(C0885R.string.x8_open_motor_pattern_title);
            String hint = this.rootView.getContext().getString(C0885R.string.x8_open_motor_pattern_hint);
    ...
    public void showFollowDialog(boolean on) {
        String title = this.rootView.getContext().getString(C0885R.string.x8_fc_item_follow_return_title);
        String hint = this.rootView.getContext().getString(C0885R.string.x8_fc_item_follow_return_msg);
    ...
    public void showFlyHeightDialog(final float value) {
        String title = this.rootView.getContext().getString(C0885R.string.x8_fc_item_height_limit);
        String hint = this.rootView.getContext().getString(C0885R.string.x8_fc_fly_height_limit_tip);
    ...
    public void showFailsafeDialog(final int last, final int value, final int index) {
        String hint;
        String title = this.rootView.getContext().getString(C0885R.string.x8_setting_fc_loastaction_tips_title);
        if (value == 1) {
            hint = this.rootView.getContext().getString(C0885R.string.x8_setting_fc_loastaction_tips_content_hover);
        } else if (value == 2) {
            hint = this.rootView.getContext().getString(C0885R.string.x8_setting_fc_loastaction_tips_content_leading);
        } else {
            hint = this.rootView.getContext().getString(C0885R.string.x8_setting_fc_loastaction_tips_content_back);
        }
    ...
    public void showDistanceDialog() {
        String title = this.rootView.getContext().getString(C0885R.string.x8_fc_item_distance_limit);
        String hint = this.rootView.getContext().getString(C0885R.string.x8_fc_fly_distance_limit_msg);
    ...
    public void showNewHandDialog() {
        X8SingleCustomDialog dialog = null;
        if (0 == 0) {
            String t = this.rootView.getContext().getString(C0885R.string.x8_fc_item_novice_mode_disable);
            String m = this.rootView.getContext().getString(C0885R.string.x8_fc_item_novice_mode_disable_message);
