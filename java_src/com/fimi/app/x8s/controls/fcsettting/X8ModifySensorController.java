...
public class X8ModifySensorController extends AbsX8MenuBoxControllers {
    ...
    X8IMUCheckController.OnCheckIMULisenter mOncheckImuLisenter = new X8IMUCheckController.OnCheckIMULisenter() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifySensorController.3
    ...
    Handler mHandler = new Handler() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifySensorController.7
    ...
    public void initViews(View rootView) {
        this.handleView = rootView.findViewById(C0885R.C0889id.x8_rl_main_mdify_sensor_layout);
        this.back_btn = (ImageView) this.handleView.findViewById(C0885R.C0889id.btn_return);
        this.tvGyroX = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro_x);
        this.tvGyroY = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro_y);
        this.tvGyroZ = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro_z);
        this.tvAccelX = (TextView) this.handleView.findViewById(C0885R.C0889id.accel_x);
        this.tvAccelY = (TextView) this.handleView.findViewById(C0885R.C0889id.accel_y);
        this.tvAccelZ = (TextView) this.handleView.findViewById(C0885R.C0889id.accel_z);
        this.tvMagX = (TextView) this.handleView.findViewById(C0885R.C0889id.magx_x);
        this.tvMagY = (TextView) this.handleView.findViewById(C0885R.C0889id.magx_y);
        this.tvMagZ = (TextView) this.handleView.findViewById(C0885R.C0889id.magx_z);
        this.tvGyroxMode = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro_mode);
        this.tvAccelMode = (TextView) this.handleView.findViewById(C0885R.C0889id.accel_mode);
        this.tvMagMode = (TextView) this.handleView.findViewById(C0885R.C0889id.magx_mode);
        this.tvGyroX2 = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro2_x);
        this.tvGyroY2 = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro2_y);
        this.tvGyroZ2 = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro2_z);
        this.tvAccelX2 = (TextView) this.handleView.findViewById(C0885R.C0889id.accel2_x);
        this.tvAccelY2 = (TextView) this.handleView.findViewById(C0885R.C0889id.accel2_y);
        this.tvAccelZ2 = (TextView) this.handleView.findViewById(C0885R.C0889id.accel2_z);
        this.tvGyroxMode2 = (TextView) this.handleView.findViewById(C0885R.C0889id.gyro2_mode);
        this.tvAccelMode2 = (TextView) this.handleView.findViewById(C0885R.C0889id.accel2_mode);
        this.btnImuCheck = (Button) this.handleView.findViewById(C0885R.C0889id.btn_imu_check);
    }
    ...
    public void setImuState(int type, String erreoCode) {
        ...
        switch (type) {
            case 0:
                this.x8IMUCustomDialog = new X8IMUCustomDialog(this.handleView.getContext(), getString(C0885R.string.x8_fc_item_dialog_title_two), null, getString(C0885R.string.x8_fc_item_imu_err), true, new X8IMUCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifySensorController.4
                ...
                return;
            case 1:
                this.x8IMUCustomDialog = new X8IMUCustomDialog(this.handleView.getContext(), getString(C0885R.string.x8_fc_item_dialog_title), getString(C0885R.string.x8_fc_item_imu_normal), null, false, new X8IMUCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifySensorController.5
                    @Override // com.fimi.app.x8s.widget.X8IMUCustomDialog.onDialogButtonClickListener
                    public void onSingleButtonClick() {
                        if (X8ModifySensorController.this.x8IMUCustomDialog != null && X8ModifySensorController.this.x8IMUCustomDialog.isShowing()) {
                            X8ModifySensorController.this.x8IMUCustomDialog.dismiss();
                ...
                return;
            case 2:
                this.x8IMUCustomDialog = new X8IMUCustomDialog(this.handleView.getContext(), getString(C0885R.string.x8_fc_item_dialog_title), getString(C0885R.string.x8_fc_item_imu_abnormal), erreoCode, false, new X8IMUCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.controls.fcsettting.X8ModifySensorController.6
                    @Override // com.fimi.app.x8s.widget.X8IMUCustomDialog.onDialogButtonClickListener
                    public void onSingleButtonClick() {
                        if (X8ModifySensorController.this.x8IMUCustomDialog != null && X8ModifySensorController.this.x8IMUCustomDialog.isShowing()) {
                            X8ModifySensorController.this.x8IMUCustomDialog.dismiss();
