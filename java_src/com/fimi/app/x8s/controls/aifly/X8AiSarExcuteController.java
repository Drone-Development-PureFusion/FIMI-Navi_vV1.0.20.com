...
public class X8AiSarExcuteController extends AbsX8AiController implements View.OnClickListener, X8DoubleCustomDialog.onDialogButtonClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == C0885R.C0889id.img_ai_follow_back) {
            showExitDialog();
        } else if (id == C0885R.C0889id.img_ai_map_switch) {
        ...
        } else if (id == C0885R.C0889id.img_ai_screen_shot) {
    ...
    public void openUi() {
        ...
        this.handleView = inflater.inflate(C0885R.layout.x8_ai_sar_excute_layout, (ViewGroup) this.rootView, true);
        this.tvLatlng = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_latlng);
        this.tvTime = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_time);
        this.mContentTip = (X8AiTipWithCloseView) this.handleView.findViewById(C0885R.C0889id.v_sar_content_tip);
        this.mContentTip.setTipText(this.rootView.getContext().getString(C0885R.string.x8_ai_fly_sar_content_tip));
        this.imgBack = (ImageView) this.handleView.findViewById(C0885R.C0889id.img_ai_follow_back);
        this.imgSwith = (ImageView) this.handleView.findViewById(C0885R.C0889id.img_ai_map_switch);
        this.imgShot = (ImageView) this.handleView.findViewById(C0885R.C0889id.img_ai_screen_shot);
        this.sbLayout = (X8VerticalSeekBarValueLayout) this.handleView.findViewById(C0885R.C0889id.sb_switch_focus);
    ...
    public void showExitDialog() {
        ...
        String m = this.rootView.getContext().getString(C0885R.string.x8_ai_fly_sar_exite_tip);
