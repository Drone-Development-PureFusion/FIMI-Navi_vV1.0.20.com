...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiGravitationExcuteComfirmUi */
...
public class X8AiGravitationExcuteComfirmUi implements View.OnClickListener {
    ...
    /* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiGravitationExcuteComfirmUi$ExcuteComfirmState */
    /* loaded from: classes.dex */
    ...
    public X8AiGravitationExcuteComfirmUi(X8sMainActivity activity, View parent, CameraManager cameraManager) {
        ...
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_gravitation_excute_confirm_layout, (ViewGroup) parent, true);
    ...
    private void initViews(View contentView) {
        this.mExcuteReturn = (ImageView) contentView.findViewById(C0885R.C0889id.img_ai_gravitation_excute_return);
        this.mExcuteTitle = (TextView) contentView.findViewById(C0885R.C0889id.tv_ai_gravitation_excute_title);
        this.mRlExcuteSetting = (RelativeLayout) contentView.findViewById(C0885R.C0889id.rl_gravitation_excute_setting);
        this.mXthVidotape = (X8TabHost) contentView.findViewById(C0885R.C0889id.x8_ai_gravitation_excute_videotape);
        this.mXthVidotape.setSelect(0);
        this.mBtnExcuteAdvancedSetting = (Button) contentView.findViewById(C0885R.C0889id.btn_ai_gravitation_excute_advanced_setting);
        this.mBtnExcuteOk = (Button) contentView.findViewById(C0885R.C0889id.btn_ai_gravitation_excute_ok);
        this.mBtnExcuteDefault = (Button) contentView.findViewById(C0885R.C0889id.btn_ai_gravitation_excute_default);
        this.mBtnExcuteSave = (Button) contentView.findViewById(C0885R.C0889id.btn_ai_gravitation_excute_save);
        this.mLlAdvancedSetting = (LinearLayout) contentView.findViewById(C0885R.C0889id.ll_gravitation_excute_advanced_setting);
        this.mTvLevel = (TextView) contentView.findViewById(C0885R.C0889id.tv_ai_gravitation_excute_level);
        this.mRlLevelMinus = (RelativeLayout) contentView.findViewById(C0885R.C0889id.rl_ai_gravitation_excute_level_minus);
        this.mSbLevel = (X8SeekBarView) contentView.findViewById(C0885R.C0889id.sb_ai_gravitation_excute_level);
        this.mRlLevelPlus = (RelativeLayout) contentView.findViewById(C0885R.C0889id.rl_ai_gravitation_excute_level_plus);
        this.mTvHeight = (TextView) contentView.findViewById(C0885R.C0889id.tv_ai_gravitation_excute_height);
        this.mRlHightMinus = (RelativeLayout) contentView.findViewById(C0885R.C0889id.rl_ai_gravitation_excute_heigth_minus);
        this.mSbHeight = (X8SeekBarView) contentView.findViewById(C0885R.C0889id.sb_ai_gravitation_excute_heigth);
        this.mRlHightPlus = (RelativeLayout) contentView.findViewById(C0885R.C0889id.rl_ai_gravitation_excute_heigth_plus);
        this.mXthRotate = (X8TabHost) contentView.findViewById(C0885R.C0889id.x8_ai_gravitation_excute_rotate);
    }
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == C0885R.C0889id.img_ai_gravitation_excute_return) {
            if (this.mComfirmState == ExcuteComfirmState.MAIN) {
                this.mIX8NextViewListener.onBackClick();
            } else {
                returnExcuteSetting();
            }
        } else if (id == C0885R.C0889id.btn_ai_gravitation_excute_ok) {
            setGravitationPrameter();
        } else if (id == C0885R.C0889id.btn_ai_gravitation_excute_advanced_setting) {
            showAdvancedSetting();
        } else if (id == C0885R.C0889id.btn_ai_gravitation_excute_default) {
            recoverDefaultValue();
        } else if (id == C0885R.C0889id.btn_ai_gravitation_excute_save) {
            saveValue();
        } else if (id == C0885R.C0889id.rl_ai_gravitation_excute_level_minus) {
        ...
        } else if (id == C0885R.C0889id.rl_ai_gravitation_excute_level_plus) {
        ...
        } else if (id == C0885R.C0889id.rl_ai_gravitation_excute_heigth_minus) {
        ...
        } else if (id == C0885R.C0889id.rl_ai_gravitation_excute_heigth_plus && this.mSbHeight.getProgress() != this.HIGHT_MAX_PROGRESS) {
    ...
    private void setGravitationPrameter() {
        ...
        this.mFcManager.setGravitationPrameter(prameter, new UiCallBackListener() { // from class: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiGravitationExcuteComfirmUi.3
            ...
            public void onComplete(CmdResult cmdResult, Object o) {
                ...
                String s = X8AiGravitationExcuteComfirmUi.this.contentView.getContext().getString(C0885R.string.x8_ai_fly_gravitation_set_prameter_error);
    ...
    public void startGravitation() {
        this.mFcManager.setGravitationStart(new UiCallBackListener() { // from class: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiGravitationExcuteComfirmUi.4
            ...
            public void onComplete(CmdResult cmdResult, Object o) {
                ...
                String s = X8AiGravitationExcuteComfirmUi.this.contentView.getContext().getString(C0885R.string.x8_ai_fly_gravitation_start_error);
                X8ToastUtil.showToast(X8AiGravitationExcuteComfirmUi.this.activity.getApplicationContext(), s, 0);
            }
        });
    }
    ...
    private void recoverDefaultValue() {
        ...
        this.mTvLevel.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_gravitation_excute_advanced_setting_level));
        this.mSbHeight.setProgress(0);
        this.mTvHeight.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_gravitation_excute_advanced_setting_height));
