...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiTtipodConfirmUi */
/* loaded from: classes.dex */
public class X8AiTtipodConfirmUi implements View.OnClickListener {
    private View btnOk;
    ...
    public X8AiTtipodConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_ttipod_confirm_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.imgFlag = (ImageView) rootView.findViewById(C0885R.C0889id.img_ttipod_flag);
        this.imgFlag.setImageBitmap(ImageUtils.getBitmapByPath(rootView.getContext(), C0885R.C0888drawable.x8_img_ttipod_flag));
    }
    ...
    public void onClick(View v) {
        ...
        if (id == C0885R.C0889id.img_ai_follow_return) {
            ...
            if (this.cbTip.isChecked()) {
                X8AiConfig.getInstance().setAiTripodCourse(false);
            } else {
                X8AiConfig.getInstance().setAiTripodCourse(true);
            }
            this.mX8MainAiFlyController.onTtipodConfirmOkClick();
        }
    }
