...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiPoint2PointExcuteConfirmUi */
...
public class X8AiPoint2PointExcuteConfirmUi implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public X8AiPoint2PointExcuteConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_point_to_point__excute_confirm_layout, (ViewGroup) parent, true);
