...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8MainAiFollowConfirmController */
...
public class X8MainAiFollowConfirmController extends AbsX8MenuBoxControllers implements View.OnClickListener {
    ...
    public void initViews(View rootView) {
        this.mainLayout = rootView.findViewById(C0885R.C0889id.x8_main_ai_follow_confirm_main_layout);
        this.blank = rootView.findViewById(C0885R.C0889id.x8_main_ai_follow_confirm_main_layout_content_blank);
        this.contentView = rootView.findViewById(C0885R.C0889id.x8_main_ai_follow_confirm_main_layout_content);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == C0885R.C0889id.x8_main_ai_follow_confirm_main_layout_content_blank) {
            closeAiUi();
        }
    }
