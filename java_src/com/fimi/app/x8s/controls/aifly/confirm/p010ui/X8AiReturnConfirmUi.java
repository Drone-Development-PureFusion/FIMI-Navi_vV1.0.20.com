...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiReturnConfirmUi */
...
public class X8AiReturnConfirmUi implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public X8AiReturnConfirmUi(Activity activity, View parent) {
        this.MAX = 0;
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_return_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.prex = rootView.getContext().getString(C0885R.string.x8_ai_fly_return_home_tip);
        this.prex2 = rootView.getContext().getString(C0885R.string.x8_ai_fly_return_home_tip2);
        this.tvCuurentHeight = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_follow_confirm_title1);
        this.tvHeight = (TextView) rootView.findViewById(C0885R.C0889id.tv_limit_height);
        this.rlMinus = rootView.findViewById(C0885R.C0889id.rl_minus);
        this.rlPlus = rootView.findViewById(C0885R.C0889id.rl_plus);
        this.mSeekBar = (SeekBar) rootView.findViewById(C0885R.C0889id.sb_value);
        this.mSeekBar.setMax(this.MAX);
        this.imgFlag = (ImageView) rootView.findViewById(C0885R.C0889id.img_ai_return_flag);
    ...
    public void onClick(View v) {
        ...
        } else if (id == C0885R.C0889id.rl_plus && this.mSeekBar.getProgress() != this.MAX) {
            this.mSeekBar.setProgress(this.mSeekBar.getProgress() + (this.accuracy * 1));
            setHeightLimit();
        }
    }
