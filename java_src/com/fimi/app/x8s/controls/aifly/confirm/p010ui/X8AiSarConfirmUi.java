...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiSarConfirmUi */
/* loaded from: classes.dex */
public class X8AiSarConfirmUi implements View.OnClickListener {
    private View btnOk;
    ...
    public X8AiSarConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_sar_confirm_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.imgFlag = (ImageView) rootView.findViewById(C0885R.C0889id.img_sar_flag);
        this.imgFlag.setImageBitmap(ImageUtils.getBitmapByPath(rootView.getContext(), C0885R.C0888drawable.x8_img_ai_sar_flag));
    }
    ...
    public void onClick(View v) {
        ...
        if (id == C0885R.C0889id.img_ai_follow_return) {
            ...
            if (this.cbTip.isChecked()) {
                X8AiConfig.getInstance().setAiSar(false);
            } else {
                X8AiConfig.getInstance().setAiSar(true);
            }
            this.mX8MainAiFlyController.onSarConfirmOkClick();
        }
    }
