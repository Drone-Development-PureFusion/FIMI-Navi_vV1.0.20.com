...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiSurroundToPointExcuteConfirmUi */
...
public class X8AiSurroundToPointExcuteConfirmUi implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public X8AiSurroundToPointExcuteConfirmUi(Activity activity, View parent, float radius) {
        ...
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_surround_to_point__excute_confirm_layout, (ViewGroup) parent, true);
        this.f107r = Math.round(radius);
        this.MAX = (float) Math.sqrt(this.f107r * 1.5d);
        if (this.MAX > 10.0f) {
            this.MAX = 10.0f;
        }
        this.MAX_PROGRESS = (int) ((this.MAX - this.MIN) * 10.0f);
    ...
    public void initView(View rootView) {
        ...
        this.tvRotation1 = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_rotation1);
        this.tvRotation2 = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_rotation2);
        this.tvOrientation1 = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_orientation1);
        this.tvOrientation2 = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_orientation2);
    ...
    public void onClick(View v) {
        ...
        if (id == C0885R.C0889id.rl_minus) {
            ...
            onGoClick();
        } else if (id == C0885R.C0889id.tv_ai_rotation1) {
            this.tvRotation1.setSelected(true);
            this.tvRotation2.setSelected(false);
        } else if (id == C0885R.C0889id.tv_ai_rotation2) {
            this.tvRotation1.setSelected(false);
            this.tvRotation2.setSelected(true);
        } else if (id == C0885R.C0889id.tv_ai_orientation1) {
            this.tvOrientation1.setSelected(true);
            this.tvOrientation2.setSelected(false);
        } else if (id == C0885R.C0889id.tv_ai_orientation2) {
    ...
    public void onGoClick() {
        ...
        if (alt >= 5.0f) {
            ...
            X8ToastUtil.showToast(this.contentView.getContext(), this.contentView.getContext().getString(C0885R.string.height_tip), 0);
        }
    }
