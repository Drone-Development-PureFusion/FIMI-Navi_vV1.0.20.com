...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLineInterestPointController */
...
public class X8AiLineInterestPointController {
    ...
    /* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLineInterestPointController$OnInterestTouchUp */
    /* loaded from: classes.dex */
        ...
        this.view.setOnTouchListener(new View.OnTouchListener() { // from class: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLineInterestPointController.1
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == 0) {
                    ...
                    X8AiLineInterestPointController.this.tmpView.setBackgroundResource(C0885R.C0888drawable.x8_img_ai_line_inreterst_max2);
