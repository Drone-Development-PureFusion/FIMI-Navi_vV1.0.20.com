...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLinesExcuteConfirmUi */
...
public class X8AiLinesExcuteConfirmUi implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, SwitchButton.OnSwitchListener, X8DoubleCustomDialog.onDialogButtonClickListener {
    ...
    Handler mHandler = new Handler() { // from class: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLinesExcuteConfirmUi.11
        ...
        public void handleMessage(Message msg) {
            ...
            if (X8AiLinesExcuteConfirmUi.this.f105i < X8AiLinesExcuteConfirmUi.this.mapPointList.size()) {
                ...
                int i = x8AiLinesExcuteConfirmUi.f105i;
                x8AiLinesExcuteConfirmUi.f105i = i + 1;
    ...
    /* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLinesExcuteConfirmUi$SaveData */
    /* loaded from: classes.dex */
    ...
    public X8AiLinesExcuteConfirmUi(Activity activity, View parent, CameraManager cameraManager) {
        ...
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_line_excute_confirm_layout, (ViewGroup) parent, true);
    ...
    public void initView(View rootView) {
        this.imgBack = (ImageView) rootView.findViewById(C0885R.C0889id.img_ai_follow_return);
        this.mTvLineFollowTitle = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_follow_title);
        this.tvDistance = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_follow_distance);
        this.mTvDistanceTitle = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_follow_confirm_title1);
        this.tvTime = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_follow_time);
        this.tvSpeed = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_follow_speed);
        this.tvPointSize = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_follow_size);
        this.vMinus = rootView.findViewById(C0885R.C0889id.rl_minus);
        this.sbSeekBar = (SeekBar) rootView.findViewById(C0885R.C0889id.sb_value);
        this.vPlus = rootView.findViewById(C0885R.C0889id.rl_plus);
        this.btnGo = (Button) rootView.findViewById(C0885R.C0889id.btn_ai_follow_confirm_ok);
        this.mRlCurveVideotape = (RelativeLayout) rootView.findViewById(C0885R.C0889id.rl_ai_line_curve_videotape);
        this.mCurveVidotape = (X8TabHost) rootView.findViewById(C0885R.C0889id.x8_ai_line_curve_videotape);
        this.mCurveVidotape.setSelect(0);
        this.tvOrientation1 = (X8TabHost) rootView.findViewById(C0885R.C0889id.x8_ai_line_rorate1);
        ...
        this.tvOrientation2 = (X8TabHost) rootView.findViewById(C0885R.C0889id.x8_ai_line_rorate2);
        ...
        this.tbDisconnect = (X8TabHost) rootView.findViewById(C0885R.C0889id.tb_disconnect);
        ...
        this.tbEnd = (X8TabHost) rootView.findViewById(C0885R.C0889id.tb_ai_excute_end);
        ...
        this.mSbRecord = (SwitchButton) rootView.findViewById(C0885R.C0889id.sb_ai_auto_record);
        this.mSbCurve = (SwitchButton) rootView.findViewById(C0885R.C0889id.swb_ai_curve);
        this.sbSeekBar.setMax(this.MAX_PROGRESS);
        this.mSbCurve.setEnabled(true);
        this.mSbRecord.setEnabled(true);
        if (!this.isInSky) {
            this.btnGo.setText(rootView.getContext().getString(C0885R.string.x8_ai_fly_line_save));
        }
    }
    ...
    public void onClick(View v) {
        ...
        } else if (id == C0885R.C0889id.img_ai_follow_return) {
    ...
    public void showDialog() {
        if (this.dialog == null) {
            String t = this.contentView.getContext().getString(C0885R.string.x8_ai_fly_route);
            String m = this.contentView.getContext().getString(C0885R.string.x8_ai_line_save_collector);
            this.dialog = new X8DoubleCustomDialog(this.contentView.getContext(), t, m, this.contentView.getContext().getString(C0885R.string.x8_ai_line_save_fly), this.contentView.getContext().getString(C0885R.string.x8_save), this);
        }
        this.dialog.show();
    }
    ...
    public void startAiLineSetPoint(boolean isSaveData2Collector) {
        ...
        if (this.dataByHistory == null) {
            X8ToastUtil.showToast(this.contentView.getContext(), "" + this.contentView.getContext().getString(C0885R.string.x8_ai_fly_line_save_tip), 1);
        }
    ...
    public void setViewValue() {
        ...
        if (this.aiLineMode == 3) {
            this.tvTime.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_lines_setting_curve_lessthan) + time + "S");
            this.mTvLineFollowTitle.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_lines_curve));
            this.mRlCurveVideotape.setVisibility(0);
        } else if (this.aiLineMode == 0) {
            this.tvTime.setText("" + time + "S");
            this.mTvLineFollowTitle.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_lines_straight));
            this.mRlCurveVideotape.setVisibility(8);
        } else if (this.aiLineMode == 1) {
            this.tvTime.setText("" + time + "S");
            this.mTvLineFollowTitle.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_lines_setting));
            this.mRlCurveVideotape.setVisibility(8);
        } else if (this.aiLineMode == 2) {
            this.tvTime.setText("" + time + "S");
            this.mTvLineFollowTitle.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_line_history));
            this.mRlCurveVideotape.setVisibility(8);
        }
    }
