...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiScrewConfirmUi */
...
public class X8AiScrewConfirmUi implements View.OnClickListener {
    ...
    public X8AiScrewConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_screw_confirm_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.imgFlag = (ImageView) rootView.findViewById(C0885R.C0889id.img_screw_flag);
        this.imgFlag.setImageBitmap(ImageUtils.getBitmapByPath(rootView.getContext(), C0885R.C0888drawable.x8_img_ai_screw_flag));
    }
    ...
    public void onClick(View v) {
        ...
        if (id == C0885R.C0889id.img_ai_follow_return) {
            ...
            if (this.cbTip.isChecked()) {
                X8AiConfig.getInstance().setAiScrew(false);
            } else {
                X8AiConfig.getInstance().setAiScrew(true);
            }
