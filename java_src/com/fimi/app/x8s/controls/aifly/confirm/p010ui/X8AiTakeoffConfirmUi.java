...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiTakeoffConfirmUi */
...
public class X8AiTakeoffConfirmUi implements View.OnClickListener {
    ...
    public X8AiTakeoffConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_takeoff_layout, (ViewGroup) parent, true);
    ...
    public void initViews(View rootView) {
        ...
        this.imgFlag = (ImageView) rootView.findViewById(C0885R.C0889id.img_takeoff_flag);
        this.imgFlag.setImageBitmap(ImageUtils.getBitmapByPath(rootView.getContext(), C0885R.C0888drawable.x8_img_take_off_flag));
    }
