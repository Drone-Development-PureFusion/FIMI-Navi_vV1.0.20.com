...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiSurroundToPointConfirmUi */
...
public class X8AiSurroundToPointConfirmUi implements View.OnClickListener {
    ...
    public X8AiSurroundToPointConfirmUi(Activity activity, View parent) {
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_surround_to_point_confirm_layout, (ViewGroup) parent, true);
    ...
    public void initView(View rootView) {
        ...
        this.imgFlag = (ImageView) rootView.findViewById(C0885R.C0889id.img_surround_flag);
        this.imgFlag.setImageBitmap(ImageUtils.getBitmapByPath(rootView.getContext(), C0885R.C0888drawable.x8_img_surround_point_flag));
    }
