...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLinesPointValueUi */
...
public class X8AiLinesPointValueUi implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public X8AiLinesPointValueUi(Activity activity, View rootView, int mode, MapPointLatLng mpl, X8MapVideoController mapVideoController, X8AiLineExcuteController controller) {
        ...
        if (mode == 0) {
            if (mpl.isIntertestPoint) {
                this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_line_point_interest_layout, (ViewGroup) rootView, true);
            } else {
                this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_line_point_value_layout, (ViewGroup) rootView, true);
            }
        } else if (mode == 3) {
            if (mpl.isIntertestPoint) {
                this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_line_point_interest_layout, (ViewGroup) rootView, true);
            } else {
                this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_line_curve_value_layout, (ViewGroup) rootView, true);
            }
        } else {
            this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_line_point_value_2fpv_layout, (ViewGroup) rootView, true);
        }
    ...
    private void initView(View view, boolean isIntertestPoint) {
        this.btnOk = (Button) view.findViewById(C0885R.C0889id.btn_ai_follow_confirm_ok);
        this.pos = (TextView) view.findViewById(C0885R.C0889id.tv_ai_follow_pos);
        this.tvHeight = (TextView) view.findViewById(C0885R.C0889id.tv_height);
        this.minus = view.findViewById(C0885R.C0889id.rl_minus);
        this.plus = view.findViewById(C0885R.C0889id.rl_plus);
        this.sbValue = (SeekBar) view.findViewById(C0885R.C0889id.sb_value);
        this.sbValue.setMax(this.SB_MAX);
        if (!isIntertestPoint) {
            this.vNa = view.findViewById(C0885R.C0889id.rl_ai_item1);
            this.imgNa = (ImageView) view.findViewById(C0885R.C0889id.img_ai_line_action_na);
            int i = 0 + 1;
            this.arraysView[0] = this.imgNa;
            this.vHover = view.findViewById(C0885R.C0889id.rl_ai_item2);
            this.imgHover = (ImageView) view.findViewById(C0885R.C0889id.img_ai_line_action_hover);
            int i2 = i + 1;
            this.arraysView[i] = this.imgHover;
            this.vRecord = view.findViewById(C0885R.C0889id.rl_ai_item3);
            this.imgRecord = (ImageView) view.findViewById(C0885R.C0889id.img_ai_line_action_record);
            int i3 = i2 + 1;
            this.arraysView[i2] = this.imgRecord;
            this.v4xSlow = view.findViewById(C0885R.C0889id.rl_ai_item4);
            this.img4xSlow = (ImageView) view.findViewById(C0885R.C0889id.img_ai_lind_action_4xslow);
            int i4 = i3 + 1;
            this.arraysView[i3] = this.img4xSlow;
            this.vOnePhoto = view.findViewById(C0885R.C0889id.rl_ai_item5);
            this.imgOnePhoto = (ImageView) view.findViewById(C0885R.C0889id.img_ai_lind_action_one_photo);
            int i5 = i4 + 1;
            this.arraysView[i4] = this.imgOnePhoto;
            this.v5sPhoto = view.findViewById(C0885R.C0889id.rl_ai_item6);
            this.img5sPhoto = (ImageView) view.findViewById(C0885R.C0889id.img_ai_lind_action_5s_photo);
            int i6 = i5 + 1;
            this.arraysView[i5] = this.img5sPhoto;
            this.vThreePhoto = view.findViewById(C0885R.C0889id.rl_ai_item7);
            this.imgThreePhoto = (ImageView) view.findViewById(C0885R.C0889id.img_ai_lind_three_photo);
            int i7 = i6 + 1;
            this.arraysView[i6] = this.imgThreePhoto;
            if (this.mode == 1) {
                this.tvDvOrientation = (TextView) view.findViewById(C0885R.C0889id.tv_ai_line_dv_orientation_value);
                this.tvGbOrientation = (TextView) view.findViewById(C0885R.C0889id.tv_ai_line_gb_orientation_value);
                this.tabRorate = (X8TabHost) view.findViewById(C0885R.C0889id.x8_ai_line_rorate);
                ...
                if (this.controller.getOration() == 1) {
                    view.findViewById(C0885R.C0889id.rl_rorate).setVisibility(0);
                    return;
                } else {
                    view.findViewById(C0885R.C0889id.rl_rorate).setVisibility(8);
                    return;
                }
            } else if (this.mode == 3) {
                this.tvBindPoint = (TextView) view.findViewById(C0885R.C0889id.x8_ai_line_bind_point);
                this.mRecyclerView = (RecyclerView) view.findViewById(C0885R.C0889id.ryv_ai_line_point);
        ...
        this.btnAll = (Button) view.findViewById(C0885R.C0889id.btn_x8_ai_line_bind_point);
        ...
        this.mRecyclerView.addItemDecoration(new DividerGridItemDecoration(this.contentView.getContext()));
        ((SimpleItemAnimator) this.mRecyclerView.getItemAnimator()).setSupportsChangeAnimations(false);
        ((TextView) view.findViewById(C0885R.C0889id.tv_ai_follow_title)).setText(view.getContext().getString(C0885R.string.x8_ai_fly_lines_interest_point_title) + this.mapPointLatLng.nPos);
        lablesInterestEvent();
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == C0885R.C0889id.rl_ai_item1) {
            this.index = 0;
            setSelect(this.index);
        } else if (id == C0885R.C0889id.rl_ai_item2) {
            this.index = 1;
            setSelect(this.index);
        } else if (id == C0885R.C0889id.rl_ai_item3) {
            this.index = 2;
            setSelect(this.index);
        } else if (id == C0885R.C0889id.rl_ai_item4) {
            this.index = 3;
            setSelect(this.index);
        } else if (id == C0885R.C0889id.rl_ai_item5) {
            this.index = 4;
            setSelect(this.index);
        } else if (id == C0885R.C0889id.rl_ai_item6) {
            this.index = 5;
            setSelect(this.index);
        } else if (id == C0885R.C0889id.rl_ai_item7) {
            this.index = 6;
            setSelect(this.index);
        ...
        } else if (id == C0885R.C0889id.btn_x8_ai_line_bind_point) {
    ...
    public void onSelectAll(boolean isAll) {
        ...
        if (isAll) {
            this.btnAll.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_point_bind_interest_unselect));
            this.adapter.setAll(true);
        } else {
            this.btnAll.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_point_bind_interest_select));
    ...
    public void setMapPointLatLng(MapPointLatLng mapPointLatLng) {
        ...
        if (!mapPointLatLng.isActionSave) {
            if (this.mode == 3) {
                this.btnOk.setText(this.contentView.getContext().getString(C0885R.string.x8_setting_fc_loastaction_tips_content_confirm));
            } else {
                this.btnOk.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_lines_point_action_add));
            }
        } else {
            this.btnOk.setText(this.contentView.getContext().getString(C0885R.string.x8_ai_fly_lines_point_action_update));
        }
        ...
        this.adapter.setOnItemClickListener(new X8AiLinePointValueAdapter.OnItemClickListener() { // from class: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiLinesPointValueUi.3
            ...
            public void onItemClicked(int index, int last, boolean isSelect) {
                ...
                if (X8AiLinesPointValueUi.this.count == selectCount2) {
                    X8AiLinesPointValueUi.this.btnAll.setText(X8AiLinesPointValueUi.this.contentView.getContext().getString(C0885R.string.x8_ai_fly_point_bind_interest_unselect));
                    X8AiLinesPointValueUi.this.adapter.setAll(true);
                    return;
                }
                X8AiLinesPointValueUi.this.btnAll.setText(X8AiLinesPointValueUi.this.contentView.getContext().getString(C0885R.string.x8_ai_fly_point_bind_interest_select));
