...
/* renamed from: com.fimi.app.x8s.controls.aifly.confirm.ui.X8AiAutoPhotoExcuteConfirmUi */
...
public class X8AiAutoPhotoExcuteConfirmUi implements View.OnClickListener, SwitchButton.OnSwitchListener {
    ...
    public X8AiAutoPhotoExcuteConfirmUi(Activity activity, View parent, int type, int angle) {
        ...
        this.contentView = activity.getLayoutInflater().inflate(C0885R.layout.x8_ai_auto_photo_excute_confirm_layout, (ViewGroup) parent, true);
        this.mType = type;
        if (type == 0) {
    ...
    public void initViews(View rootView) {
        this.imgReturn = rootView.findViewById(C0885R.C0889id.img_ai_return);
        this.btnOk = rootView.findViewById(C0885R.C0889id.btn_ai_confirm_ok);
        this.tvTitle = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_title);
        this.tvContent = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_next_content1);
        this.tvTime = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_time);
        this.tvSpeed = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_speed);
        this.tvDistance = (TextView) rootView.findViewById(C0885R.C0889id.tv_ai_distance);
        this.vSpeedMinus = rootView.findViewById(C0885R.C0889id.rl_speed_minus);
        this.vSpeedPlus = rootView.findViewById(C0885R.C0889id.rl_speed_plus);
        this.sbSpeed = (X8SeekBarView) rootView.findViewById(C0885R.C0889id.sb_speed);
        this.sbSpeed.setMaxProgress(this.SPEED_MAX_PROGRESS);
        this.vDistanceMinus = rootView.findViewById(C0885R.C0889id.rl_distance_minus);
        this.vDistancePlus = rootView.findViewById(C0885R.C0889id.rl_distance_plus);
        this.sbDistance = (X8SeekBarView) rootView.findViewById(C0885R.C0889id.sb_distance);
        ...
        this.swbAutoReturn = (SwitchButton) rootView.findViewById(C0885R.C0889id.swb_ai_auto_return);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id != C0885R.C0889id.img_ai_return) {
            if (id == C0885R.C0889id.btn_ai_confirm_ok) {
                this.listener.onExcuteClick();
            } else if (id == C0885R.C0889id.rl_speed_minus) {
            ...
            } else if (id == C0885R.C0889id.rl_speed_plus) {
            ...
            } else if (id == C0885R.C0889id.rl_distance_minus) {
            ...
            } else if (id == C0885R.C0889id.rl_distance_plus) {
    ...
    public void setValue() {
        if (this.mType == 0) {
            ...
            String s = this.contentView.getResources().getString(C0885R.string.x8_ai_auto_photo_tip4);
            ...
            this.tvTitle.setText(this.contentView.getResources().getString(C0885R.string.x8_ai_auto_photo_title));
            return;
        }
        this.item = this.mType;
        String s2 = this.contentView.getResources().getString(C0885R.string.x8_ai_auto_photo_vertical_next_tip1);
        ...
        this.tvTitle.setText(this.contentView.getResources().getString(C0885R.string.x8_ai_auto_photo_vertical_title));
    }
