...
public class X8AiD2PExcuteController extends AbsX8AiController implements View.OnClickListener, X8MainPitchingAngle.OnProgressListener, IX8MarkerListener, X8DoubleCustomDialog.onDialogButtonClickListener, X8AiTrackController.OnAiTrackControllerListener {
    ...
    private IX8NextViewListener mIX8NextViewListener = new IX8NextViewListener() { // from class: com.fimi.app.x8s.controls.aifly.X8AiD2PExcuteController.5
    ...
    public void onClick(View v) {
        ...
        } else if (id == C0885R.C0889id.x8_main_ai_point2point_next_blank) {
            closeNextUi(true);
    ...
    public void openUi() {
        ...
        this.handleView = inflater.inflate(C0885R.layout.x8_ai_follow_point2point_layout, (ViewGroup) this.rootView, true);
        ...
        this.vHeight = (X8MainPitchingAngle) this.handleView.findViewById(C0885R.C0889id.x8_pitching_angle);
        this.mTipBgView = (X8AiTipWithCloseView) this.handleView.findViewById(C0885R.C0889id.img_ai_follow_tip);
        ...
        if (this.state == X8AiPointState.IDLE) {
            ...
            this.mTipBgView.setTipText(getString(C0885R.string.x8_ai_fly_follow_select_point));
        ...
        this.nextRootView = this.rootView.findViewById(C0885R.C0889id.x8_main_ai_point2point_next_content);
        this.blank = this.rootView.findViewById(C0885R.C0889id.x8_main_ai_point2point_next_blank);
    ...
    public void showExitDialog() {
        if (this.dialog == null) {
            String t = this.rootView.getContext().getString(C0885R.string.x8_ai_fly_point_to_point);
            String m = this.rootView.getContext().getString(C0885R.string.x8_ai_fly_p2p_exite);
