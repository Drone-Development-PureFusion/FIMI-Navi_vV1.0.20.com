...
public class X8AiScrewExcuteController extends AbsX8AiController implements View.OnClickListener, X8DoubleCustomDialog.onDialogButtonClickListener {
    ...
    private IX8NextViewListener mIX8NextViewListener = new IX8NextViewListener() { // from class: com.fimi.app.x8s.controls.aifly.X8AiScrewExcuteController.2
    ...
    public void onClick(View v) {
        ...
        if (id == C0885R.C0889id.img_ai_follow_back) {
            ...
            if (this.state == ScrewState.IDLE) {
                ...
                if (this.radius >= 200.0f) {
                    ...
                    String tip = String.format(this.activity.getString(C0885R.string.height_tip), X8NumberUtil.getDistanceNumberString(3.0f, 0, true));
        ...
        } else if (id == C0885R.C0889id.main_ai_ai_screw_next_blank) {
            closeNextUi(true);
    ...
    public void openUi() {
        ...
        this.handleView = inflater.inflate(C0885R.layout.x8_ai_screw_layout, (ViewGroup) this.rootView, true);
        ...
        this.prex = this.activity.getString(C0885R.string.x8_ai_fly_screw_hight_distance);
        this.nextRootView = this.rootView.findViewById(C0885R.C0889id.x8_main_ai_screw_next_content);
        this.blank = this.rootView.findViewById(C0885R.C0889id.main_ai_ai_screw_next_blank);
    ...
    public void showExitDialog() {
        ...
        String m = this.rootView.getContext().getString(C0885R.string.x8_ai_fly_screw_exte);
    ...
    public void setCirclePoint() {
        ...
        String prex1 = this.rootView.getContext().getString(C0885R.string.x8_ai_fly_screw_tip5);
    ...
    public void getParmeter() {
        if (!this.isDraw && this.state == ScrewState.RUNNING) {
            ...
            if (this.isGetPoint && this.isGetDistance && this.isGetSpeed) {
                drawScrew(this.f102cw, this.f103r, this.distance);
            }
        }
    }
        ...
        this.mFcManager.getAiSurroundSpeed(new UiCallBackListener<AckAiSurrounds>() { // from class: com.fimi.app.x8s.controls.aifly.X8AiScrewExcuteController.8
            ...
            public void onComplete(CmdResult cmdResult, AckAiSurrounds o) {
                if (cmdResult.isSuccess()) {
                    ...
                    o.getSpeed();
                    if (o.getSpeed() > 0) {
                        X8AiScrewExcuteController.this.f102cw = true;
                        return;
                    } else {
                        X8AiScrewExcuteController.this.f102cw = false;
                        return;
                    }
                }
