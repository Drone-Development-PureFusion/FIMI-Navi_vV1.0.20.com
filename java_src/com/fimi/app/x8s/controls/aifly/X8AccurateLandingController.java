...
public class X8AccurateLandingController {
    ...
    public X8AccurateLandingController(View root) {
        this.root = root;
        this.mTipBgView = (X8AiTipWithCloseView) root.findViewById(C0885R.C0889id.v_accurate_landing_tip);
    }
    ...
    public void onDroneConnected(boolean b) {
        if (!b) {
            ...
            if (StateManager.getInstance().getX8Drone().isAutoLandingCheckObj()) {
                this.mTipBgView.setTipText(this.root.getContext().getString(C0885R.string.x8_accurate_check_obj1));
            } else {
                this.mTipBgView.setTipText(this.root.getContext().getString(C0885R.string.x8_accurate_check_obj0));
            }
