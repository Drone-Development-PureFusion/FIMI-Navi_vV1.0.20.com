...
public class X8AiAutoPhototExcuteController extends AbsX8AiController implements View.OnClickListener, X8DoubleCustomDialog.onDialogButtonClickListener, X8AiTrackController.OnAiTrackControllerListener, IX8AiAutoPhototExcuteListener {
    ...
    private IX8NextViewListener mIX8NextViewListener = new IX8NextViewListener() { // from class: com.fimi.app.x8s.controls.aifly.X8AiAutoPhototExcuteController.2
    ...
    public void showExitDialog() {
        if (this.dialog == null) {
            String t = this.rootView.getContext().getString(C0885R.string.x8_ai_fly_auto_photo);
            String m = this.rootView.getContext().getString(C0885R.string.x8_ai_auto_photo_exite);
    ...
    public void onClick(View v) {
        ...
        if (id == C0885R.C0889id.img_ai_follow_back) {
            ...
            openNextUi();
        } else if (id == C0885R.C0889id.x8_main_ai_auto_photo_next_blank) {
            closeNextUi(true);
    ...
    public void openUi() {
        ...
        this.handleView = inflater.inflate(C0885R.layout.x8_ai_auto_photo_layout, (ViewGroup) this.rootView, true);
        ...
        this.imgNext = (ImageView) this.handleView.findViewById(C0885R.C0889id.img_ai_follow_next);
        ...
        this.imgAutoBg = (ImageView) this.handleView.findViewById(C0885R.C0889id.img_ai_auto_photo_bg);
        this.mAngle = this.handleView.findViewById(C0885R.C0889id.rl_angle);
        this.imgCloud = (ImageView) this.handleView.findViewById(C0885R.C0889id.img_cloud);
        this.tvCloud = (TextView) this.handleView.findViewById(C0885R.C0889id.tv_cloud);
        this.tvTime = (TextView) this.handleView.findViewById(C0885R.C0889id.img_ai_time);
        this.nextRootView = this.rootView.findViewById(C0885R.C0889id.x8_main_ai_auto_photo_next_content);
        this.blank = this.rootView.findViewById(C0885R.C0889id.x8_main_ai_auto_photo_next_blank);
        ...
        if (this.state == X8AiAutoPhotoState.IDLE) {
            ...
            if (this.type == 0) {
                String s = this.rootView.getContext().getString(C0885R.string.x8_ai_auto_photo_tip5);
                ...
                String s2 = this.rootView.getContext().getString(C0885R.string.x8_ai_auto_photo_tip5);
                this.imgAutoBg.setVisibility(8);
