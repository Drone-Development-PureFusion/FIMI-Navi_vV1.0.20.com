...
public class SubParamsViewHolder extends RecyclerView.ViewHolder implements JsonUiCallBackListener, SeekBar.OnSeekBarChangeListener {
    ...
    private Handler handler = new Handler() { // from class: com.fimi.app.x8s.viewHolder.SubParamsViewHolder.2
            ...
            switch (msg.what) {
                case 1:
                    if (SubParamsViewHolder.this.listener != null && SubParamsViewHolder.this.optionValue != null) {
                        ...
                        if (SubParamsViewHolder.this.paramKey.equals(SubParamsViewHolder.this.context.getResources().getString(C0885R.string.x8_camera_saturation))) {
                            ...
                            return;
                        } else if (SubParamsViewHolder.this.paramKey.equals(SubParamsViewHolder.this.context.getResources().getString(C0885R.string.x8_camera_contrast)) && SubParamsViewHolder.this.optionValue.getText().toString() != null) {
    ...
    public SubParamsViewHolder(View itemView, SubParamItemListener itemListener) {
        ...
        this.sub_options = (TextView) itemView.findViewById(C0885R.C0889id.sub_option_name);
        this.optionValue = (TextView) itemView.findViewById(C0885R.C0889id.sub_option_value);
        this.contentLayout = (RelativeLayout) itemView.findViewById(C0885R.C0889id.sub_content_layout);
        this.viewStub = (ViewStub) itemView.findViewById(C0885R.C0889id.camera_style_layout);
        this.styleView = this.viewStub.inflate();
        this.seekBar = (SeekBar) this.styleView.findViewById(C0885R.C0889id.style_seekBar);
        this.seekBar.setOnSeekBarChangeListener(this);
        if (!StateManager.getInstance().getConectState().isCameraConnect()) {
            this.seekBar.setProgress(64);
            this.optionValue.setText("64");
        }
        this.resetBtn = (ImageView) this.styleView.findViewById(C0885R.C0889id.x8_btn_reset);
        this.sharpViewStub = (ViewStub) itemView.findViewById(C0885R.C0889id.camera_sharp_layout);
    }
    ...
    public void initItemData(PhotoSubParamItemEntity itemEntity, int index, boolean enable, int select_index) {
        ...
        if (itemEntity != null) {
            ...
            if (this.paramKey.equals(this.context.getResources().getString(C0885R.string.x8_camera_saturation))) {
            ...
            } else if (this.paramKey.equals(this.context.getResources().getString(C0885R.string.x8_camera_contrast))) {
                this.contrast = nickMap.get("contrast");
                this.optionValue.setVisibility(0);
                if (this.styleView != null) {
                    this.styleView.setVisibility(0);
                }
            } else if (this.paramKey.equals(this.context.getResources().getString(C0885R.string.x8_camera_sharpness))) {
    ...
    private String paramKey2Title(String paramKey) {
        if (this.context.getString(C0885R.string.x8_timelapse_capture_0).contains(paramKey)) {
            String string = this.context.getString(C0885R.string.x8_photo_signal_mode);
            return string;
        } else if (this.context.getString(C0885R.string.x8_timelapse_capture_1).contains(paramKey)) {
            String string2 = this.context.getString(C0885R.string.x8_photo_delay_mode);
            return string2;
        } else if (this.context.getString(C0885R.string.x8_timelapse_capture_8).contains(paramKey)) {
            String string3 = this.context.getString(C0885R.string.x8_photo_panorama_mode);
            return string3;
        } else if (this.context.getString(C0885R.string.x8_timelapse_record_0).contains(paramKey)) {
            String string4 = this.context.getString(C0885R.string.x8_record_normal);
            return string4;
        } else if (this.context.getString(C0885R.string.x8_timelapse_record_1).contains(paramKey)) {
            String string5 = this.context.getString(C0885R.string.x8_record_cut_mode);
            return string5;
        } else {
            return paramKey;
        }
    ...
    public void addParamContent(Context context, CameraManager cameraManager, int layout_id, String... optionName) {
        ...
        if (optionName[0].equals(context.getResources().getString(C0885R.string.x8_camera_awb))) {
            this.awbController = new X8CameraAwbItemController(paramView, cameraManager);
            this.optionValue.setVisibility(0);
        } else if (!optionName[0].equals(context.getResources().getString(C0885R.string.x8_camera_style))) {
            if (optionName[0].equals(context.getResources().getString(C0885R.string.x8_video_resolution))) {
            ...
            } else if (optionName[0].equals(context.getResources().getString(C0885R.string.x8_photo_mode))) {
            ...
            } else if (optionName[0].equals(context.getResources().getString(C0885R.string.x8_record_mode))) {
        ...
        this.resetBtn.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.app.x8s.viewHolder.SubParamsViewHolder.1
            ...
            public void onClick(View v) {
                if (SubParamsViewHolder.this.listener != null) {
                    SubParamsViewHolder.this.listener.setRecyclerScroller(true);
                    if (!SubParamsViewHolder.this.paramKey.equals(SubParamsViewHolder.this.context.getResources().getString(C0885R.string.x8_camera_saturation))) {
                        if (SubParamsViewHolder.this.paramKey.equals(SubParamsViewHolder.this.context.getResources().getString(C0885R.string.x8_camera_contrast))) {
    ...
    public void initSharpViewStub() {
        ...
        this.sharpView.setVisibility(0);
        this.normalTv = (TextView) this.sharpView.findViewById(C0885R.C0889id.normal_v);
        this.sharpTv = (TextView) this.sharpView.findViewById(C0885R.C0889id.sharp_v);
    }
    ...
    private void updateEnable(boolean enable) {
        ...
        if (enable) {
            if (!isSubOptionsSetTextColor(keyString)) {
                this.optionValue.setTextColor(this.context.getResources().getColor(C0885R.C0887color.x8_value_select));
                this.sub_options.setTextColor(this.context.getResources().getColor(C0885R.C0887color.x8_value_unselected));
                ...
                int[] colorsRecording = {this.context.getResources().getColor(C0885R.C0887color.x8_value_disable_select), this.context.getResources().getColor(C0885R.C0887color.x8_value_disable)};
                ...
                int[] colors = {this.context.getResources().getColor(C0885R.C0887color.x8_value_select), this.context.getResources().getColor(C0885R.C0887color.x8_value_unselected)};
                ColorStateList colorStateList = new ColorStateList(states, colors);
                this.sub_options.setTextColor(colorStateList);
            }
        } else if (!isSubOptionsSetTextColor(keyString)) {
            this.optionValue.setTextColor(this.context.getResources().getColor(C0885R.C0887color.x8_value_disable));
            this.sub_options.setTextColor(this.context.getResources().getColor(C0885R.C0887color.x8_value_disable));
        } else {
            this.sub_options.setEnabled(false);
            int[][] states2 = {new int[]{16842913}, new int[]{-16842910}};
            int[] colors2 = {this.context.getResources().getColor(C0885R.C0887color.x8_value_disable_select), this.context.getResources().getColor(C0885R.C0887color.x8_value_disable)};
    ...
    private boolean isSubOptionsSetTextColor(String titleName) {
        if (titleName.equals(this.context.getResources().getString(C0885R.string.x8_camera_style))) {
            return false;
        }
        return true;
    }
    ...
    public boolean isRecordingUnclickableItem(String titleName) {
        if (CameraParamStatus.modelStatus == CameraParamStatus.CameraModelStatus.recording) {
            if (titleName.equals(this.context.getResources().getString(C0885R.string.x8_record_mode)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_video_type)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_video_resolution)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_record_quality))) {
                return true;
            }
            return false;
        }
    ...
    public boolean isDelayedPhotographyUnclickableItem(String titleName) {
        if (StateManager.getInstance().getCamera().isDelayedPhotography()) {
            if (titleName.equals(this.context.getResources().getString(C0885R.string.x8_photo_mode)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_photo_size)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_photo_format)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_camera_awb)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_camera_digita)) || titleName.equals(this.context.getResources().getString(C0885R.string.x8_camera_style))) {
                return true;
            }
            return false;
        }
