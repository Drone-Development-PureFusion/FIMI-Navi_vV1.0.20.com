...
public class X8BatteryLayout extends RelativeLayout {
    ...
    private void initView(Context context, @Nullable AttributeSet attrs) {
        ...
        View myView = mInflater.inflate(C0885R.layout.x8_view_battery_layout, (ViewGroup) null);
        addView(myView);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, C0885R.styleable.batteryLayout);
        this.batteryName = typedArray.getString(C0885R.styleable.batteryLayout_coreName);
        this.defaultValue = typedArray.getString(C0885R.styleable.batteryLayout_defaultValue);
        typedArray.recycle();
        this.batteryCoreView = (X8BatteryView) myView.findViewById(C0885R.C0889id.img_battery_core_view);
        this.tvBatteryCoreState = (TextView) myView.findViewById(C0885R.C0889id.img_battery_core_state);
    ...
    public void setData(double curVoltage, double otherVoltage1, double otherVoltage2, int disChargeCnt) {
        ...
        switch (state) {
            case 1:
                tip = String.format(getContext().getString(C0885R.string.x8_battery_setting_format), String.valueOf(X8BatteryView.COLOR_ABNORMAL_YELLOW), getContext().getString(C0885R.string.x8_battery_setting_over_pressure));
                break;
            case 2:
                tip = String.format(getContext().getString(C0885R.string.x8_battery_setting_format), String.valueOf(X8BatteryView.COLOR_SERIOUS_RED), getContext().getString(C0885R.string.x8_battery_setting_corrupted));
                break;
            case 3:
                tip = String.format(getContext().getString(C0885R.string.x8_battery_setting_format), String.valueOf(X8BatteryView.COLOR_ABNORMAL_YELLOW), getContext().getString(C0885R.string.x8_battery_setting_over_release));
                break;
            case 4:
                tip = String.format(getContext().getString(C0885R.string.x8_battery_setting_format), String.valueOf(X8BatteryView.COLOR_SERIOUS_RED), getContext().getString(C0885R.string.x8_battery_setting_over_release_serious));
                break;
        }
