...
public class X8PieView extends View {
    ...
    public X8PieView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.dataTextColor = SupportMenu.CATEGORY_MASK;
        this.circleWidth = 100.0f;
        TypedArray typedArray = context.obtainStyledAttributes(attrs, C0885R.styleable.PieView);
        this.dataTextSize = typedArray.getDimension(C0885R.styleable.PieView_dataTextSize, this.dataTextSize);
        this.circleWidth = typedArray.getDimension(C0885R.styleable.PieView_circleWidth, this.circleWidth);
        this.dataTextColor = typedArray.getColor(C0885R.styleable.PieView_dataTextColor, this.dataTextColor);
        typedArray.recycle();
        init();
    }
