...
public class X8TabHost extends LinearLayout implements View.OnClickListener {
    ...
    public X8TabHost(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public X8TabHost(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void readAttr(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0885R.styleable.X8TabHost);
        int i = a.getInt(C0885R.styleable.X8TabHost_default_index, 0);
        this.curIndex = i;
        this.lastIndex = i;
        this.radius = a.getDimensionPixelSize(C0885R.styleable.X8TabHost_radiusC, dpToPx(this.radius));
        this.backBg = a.getColor(C0885R.styleable.X8TabHost_bg, -1);
        this.lineColor = a.getColor(C0885R.styleable.X8TabHost_lineColor, -1);
        this.lineStroke = a.getDimensionPixelSize(C0885R.styleable.X8TabHost_lineStroke, dpToPx(this.lineStroke));
        this.unSelectTabBg = a.getColor(C0885R.styleable.X8TabHost_tab_unselect_color, Color.parseColor("#51B5EF"));
        this.selectTabBg = a.getColor(C0885R.styleable.X8TabHost_tab_select_color, -1);
        this.unSelectTextColor = a.getColor(C0885R.styleable.X8TabHost_text_unselect_color, -1);
        this.selectTextColor = a.getColor(C0885R.styleable.X8TabHost_text_select_color, Color.parseColor("#51B5EF"));
        this.space = a.getDimensionPixelSize(C0885R.styleable.X8TabHost_tab_space, 1);
        this.tabWidth = a.getDimensionPixelSize(C0885R.styleable.X8TabHost_tab_width, dpToPx(this.tabWidth));
        this.tabHeight = a.getDimensionPixelSize(C0885R.styleable.X8TabHost_tab_height, -1);
        this.textSize = a.getDimension(C0885R.styleable.X8TabHost_text_sizeC, this.textSize);
        CharSequence[] arr = a.getTextArray(C0885R.styleable.X8TabHost_src);
        if (arr != null) {
            String[] tArr = new String[arr.length];
            for (int i2 = 0; i2 < arr.length; i2++) {
                tArr[i2] = String.valueOf(arr[i2]);
            }
            this.textArr = tArr;
        }
        a.recycle();
    ...
    public void onClick(View v) {
        ...
        if (this.mOnSelectListener != null) {
            this.mOnSelectListener.onSelect(index, this.textArr[index], last);
        }
    }
    ...
    public void upSelect(int index, boolean isSame) {
        if (index != this.curIndex || !isSame) {
            TextView tv = (TextView) getChildAt(this.curIndex);
            tv.setTextColor(this.unSelectTextColor);
            GradientDrawable d = getFitGradientDrawable(this.curIndex);
            d.setColor(this.unSelectTabBg);
            ...
            if (this.mOnSelectListener != null) {
                this.mOnSelectListener.onSelect(index, this.textArr[index], this.lastIndex);
            }
        }
    }
