...
public class X8CustomVideoView extends RelativeLayout implements View.OnClickListener, TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnInfoListener, MediaPlayer.OnErrorListener, MediaPlayer.OnBufferingUpdateListener, SeekBar.OnSeekBarChangeListener {
    ...
    private Handler mHandler = new Handler() { // from class: com.fimi.app.x8s.widget.videoview.X8CustomVideoView.1
                ...
                case 1:
                    if (X8CustomVideoView.this.isPlaying()) {
                        if (!X8CustomVideoView.this.isUpdateProgressed) {
                            ...
                            LogUtil.m1326i(X8CustomVideoView.TAG, "handleMessage: currentPosition:" + currentPosition + ",max:" + X8CustomVideoView.this.mPlaySb.getMax());
    ...
    private void initView() {
        ...
        this.mPlayerView = (RelativeLayout) layoutInflater.inflate(C0885R.layout.x8_custom_video_view, this);
        this.mPlayerView.setOnClickListener(this);
        this.mLoadingBar = (ProgressBar) this.mPlayerView.findViewById(C0885R.C0889id.load_iv);
        this.mVideoView = (TextureView) this.mPlayerView.findViewById(C0885R.C0889id.play_video_textureview);
        this.mBtnPlayMax = (Button) this.mPlayerView.findViewById(C0885R.C0889id.btn_play_max);
        this.mBtnPlayMax.setOnClickListener(this);
        this.mVideoView.setOnClickListener(this);
        this.mVideoView.setKeepScreenOn(true);
        this.mVideoView.setSurfaceTextureListener(this);
        this.mBottomPlayRl = (RelativeLayout) this.mPlayerView.findViewById(C0885R.C0889id.bottom_play_rl);
        this.mMiniPlayBtn = (ImageButton) this.mBottomPlayRl.findViewById(C0885R.C0889id.play_btn);
        this.mPlaySb = (SeekBar) this.mBottomPlayRl.findViewById(C0885R.C0889id.play_sb);
        this.mPlaySb.setOnSeekBarChangeListener(this);
        this.mMiniPlayBtn.setOnClickListener(this);
        this.mCurrentTimeTv = (TextView) this.mBottomPlayRl.findViewById(C0885R.C0889id.time_current_tv);
        this.mCurrentTimeTv.setText(setTimeFormatter(0));
        this.mTotalTimeTv = (TextView) this.mBottomPlayRl.findViewById(C0885R.C0889id.total_time_tv);
    ...
    public void onClick(View view) {
        if (view.getId() == C0885R.C0889id.play_video_textureview) {
            if (this.mBottomPlayRl.getVisibility() == 0) {
        ...
        } else if (view.getId() == C0885R.C0889id.play_btn || view.getId() == C0885R.C0889id.btn_play_max) {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i1) {
        LogUtil.m1326i(TAG, "onSurfaceTextureAvailable");
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i1) {
        LogUtil.m1326i(TAG, "onSurfaceTextureSizeChanged");
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        LogUtil.m1326i(TAG, "onPrepare:" + getDuration());
        showPlayView();
    ...
    public void onCompletion(MediaPlayer mp) {
        LogUtil.m1326i(TAG, "onCompletion:" + Thread.currentThread().getName());
        ...
        if (this.mediaPlayer != null) {
            ...
            this.mediaPlayer.setOnSeekCompleteListener(new MediaPlayer.OnSeekCompleteListener() { // from class: com.fimi.app.x8s.widget.videoview.X8CustomVideoView.2
                ...
                public void onSeekComplete(MediaPlayer mp) {
                    LogUtil.m1330d(X8CustomVideoView.TAG, "do seek and resume");
        ...
        if (this.playerState == 1) {
            ...
            if (isPlaying()) {
                ...
                this.mediaPlayer.setOnSeekCompleteListener(new MediaPlayer.OnSeekCompleteListener() { // from class: com.fimi.app.x8s.widget.videoview.X8CustomVideoView.3
                    @Override // android.media.MediaPlayer.OnSeekCompleteListener
                    public void onSeekComplete(MediaPlayer mp) {
                        LogUtil.m1330d(X8CustomVideoView.TAG, "do seek and pause");
    ...
    private void showPauseView(boolean show) {
        ...
        this.mMiniPlayBtn.setImageResource(show ? C0885R.C0888drawable.album_btn_media_stop_selector : C0885R.C0888drawable.album_btn_media_play_selector);
        this.mBtnPlayMax.setVisibility(show ? 8 : 0);
    }

    private void showLoadingView() {
        this.mLoadingBar.setVisibility(0);
        this.mMiniPlayBtn.setImageResource(C0885R.C0888drawable.album_btn_media_play_selector);
    ...
    private void showPlayView() {
        this.mLoadingBar.setVisibility(8);
        this.mMiniPlayBtn.setImageResource(C0885R.C0888drawable.album_btn_media_stop_selector);
