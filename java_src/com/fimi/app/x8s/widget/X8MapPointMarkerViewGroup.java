...
public class X8MapPointMarkerViewGroup extends ViewGroup {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray mTypedArray = context.obtainStyledAttributes(attrs, C0885R.styleable.X8MapPointView);
            this.type = mTypedArray.getInt(C0885R.styleable.X8MapPointView_type, 1);
            this.magin1 = mTypedArray.getDimensionPixelSize(C0885R.styleable.X8MapPointView_margin1, dip2px(this.defaultMagin));
            this.magin2 = mTypedArray.getDimensionPixelSize(C0885R.styleable.X8MapPointView_margin2, dip2px(this.defaultMagin));
            this.magin3 = mTypedArray.getDimensionPixelSize(C0885R.styleable.X8MapPointView_margin3, dip2px(this.defaultMagin));
            mTypedArray.recycle();
        }
        this.paintColor = getContext().getResources().getColor(C0885R.C0887color.black_65);
        this.textBg = C0885R.C0888drawable.x8_ai_follow_marker_info_bg;
    }
    ...
    protected void onDraw(Canvas canvas) {
        Paint p = new Paint();
        if (this.isSelect) {
            this.paintColor = getContext().getResources().getColor(C0885R.C0887color.colorAccent);
            this.textBg = C0885R.C0888drawable.x8_ai_follow_marker_info_select_bg;
        } else {
            this.paintColor = getContext().getResources().getColor(C0885R.C0887color.black_65);
            this.textBg = C0885R.C0888drawable.x8_ai_follow_marker_info_bg;
        }
        ...
        if (this.type == 1) {
            View v1 = (TextView) getChildAt(0);
            View v2 = (TextView) getChildAt(3);
            v1.setBackgroundResource(this.textBg);
            int startY = v1.getMeasuredHeight();
            int endY = getMeasuredHeight() - v2.getMeasuredHeight();
            if (this.isRelation) {
                v2.setBackgroundResource(C0885R.C0888drawable.x8_ai_follow_marker_info_select_bg);
                canvas.drawLine(getMeasuredWidth() / 2, startY, getMeasuredWidth() / 2, endY - this.lintTop, p);
                p.setColor(getContext().getResources().getColor(C0885R.C0887color.colorAccent));
    ...
    private int measureWidth(int measureSpec, int width) {
        ...
        int result = Math.min(width, size);
        return result;
    }
