...
public class X8AiLineHistoryAdapter2 extends RecyclerView.Adapter<HistoryViewHolder> {
    ...
    public X8AiLineHistoryAdapter2(Context context, List<X8AiLinePointInfo> list, int type) {
        ...
        this.list = list;
        this.type = type;
        this.f97p = context.getString(C0885R.string.x8_ai_fly_line_history_time_pattern);
    }

    @Override // android.support.p004v7.widget.RecyclerView.Adapter
    /* renamed from: onCreateViewHolder  reason: collision with other method in class */
    public HistoryViewHolder mo1873onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = this.inflater.inflate(C0885R.layout.x8_ai_line_history_item_layout, parent, false);
    ...
    public void onBindViewHolder(HistoryViewHolder holder, final int position) {
        ...
        String time = DateUtil.getStringByFormat3(info.getTime(), this.f97p);
        ...
        if (info.getSaveFlag() == 1) {
            if (this.type == 0) {
                holder.mImgSaveFlag.setBackgroundResource(C0885R.C0888drawable.x8_btn_save_flag_selector);
            } else {
                holder.mImgSaveFlag.setBackgroundResource(C0885R.C0888drawable.x8_btn_cancle_save_flag_selector);
            }
        } else if (info.getSaveFlag() == 0) {
            holder.mImgSaveFlag.setBackgroundResource(C0885R.C0888drawable.x8_btn_unsave_flag_selector);
        }
        holder.rlSaveFlag.setTag(info);
        holder.rlSaveFlag.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.app.x8s.adapter.X8AiLineHistoryAdapter2.1
        ...
        holder.rlRootView.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.app.x8s.adapter.X8AiLineHistoryAdapter2.2
            @Override // android.view.View.OnClickListener
    ...
    public class HistoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public HistoryViewHolder(View itemView) {
            ...
            this.mTvItemTitle3 = (TextView) itemView.findViewById(C0885R.C0889id.tvItme3);
            this.mTvItemTitle4 = (TextView) itemView.findViewById(C0885R.C0889id.tvItme4);
            this.mTvItemTitle5 = (TextView) itemView.findViewById(C0885R.C0889id.tvItme5);
            this.mTvItemTitle6 = (TextView) itemView.findViewById(C0885R.C0889id.tvItme6);
    ...
    public void showCancleDialog(final X8AiLinePointInfo info, final int index) {
        String t = this.context.getString(C0885R.string.x8_ai_line_cancle_save_title);
        String m = this.context.getString(C0885R.string.x8_ai_line_cancle_save_tip);
        String l = this.context.getString(C0885R.string.cancel);
        String r = this.context.getString(C0885R.string.x8_dialog_delete);
        X8DoubleCustomDialog dialog = new X8DoubleCustomDialog(this.context, t, m, l, r, new X8DoubleCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.adapter.X8AiLineHistoryAdapter2.4
    ...
    public void showMaxSaveDialog() {
        String t = this.context.getString(C0885R.string.x8_ai_line_max_save_title);
        String m = this.context.getString(C0885R.string.x8_ai_line_max_save_tip);
        String l = this.context.getString(C0885R.string.x8_ai_line_save_cancle);
        String r = this.context.getString(C0885R.string.x8_ai_line_save_ok);
        X8DoubleCustomDialog dialogMax = new X8DoubleCustomDialog(this.context, t, m, l, r, new X8DoubleCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.adapter.X8AiLineHistoryAdapter2.5
            @Override // com.fimi.app.x8s.widget.X8DoubleCustomDialog.onDialogButtonClickListener
            public void onLeft() {
            }
    ...
    public static String secToTime(int time) {
        ...
        int minute = time / 60;
        if (minute == 0) {
            timeStr = time + C2354g.f1005ap;
        } else if (minute < 60) {
            int second = time % 60;
            timeStr = minute + "min " + second + C2354g.f1005ap;
        } else {
            int hour = minute / 60;
            if (hour > 99) {
                return "99:59:59";
            ...
            timeStr = hour + "h " + minute2 + "min " + second2 + C2354g.f1005ap;
        }
        return timeStr;
    }
    ...
    public static String unitFormat(int i) {
        if (i >= 0 && i < 10) {
            String retStr = "0" + Integer.toString(i);
            return retStr;
        }
        String retStr2 = "" + i;
        return retStr2;
    ...
    public void showEditorDialog(final int positon, final X8AiLinePointInfo info1) {
        String t = this.context.getString(C0885R.string.x8_ai_line_editor);
        final X8EditorCustomDialog dialogEditor = new X8EditorCustomDialog(this.context, t, new X8EditorCustomDialog.onDialogButtonClickListener() { // from class: com.fimi.app.x8s.adapter.X8AiLineHistoryAdapter2.6
        ...
        dialogEditor.show();
        dialogEditor.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.fimi.app.x8s.adapter.X8AiLineHistoryAdapter2.7
            @Override // android.content.DialogInterface.OnDismissListener
            public void onDismiss(DialogInterface dialogInterface) {
                dialogEditor.hideSoftInputFromWindow();
            }
        });
    }
}
