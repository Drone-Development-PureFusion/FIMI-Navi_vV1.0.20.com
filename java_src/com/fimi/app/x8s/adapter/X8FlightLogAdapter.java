...
import com.fimi.app.x8s.p011ui.activity.X8FlightPlaybackActivity;
...
public class X8FlightLogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder mo1873onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            View view = LayoutInflater.from(parent.getContext()).inflate(C0885R.layout.x8_flight_log_header_layout, parent, false);
            return new X8B2oxHeaderViewHolder(view);
        } else if (viewType == 1) {
            View view2 = LayoutInflater.from(parent.getContext()).inflate(C0885R.layout.x8_flight_log_item_layout, parent, false);
    ...
    private void onBindContentViewHolder(RecyclerView.ViewHolder holder, int positionSection, int position1, X8FlightLogSection section) {
        ...
        switch (file.getState()) {
            case IDLE:
                ...
                break;
            case SUCCESS:
                int resId = C0885R.C0888drawable.x8_img_playback_syn_end;
    ...
    public class X8B2oxViewHolder extends RecyclerView.ViewHolder {
        ...
        public X8B2oxViewHolder(View itemView) {
            ...
            this.x8IvFlightlogCollect = (ImageView) itemView.findViewById(C0885R.C0889id.x8_iv_flightlog_collect);
            this.x8FlightlogItmeDate = (TextView) itemView.findViewById(C0885R.C0889id.x8_flightlog_itme_date);
            this.x8FlightlogItemMileage = (TextView) itemView.findViewById(C0885R.C0889id.x8_flightlog_item_mileage);
            this.x8FlightlogItemSize = (TextView) itemView.findViewById(C0885R.C0889id.x8_flightlog_item_size);
            this.x8FlightlogItemTime = (TextView) itemView.findViewById(C0885R.C0889id.x8_flightlog_item_time);
