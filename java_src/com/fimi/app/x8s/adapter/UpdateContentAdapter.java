...
public class UpdateContentAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(this.mContext).inflate(C0885R.layout.x8_item_update_detail, (ViewGroup) null);
            viewHandle.tvSysnameFlag = (TextView) view.findViewById(C0885R.C0889id.tv_sysname_flag);
            viewHandle.tvSysname = (TextView) view.findViewById(C0885R.C0889id.tv_sysname);
            viewHandle.tvSyscontent = (TextView) view.findViewById(C0885R.C0889id.tv_sys_content);
