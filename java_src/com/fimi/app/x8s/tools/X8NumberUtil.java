...
public class X8NumberUtil {
    ...
    public static void resetPrexString(Context context) {
        if (GlobalConfig.getInstance().isShowmMtric()) {
            prexDistance = context.getResources().getString(C0885R.string.x8_unit_distance);
            prexSpeed = context.getResources().getString(C0885R.string.x8_unit_speed);
            return;
        }
        prexDistance = context.getResources().getString(C0885R.string.x8_unit_distance_en);
        prexSpeed = context.getResources().getString(C0885R.string.x8_unit_speed_en);
    }
