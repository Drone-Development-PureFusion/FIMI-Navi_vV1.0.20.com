...
import com.fimi.app.x8s.p011ui.presenter.X8LocalFragmentPresenter;
import com.fimi.app.x8s.widget.X8DoubleCustomDialog;
import com.fimi.kernel.base.BaseFragment;
import com.fimi.kernel.utils.FontUtil;
import com.fimi.kernel.utils.SizeTool;
import java.lang.ref.WeakReference;
/* renamed from: com.fimi.app.x8s.ui.album.x8s.X8MediaBaseFragment */
...
public abstract class X8MediaBaseFragment extends BaseFragment implements INodataTip {
            ...
            public void onClick(View v) {
                if (X8MediaBaseFragment.this.mBaseFragmentPresenter != null) {
                    if (X8MediaBaseFragment.this.mBaseFragmentPresenter.querySelectSize() > 0) {
                        ...
                        Toast.makeText(X8MediaBaseFragment.this.contextWeakReference.get(), C0885R.string.no_select_file, 0).show();
                    }
                }
            }
        });
    ...
    void initView(View view) {
        this.mProgressBar = (ProgressBar) view.findViewById(C0885R.C0889id.loading);
        this.rlMediaNoDataTip = (RelativeLayout) view.findViewById(C0885R.C0889id.x9_media_no_data_tip);
        this.lbBottomDelect = (ImageButton) view.findViewById(C0885R.C0889id.ibtn_delete);
        this.lbBottomDownload = (ImageButton) view.findViewById(C0885R.C0889id.ibtn_download);
        this.mTvBottomDelete = (TextView) view.findViewById(C0885R.C0889id.tv_bottom_delete);
        this.mTvBottomDownload = (TextView) view.findViewById(C0885R.C0889id.tv_bottom_download);
        this.rlMediaSelectBottom = (RelativeLayout) view.findViewById(C0885R.C0889id.rl_bottom_bar);
        this.mRecyclerView = (RecyclerView) view.findViewById(C0885R.C0889id.recycleview);
        this.mRlDownload = (RelativeLayout) view.findViewById(C0885R.C0889id.rl_download);
        this.mRlBottomBar = (RelativeLayout) view.findViewById(C0885R.C0889id.rl_bottom_bar);
        if (!this.isCamera) {
    ...
    /* renamed from: com.fimi.app.x8s.ui.album.x8s.X8MediaBaseFragment$MyGridLayoutManager */
    /* loaded from: classes.dex */
    public class MyGridLayoutManager extends GridLayoutManager {
        ...
        @Override // android.support.p004v7.widget.GridLayoutManager, android.support.p004v7.widget.LinearLayoutManager, android.support.p004v7.widget.RecyclerView.LayoutManager
