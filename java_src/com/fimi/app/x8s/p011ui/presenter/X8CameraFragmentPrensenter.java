...
import com.fimi.app.x8s.p011ui.album.x8s.X8MediaThumDownloadManager;
...
/* renamed from: com.fimi.app.x8s.ui.presenter.X8CameraFragmentPrensenter */
...
public class X8CameraFragmentPrensenter<T extends MediaModel> extends X8BaseMediaFragmentPresenter<T> implements Handler.Callback {
    ...
    private OnDownloadUiListener mOnDownloadUiListener = new OnDownloadUiListener() { // from class: com.fimi.app.x8s.ui.presenter.X8CameraFragmentPrensenter.8
    ...
    private OnDownloadUiListener mOnOriginalDownloadUiListener = new OnDownloadUiListener() { // from class: com.fimi.app.x8s.ui.presenter.X8CameraFragmentPrensenter.9
        @Override // com.fimi.album.interfaces.OnDownloadUiListener
        public void onProgress(MediaModel model, int progrss) {
        ...
        public void onSuccess(MediaModel model) {
            LogUtil.m1326i("download", "onSuccess1: name:" + model.getName());
            model.setProgress(0);
        ...
        public void onFailure(MediaModel model) {
            LogUtil.m1326i("download", "onFailure1: name:" + model.getName());
            X8CameraFragmentPrensenter.this.mPanelRecycleAdapter.notifyItemChanged(model.getItemPosition());
        }

        @Override // com.fimi.album.interfaces.OnDownloadUiListener
        public void onStop(MediaModel model) {
            LogUtil.m1326i("download", "onStop1: name:" + model.getName());
            X8CameraFragmentPrensenter.this.mPanelRecycleAdapter.notifyItemChanged(model.getItemPosition());
        }
    };
    ...
    private void doHeadTrans(HeadRecyleViewHolder headRecyleViewHolder, int position) {
        headRecyleViewHolder.mTvHeard.setText(this.context.getString(C0885R.string.x8_album_head_title, DataManager.obtain().getX8CameraVideoCount() + "", DataManager.obtain().getX8CameraPhotoCount() + ""));
    }
        ...
        if (mediaModel != null) {
            ...
            if (!TextUtils.isEmpty(currentFilePath)) {
                ...
                if (mediaModel.isDownLoadThum() && !mediaModel.isDownloading()) {
                    ...
                    LogUtil.m1326i(TAG, "doBodyTrans3: ");
    ...
    /* renamed from: com.fimi.app.x8s.ui.presenter.X8CameraFragmentPrensenter$LocalFileDeleteReceiver */
    /* loaded from: classes.dex */
