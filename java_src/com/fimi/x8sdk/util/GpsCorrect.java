...
public class GpsCorrect {
    ...
    /* renamed from: a */
    static final double f258a = 6378245.0d;

    /* renamed from: ee */
    static final double f259ee = 0.006693421622965943d;

    /* renamed from: pi */
    static final double f260pi = 3.141592653589793d;
    ...
    public static void transform(double wgLat, double wgLon, double[] latlng) {
        ...
        double radLat = (wgLat / 180.0d) * f260pi;
        double magic = Math.sin(radLat);
        double magic2 = 1.0d - ((f259ee * magic) * magic);
        double sqrtMagic = Math.sqrt(magic2);
        double dLat2 = (180.0d * dLat) / ((6335552.717000426d / (magic2 * sqrtMagic)) * f260pi);
        double dLon2 = (180.0d * dLon) / (((f258a / sqrtMagic) * Math.cos(radLat)) * f260pi);
    ...
    private static double transformLat(double x, double y) {
        ...
        return ret + ((((20.0d * Math.sin((6.0d * x) * f260pi)) + (20.0d * Math.sin((2.0d * x) * f260pi))) * 2.0d) / 3.0d) + ((((20.0d * Math.sin(f260pi * y)) + (40.0d * Math.sin((y / 3.0d) * f260pi))) * 2.0d) / 3.0d) + ((((160.0d * Math.sin((y / 12.0d) * f260pi)) + (320.0d * Math.sin((f260pi * y) / 30.0d))) * 2.0d) / 3.0d);
    }

    private static double transformLon(double x, double y) {
        double ret = 300.0d + x + (2.0d * y) + (0.1d * x * x) + (0.1d * x * y) + (0.1d * Math.sqrt(Math.abs(x)));
        return ret + ((((20.0d * Math.sin((6.0d * x) * f260pi)) + (20.0d * Math.sin((2.0d * x) * f260pi))) * 2.0d) / 3.0d) + ((((20.0d * Math.sin(f260pi * x)) + (40.0d * Math.sin((x / 3.0d) * f260pi))) * 2.0d) / 3.0d) + ((((150.0d * Math.sin((x / 12.0d) * f260pi)) + (300.0d * Math.sin((x / 30.0d) * f260pi))) * 2.0d) / 3.0d);
    }
    ...
    public static FLatLng Earth_To_Mars(double srclat, double srclon) {
        if (GlobalConfig.getInstance().getMapType() == MapType.AMap) {
            if (GlobalConfig.getInstance().isRectification()) {
                ...
                double radLat = (srclat / 180.0d) * f260pi;
                double magic = Math.sin(radLat);
                double magic2 = 1.0d - ((f259ee * magic) * magic);
                double sqrtMagic = Math.sqrt(magic2);
                double dLat2 = (180.0d * dLat) / ((6335552.717000426d / (magic2 * sqrtMagic)) * f260pi);
                double latlat = srclat + dLat2;
                double latlon = srclon + ((180.0d * dLon) / (((f258a / sqrtMagic) * Math.cos(radLat)) * f260pi));
