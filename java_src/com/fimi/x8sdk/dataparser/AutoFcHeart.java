...
public class AutoFcHeart extends X8BaseMessage {
    ...
    public int getFcMode() {
        int temp = C1846R.string.x8_ctrl_type_na;
        switch (this.ctrlType) {
            case 1:
                int temp2 = C1846R.string.x8_ctrl_type_atti;
                return temp2;
            case 2:
                int temp3 = C1846R.string.x8_ctrl_type_global_auto;
                return temp3;
            case 3:
                int temp4 = C1846R.string.x8_ctrl_type_local_auto;
                return temp4;
            case 4:
                int temp5 = C1846R.string.x8_ctrl_type_assited;
                return temp5;
            case 5:
                int temp6 = C1846R.string.x8_ctrl_type_acro;
                return temp6;
            default:
                return temp;
        }
