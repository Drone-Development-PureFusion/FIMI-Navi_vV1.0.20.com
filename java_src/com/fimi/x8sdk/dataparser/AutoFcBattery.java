...
public class AutoFcBattery extends X8BaseMessage {
    ...
    public void unPacket(LinkPacket4 packet) {
        ...
        this.f247cc = payLoad4.getShort();
        X8AppSettingLog.setCc(this.f247cc);
