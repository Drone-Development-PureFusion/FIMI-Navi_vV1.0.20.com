...
public class AckNoFlyNormal extends X8BaseMessage {
    ...
    public void unPacket(LinkPacket4 packet) {
        ...
        boolean z2 = this.polygonShape == 1;
        if (this.polygonShape != 0) {
            z = false;
        }
        if (z2 | z) {
