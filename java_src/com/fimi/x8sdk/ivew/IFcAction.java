...
public interface IFcAction {
    ...
    void getGravitationPrameter(UiCallBackListener uiCallBackListener);

    void getNoFlyNormal(UiCallBackListener uiCallBackListener);
    ...
    void setGravitationExite(UiCallBackListener uiCallBackListener);

    void setGravitationPause(UiCallBackListener uiCallBackListener);

    void setGravitationPrameter(AckAiSetGravitationPrameter ackAiSetGravitationPrameter, UiCallBackListener uiCallBackListener);

    void setGravitationResume(UiCallBackListener uiCallBackListener);

    void setGravitationStart(UiCallBackListener uiCallBackListener);
