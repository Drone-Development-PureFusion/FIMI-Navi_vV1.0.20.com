...
public class ErrorCodeBean implements Serializable {
    ...
    public static class ConstraintBitBean {
        ...
        public boolean equals(Object o) {
            ...
            return this.BitOffset == that.getBitOffset() && this.GroupID.equals(that.getGroupID()) && this.Value == that.isValue();
        }
    }
    ...
    public static class FlightPhase {
        ...
        public boolean equals(Object o) {
            ...
            return this.Value == that.getValue() && this.IsEqual == that.isEqual();
        }
    }
    ...
    public static class ConditionValuesBean {
        ...
        public boolean equals(Object o) {
            ...
            return this.Value == that.getValue() && this.GroupID.equals(that.getGroupID()) && this.IsEqual == that.isEqual();
        }
    }
}
