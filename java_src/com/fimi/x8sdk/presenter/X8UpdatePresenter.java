...
public class X8UpdatePresenter extends BasePresenter implements IUpdateAction, UpdateDateListener {
    ...
    public IConnectResultListener mIConnectResultListener = new IConnectResultListener() { // from class: com.fimi.x8sdk.presenter.X8UpdatePresenter.5
        ...
        public void onDisconnect(String msg) {
            if (!X8UpdatePresenter.this.containRemoteControl()) {
                ...
                X8UpdatePresenter.this.firewareName = X8UpdatePresenter.this.context.getString(C1846R.string.x8_update_err_disconnect);
                ...
                if (X8UpdatePresenter.this.updateState != UpdateState.updateEnd) {
                    if (X8UpdatePresenter.this.startCheckUpdateTimeOut) {
                        ...
                        if (X8UpdatePresenter.this.cheackUpdateTimeOut > 960) {
                            X8UpdatePresenter.this.updateFailure = true;
                            X8UpdatePresenter.this.firewareName = X8UpdatePresenter.this.context.getString(C1846R.string.x8_error_code_update_25);
                            X8UpdatePresenter.this.updateProgressView(2, 0);
    ...
    public String getErrorCodeString(int result) {
        switch ((byte) result) {
            case -1:
                String str = this.context.getString(C1846R.string.x8_error_code_update_255);
                return str;
            case 0:
                String str2 = this.context.getString(C1846R.string.x8_error_code_update_0);
                return str2;
            case 1:
                String str3 = this.context.getString(C1846R.string.x8_error_code_update_1);
                return str3;
            case 2:
                String str4 = this.context.getString(C1846R.string.x8_error_code_update_2);
                return str4;
            case 3:
                String str5 = this.context.getString(C1846R.string.x8_error_code_update_3);
                return str5;
            case 4:
                String str6 = this.context.getString(C1846R.string.x8_error_code_update_4);
                return str6;
            case 5:
                String str7 = this.context.getString(C1846R.string.x8_error_code_update_5);
                return str7;
            case 6:
                String str8 = this.context.getString(C1846R.string.x8_error_code_update_6);
                return str8;
            case 7:
                String str9 = this.context.getString(C1846R.string.x8_error_code_update_7);
                return str9;
            case 8:
            case 9:
            case 10:
            ...
            default:
                return "";
            case 33:
                String str10 = this.context.getString(C1846R.string.x8_error_code_update_21);
                return str10;
            case 34:
                String str11 = this.context.getString(C1846R.string.x8_error_code_update_22);
                return str11;
            case 35:
                String str12 = this.context.getString(C1846R.string.x8_error_code_update_23);
                return str12;
            case 36:
                String str13 = this.context.getString(C1846R.string.x8_error_code_update_24);
                return str13;
            case 37:
                String str14 = this.context.getString(C1846R.string.x8_error_code_update_25);
                return str14;
            case 38:
                String str15 = this.context.getString(C1846R.string.x8_error_code_update_26);
                return str15;
            case 39:
                String str16 = this.context.getString(C1846R.string.x8_error_code_update_27);
                return str16;
            case 40:
                String str17 = this.context.getString(C1846R.string.x8_error_code_update_28);
                return str17;
            case 41:
                String str18 = this.context.getString(C1846R.string.x8_error_code_update_29);
                return str18;
        }
    }
