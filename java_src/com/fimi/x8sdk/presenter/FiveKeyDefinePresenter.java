            ...
            if (this.ix8FiveKeyDefine != null) {
                if (ackFiveKeyDefine.getAdckeyIndex() == 1) {
                    if (this.isFiveKeySaturationAdd) {
                        if (ackFiveKeyDefine.getAdckeyAction() == 2) {
                            z2 = true;
                        }
                        ...
                        int i = SPStoreManager.getInstance().getInt(Constants.FIVE_KEY_UP_KEY);
                        if (ackFiveKeyDefine.getAdckeyAction() != 2) {
                            z = false;
                        }
                    ...
                    if (this.isFiveKeySaturationAdd) {
                        ...
                        int i2 = SPStoreManager.getInstance().getInt(Constants.FIVE_KEY_DOWN_KEY, 1);
                        if (ackFiveKeyDefine.getAdckeyAction() != 2) {
                            z = false;
                        }
                        fiveKeySwitchUI(i2, z, false);
                    }
                } else if (ackFiveKeyDefine.getAdckeyIndex() == 3) {
                    if (!this.isFiveKeySaturationAdd && !this.isFiveKeyContrastRatioAdd) {
                        int i3 = SPStoreManager.getInstance().getInt(Constants.FIVE_KEY_LEFT_KEY, 2);
                        if (ackFiveKeyDefine.getAdckeyAction() != 2) {
                            z = false;
                        }
                        fiveKeySwitchUI(i3, z, false);
                    }
                } else if (ackFiveKeyDefine.getAdckeyIndex() == 4) {
                    if (!this.isFiveKeySaturationAdd && !this.isFiveKeyContrastRatioAdd) {
                        int i4 = SPStoreManager.getInstance().getInt(Constants.FIVE_KEY_RIGHT_KEY, 3);
                        if (ackFiveKeyDefine.getAdckeyAction() != 2) {
                            z = false;
                        }
                        fiveKeySwitchUI(i4, z, false);
                    }
                } else if (ackFiveKeyDefine.getAdckeyIndex() == 5) {
                    if (!this.isFiveKeyContrastRatioAdd && !this.isFiveKeySaturationAdd) {
                        int i5 = SPStoreManager.getInstance().getInt(Constants.FIVE_KEY_CENTRE_KEY, 4);
                        if (ackFiveKeyDefine.getAdckeyAction() != 2) {
                            z = false;
                        }
                        fiveKeySwitchUI(i5, z, false);
                        return;
                    }
                    if (ackFiveKeyDefine.getAdckeyAction() != 2) {
                        z = false;
