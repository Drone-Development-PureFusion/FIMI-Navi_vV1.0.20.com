...
public class X8GimbalManager {
    ...
    public void getGimbalSensorInfo(UiCallBackListener listener) {
        this.gbAction.getGimbalSensorInfo(listener);
    }
