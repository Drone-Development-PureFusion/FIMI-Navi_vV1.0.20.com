...
public class FiveKeyDefineManager {
    ...
    public String setCameraContrast(String paramKey, int param, FiveKeyDefinePresenter.ParameterType parameterType, JsonUiCallBackListener jsonUiCallBackListener) {
        return this.iFiveKeyAction.setCameraContrast(paramKey, param, parameterType, jsonUiCallBackListener);
    }

    public String setCameraSaturation(String paramKey, int param, FiveKeyDefinePresenter.ParameterType parameterType, JsonUiCallBackListener jsonUiCallBackListener) {
