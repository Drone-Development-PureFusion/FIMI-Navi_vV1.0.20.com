...
public class FcCollection extends X8BaseCmd {
    ...
    public X8SendCmd setAiLinePoints(CmdAiLinePoints points) {
        ...
        payload[i4] = 0;
        int i6 = i5 + 1;
        payload[i5] = (byte) points.nPos;
        int i7 = i6 + 1;
        payload[i6] = (byte) points.count;
        int i8 = i7 + 1;
        payload[i7] = 0;
        int i9 = i8 + 1;
        payload[i8] = 0;
        byte[] buffer = ByteHexHelper.getDoubleBytes(points.longitude);
        System.arraycopy(buffer, 0, payload, i9, 8);
        int i10 = i9 + 8;
        byte[] buffer2 = ByteHexHelper.getDoubleBytes(points.latitude);
        System.arraycopy(buffer2, 0, payload, i10, 8);
        int i11 = i10 + 8;
        int i12 = i11 + 1;
        payload[i11] = (byte) (points.altitude >> 0);
        int i13 = i12 + 1;
        payload[i12] = (byte) (points.altitude >> 8);
        int angle1 = ((int) points.angle) * 100;
        int i14 = i13 + 1;
        payload[i13] = (byte) (angle1 >> 0);
        int i15 = i14 + 1;
        payload[i14] = (byte) (angle1 >> 8);
        int i16 = i15 + 1;
        payload[i15] = (byte) (points.gimbalPitch >> 0);
        int i17 = i16 + 1;
        payload[i16] = (byte) (points.gimbalPitch >> 8);
        int i18 = i17 + 1;
        payload[i17] = (byte) points.speed;
        int i19 = i18 + 1;
        payload[i18] = 0;
        int i20 = i19 + 1;
        payload[i19] = 0;
        ...
        payload[i20] = 0;
        int i22 = i21 + 1;
        payload[i21] = (byte) ((points.autoRecord << 4) | (points.coordinatedTurnOff << 2) | points.pioEnbale | 2);
        int i23 = i22 + 1;
        payload[i22] = (byte) (points.orientation | (points.rotation << 4));
        int i24 = i23 + 1;
        ...
        payload[i24] = 0;
        int i26 = i25 + 1;
        payload[i25] = (byte) points.compeletEvent;
        int i27 = i26 + 1;
        payload[i26] = (byte) points.disconnectEvent;
        byte[] buffer3 = ByteHexHelper.getDoubleBytes(points.longitudePIO);
        System.arraycopy(buffer3, 0, payload, i27, 8);
        int i28 = i27 + 8;
        byte[] buffer4 = ByteHexHelper.getDoubleBytes(points.latitudePIO);
        System.arraycopy(buffer4, 0, payload, i28, 8);
        int i29 = i28 + 8;
        int i30 = i29 + 1;
        payload[i29] = (byte) (points.altitudePIO >> 0);
        int i31 = i30 + 1;
        payload[i30] = (byte) (points.altitudePIO >> 8);
        sendCmd.setPayLoad(payload);
        sendCmd.packSendCmd();
        return sendCmd;
    }
    ...
    public BaseCommand getAircrftCalibrationState(int sensorType, int type) {
        ...
        sendCmd.setPayLoad(payload);
        sendCmd.packSendCmd();
        sendCmd.setOutTime(CoreConstants.MILLIS_IN_ONE_MINUTE);
