...
public class Constants {
    ...
    public static final String X8_CAMERA_STATE_EVENT_KEY = "x8_camera_state_event_key";
    ...
    public static final String X8_FLIGHTLOG_EVENT_KEY = "x8_flightlog_event_key";
    public static final String X8_FLIGHTLOG_PATH = "x8_flightlog_path";
    public static final String X8_FLIGHTLOG_RENAME_FILE_EVENT_KEY = "x8_flightlog_rename_file_event_key";
    ...
    public static final String[] manufacturerModes = {"samsungSM-A9000", "xiaomiRedmi Note 5A"};
