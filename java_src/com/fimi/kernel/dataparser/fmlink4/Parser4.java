    ...
    public LinkPacket4 unPacket(int buf) {
        ...
        switch (this.state) {
            ...
            case Ver:
                if (messageReceived) {
                    ...
                    if (this.ver != 4) {
                        ...
                        this.f180m.getHeader4().setVer(this.ver);
            ...
            case Len:
                ...
                this.f180m.getHeader4().setLen(this.len);
                this.state = State.TypeAndRes1Encry;
                this.index = this.f180m.getHeader4().getDataLen();
                break;
            case TypeAndRes1Encry:
                ...
                this.f180m.getHeader4().setType(this.type);
                this.f180m.getHeader4().setEncryptType(this.encryptType);
                this.f180m.getHeader4().setReserve1(this.reserve1);
                this.state = State.SrcId;
                break;
            case SrcId:
                this.srcId = (byte) (buf & 255);
                this.f180m.getHeader4().setSrcId(this.srcId);
                this.state = State.DestId;
                break;
            case DestId:
                this.destId = (byte) (buf & 255);
                this.f180m.getHeader4().setDestId(this.destId);
                this.state = State.Reserve2;
                break;
            case Reserve2:
                this.reserve2 = (byte) (buf & 255);
                this.f180m.getHeader4().setReserve2(this.reserve2);
                this.state = State.Reserve3;
                break;
            case Reserve3:
                this.reserve3 = (byte) (buf & 255);
                this.f180m.getHeader4().setReserve3(this.reserve3);
            ...
            case Seq2:
                ...
                this.f180m.getHeader4().setSeq(this.seq);
            ...
            case CrcHeader2:
                ...
                this.f180m.getHeader4().setCrcHeader(this.crcHeader);
                break;
            case CrcFrame1:
            ...
            case CrcFrame4:
                ...
                this.f180m.getHeader4().setCrcFrame(this.crcFrame);
            ...
            case PlayLoad:
                try {
                    if (this.index <= 0) {
                        ...
                        this.f180m.getPayLoad4().add((byte) buf);
                        this.index--;
                        if (this.index == 0) {
                            if (this.f180m.getPayLoad4().size() == this.f180m.getHeader4().getDataLen()) {
                                this.state = State.PlayLoad;
                                int payloadCRC = this.f180m.getPayLoad4().getIntCrc();
                                if (this.f180m.getHeader4().checkFrameCRC(payloadCRC)) {
