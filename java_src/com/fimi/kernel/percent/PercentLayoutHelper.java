...
public class PercentLayoutHelper {
    ...
    public static PercentLayoutInfo getPercentLayoutInfo(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, C1583R.styleable.PercentLayout_Layout);
    ...
    private static PercentLayoutInfo setWidthAndHeightVal(TypedArray array, PercentLayoutInfo info) {
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_widthPercent, true);
        if (percentVal != null) {
        ...
        PercentLayoutInfo.PercentVal percentVal2 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_heightPercent, false);
        if (percentVal2 != null) {
            if (Log.isLoggable(TAG, 2)) {
    ...
    private static PercentLayoutInfo setTextSizeSupportVal(TypedArray array, PercentLayoutInfo info) {
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_textSizePercent, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, 2)) {
    ...
    private static PercentLayoutInfo setMinMaxWidthHeightRelatedVal(TypedArray array, PercentLayoutInfo info) {
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_maxWidthPercent, true);
        if (percentVal != null) {
            checkForInfoExists(info);
            info.maxWidthPercent = percentVal;
        }
        PercentLayoutInfo.PercentVal percentVal2 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_maxHeightPercent, false);
        if (percentVal2 != null) {
            checkForInfoExists(info);
            info.maxHeightPercent = percentVal2;
        }
        PercentLayoutInfo.PercentVal percentVal3 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_minWidthPercent, true);
        if (percentVal3 != null) {
            checkForInfoExists(info);
            info.minWidthPercent = percentVal3;
        }
        PercentLayoutInfo.PercentVal percentVal4 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_minHeightPercent, false);
        if (percentVal4 != null) {
            checkForInfoExists(info);
    ...
    private static PercentLayoutInfo setMarginRelatedVal(TypedArray array, PercentLayoutInfo info) {
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_marginPercent, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, 2)) {
        ...
        PercentLayoutInfo.PercentVal percentVal2 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_marginLeftPercent, true);
        if (percentVal2 != null) {
            if (Log.isLoggable(TAG, 2)) {
        ...
        PercentLayoutInfo.PercentVal percentVal3 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_marginTopPercent, false);
        if (percentVal3 != null) {
            if (Log.isLoggable(TAG, 2)) {
        ...
        PercentLayoutInfo.PercentVal percentVal4 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_marginRightPercent, true);
        if (percentVal4 != null) {
            if (Log.isLoggable(TAG, 2)) {
        ...
        PercentLayoutInfo.PercentVal percentVal5 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_marginBottomPercent, false);
        if (percentVal5 != null) {
            if (Log.isLoggable(TAG, 2)) {
        ...
        PercentLayoutInfo.PercentVal percentVal6 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_marginStartPercent, true);
        if (percentVal6 != null) {
            if (Log.isLoggable(TAG, 2)) {
        ...
        PercentLayoutInfo.PercentVal percentVal7 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_marginEndPercent, true);
        if (percentVal7 != null) {
            if (Log.isLoggable(TAG, 2)) {
    ...
    private static PercentLayoutInfo setPaddingRelatedVal(TypedArray array, PercentLayoutInfo info) {
        PercentLayoutInfo.PercentVal percentVal = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_paddingPercent, true);
        if (percentVal != null) {
            info = checkForInfoExists(info);
        ...
        PercentLayoutInfo.PercentVal percentVal2 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_paddingLeftPercent, true);
        if (percentVal2 != null) {
            info = checkForInfoExists(info);
            info.paddingLeftPercent = percentVal2;
        }
        PercentLayoutInfo.PercentVal percentVal3 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_paddingRightPercent, true);
        if (percentVal3 != null) {
            info = checkForInfoExists(info);
            info.paddingRightPercent = percentVal3;
        }
        PercentLayoutInfo.PercentVal percentVal4 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_paddingTopPercent, true);
        if (percentVal4 != null) {
            info = checkForInfoExists(info);
            info.paddingTopPercent = percentVal4;
        }
        PercentLayoutInfo.PercentVal percentVal5 = getPercentVal(array, C1583R.styleable.PercentLayout_Layout_layout_paddingBottomPercent, true);
        if (percentVal5 != null) {
            PercentLayoutInfo info2 = checkForInfoExists(info);
