...
public class LollipopBleScanner extends BaseBleScanner {
    ...
    private ScanCallback scanCallback = new ScanCallback() { // from class: com.fimi.kernel.connect.ble.scanner.LollipopBleScanner.1
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            LogUtil.m1326i(LollipopBleScanner.TAG, "onScanResult: " + callbackType + " ScanResult:" + result);
        ...
        public void onBatchScanResults(List<ScanResult> results) {
            ...
            LogUtil.m1326i(LollipopBleScanner.TAG, "onBatchScanResults()");
        }

        @Override // android.bluetooth.le.ScanCallback
        public void onScanFailed(int errorCode) {
            if (errorCode != 3 && errorCode != 1) {
                LogUtil.m1326i(LollipopBleScanner.TAG, "onScanFailed: " + errorCode);
