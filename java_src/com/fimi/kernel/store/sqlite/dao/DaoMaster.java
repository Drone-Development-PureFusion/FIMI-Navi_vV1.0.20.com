...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static DaoSession newDevSession(Context context, String name) {
        ...
        return daoMaster.mo1782newSession();
    }
    ...
    public DaoSession mo1782newSession() {
        return new DaoSession(this.f1483db, IdentityScopeType.Session, this.daoConfigMap);
    }

    @Override // org.greenrobot.greendao.AbstractDaoMaster
    /* renamed from: newSession */
    public DaoSession mo1783newSession(IdentityScopeType type) {
        return new DaoSession(this.f1483db, type, this.daoConfigMap);
    }
