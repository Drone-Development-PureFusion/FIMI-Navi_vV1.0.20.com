...
public class X8AiLinePointLatlngInfoDao extends AbstractDao<X8AiLinePointLatlngInfo, Long> {
    ...
    public static class Properties {
        ...
        /* renamed from: Id */
        public static final Property f198Id = new Property(0, Long.class, "id", true, "_id");
    ...
    public final void bindValues(DatabaseStatement stmt, X8AiLinePointLatlngInfo entity) {
        ...
        stmt.bindLong(3, entity.getTotalnumber());
        stmt.bindDouble(4, entity.getLongitude());
        stmt.bindDouble(5, entity.getLatitude());
        stmt.bindLong(6, entity.getAltitude());
        stmt.bindDouble(7, entity.getYaw());
        stmt.bindLong(8, entity.getGimbalPitch());
        stmt.bindLong(9, entity.getSpeed());
        stmt.bindLong(10, entity.getYawMode());
        stmt.bindLong(11, entity.getGimbalMode());
        stmt.bindLong(12, entity.getTrajectoryMode());
        stmt.bindLong(13, entity.getMissionFinishAction());
        stmt.bindLong(14, entity.getRCLostAction());
        stmt.bindDouble(15, entity.getLongitudePOI());
        stmt.bindDouble(16, entity.getLatitudePOI());
        stmt.bindLong(17, entity.getAltitudePOI());
        stmt.bindLong(18, entity.getLineId());
        stmt.bindLong(19, entity.getPointActionCmd());
    ...
    public X8AiLinePointLatlngInfo mo1794readEntity(Cursor cursor, int offset) {
