...
public class AesCbcWithIntegrity {
    ...
    public static SecretKeys generateKeyFromPassword(String password, byte[] salt, int iterationCount) throws GeneralSecurityException {
        fixPrng();
        KeySpec keySpec = new PBEKeySpec(password.toCharArray(), salt, iterationCount, BitmapCounterProvider.MAX_BITMAP_COUNT);
    ...
    public static class CipherTextIvMac {
        ...
        public CipherTextIvMac(byte[] c, byte[] i, byte[] h) {
            ...
            this.f192iv = new byte[i.length];
            System.arraycopy(i, 0, this.f192iv, 0, i.length);
        ...
        public CipherTextIvMac(String base64IvAndCiphertext) {
            ...
            this.f192iv = Base64.decode(civArray[0], 2);
        ...
        public String toString() {
            String ivString = Base64.encodeToString(this.f192iv, 2);
        ...
        public int hashCode() {
            ...
            return (((result * 31) + Arrays.hashCode(this.f192iv)) * 31) + Arrays.hashCode(this.mac);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass()) {
                ...
                return Arrays.equals(this.cipherText, other.cipherText) && Arrays.equals(this.f192iv, other.f192iv) && Arrays.equals(this.mac, other.mac);
            }
            return false;
        }
    }
    ...
    public static final class PrngFixes {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:32:0x002b, code lost:
            if (r3[0].getClass().getSimpleName().equals(com.fimi.kernel.security.AesCbcWithIntegrity.PrngFixes.LinuxPRNGSecureRandomProvider.class.getSimpleName()) != false) goto L9;
         */
        /*
