...
import com.fimi.album.p007ui.MediaDetailActivity;
import com.fimi.album.p007ui.VideoPlayActivity;
...
public class MediaDetailPresenter<T extends MediaDetailActivity> implements IViewpaper, OnPhotoTapListener {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = LayoutInflater.from(this.mMediaActivity.getApplicationContext()).inflate(C0522R.layout.album_adapter_detail_item, container, false);
