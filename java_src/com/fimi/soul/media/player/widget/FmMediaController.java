...
public class FmMediaController extends FrameLayout {
                ...
                switch (msg.what) {
                    case 0:
                        if (FmMediaController.this.mPlayer.isPlaying()) {
                            FmMediaController.this.mPauseButton.setBackgroundResource(C1846R.C1849drawable.ic_launcher);
                            return;
                        } else {
                            FmMediaController.this.mPauseButton.setBackgroundResource(C1846R.C1849drawable.ic_launcher);
                            return;
    ...
    protected View makeControllerView() {
        ...
        this.mRoot = inflate.inflate(C1846R.layout.x8_fm_media_controller, (ViewGroup) null);
        initControllerView(this.mRoot);
        return this.mRoot;
    }
    ...
    private void initControllerView(View v) {
        int i = 0;
        this.mPauseButton = (ImageButton) v.findViewById(C1846R.C1850id.pause);
        if (this.mPauseButton != null) {
            this.mPauseButton.requestFocus();
            this.mPauseButton.setOnClickListener(this.mPauseListener);
        }
        this.mFfwdButton = (ImageButton) v.findViewById(C1846R.C1850id.ffwd);
        ...
        this.mRewButton = (ImageButton) v.findViewById(C1846R.C1850id.rew);
        ...
        this.mNextButton = (ImageButton) v.findViewById(C1846R.C1850id.next);
        if (this.mNextButton != null && !this.mFromXml && !this.mListenersSet) {
            this.mNextButton.setVisibility(8);
        }
        this.mPrevButton = (ImageButton) v.findViewById(C1846R.C1850id.prev);
        if (this.mPrevButton != null && !this.mFromXml && !this.mListenersSet) {
            this.mPrevButton.setVisibility(8);
        }
        this.mProgress = (SeekBar) v.findViewById(C1846R.C1850id.fmmediacontroller_progress);
        ...
        this.mEndTime = (TextView) v.findViewById(C1846R.C1850id.time);
        this.mCurrentTime = (TextView) v.findViewById(C1846R.C1850id.time_current);
    ...
    public void updatePausePlay() {
        if (this.mRoot != null && this.mPauseButton != null) {
            if (this.mPlayer.isPlaying()) {
                this.mPauseButton.setBackgroundResource(C1846R.C1849drawable.ic_launcher);
            } else {
                this.mPauseButton.setBackgroundResource(C1846R.C1849drawable.ic_launcher);
            }
