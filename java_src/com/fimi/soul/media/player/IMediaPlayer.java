...
public interface IMediaPlayer {
    ...
    int PlayerPreviewInputNetData(byte[] bArr, int i, int i2) throws IllegalStateException;

    int PlayerRtmpStart(String str, int i, int i2);
    ...
    void prepareAsync(int i, int i2) throws IllegalStateException;
