    ...
    public void setScreenOnWhilePlaying(boolean screenOn) {
        if (this.mScreenOnWhilePlaying != screenOn) {
            if (screenOn && this.mSurfaceHolder == null) {
                DebugLog.m1312w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (player == null || player.mNativeMediaPlayer == 0) {
                DebugLog.m1312w(FimiMediaPlayer.TAG, "FimiMediaPlayer went away with unhandled events");
                return;
            }
            switch (msg.what) {
                case 0:
                ...
                case 7:
                    ...
                    return;
                case 8:
                    DebugLog.m1318e("moweiru", "Error (" + msg.arg1 + "," + msg.arg2 + ")");
                    player.showMediaQuality(msg.arg1, msg.arg2);
                    return;
                case 100:
                    DebugLog.m1318e(FimiMediaPlayer.TAG, "Error (" + msg.arg1 + "," + msg.arg2 + ")");
                ...
                case 200:
                    switch (msg.arg1) {
                        case 3:
                            DebugLog.m1316i(FimiMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            break;
                    }
