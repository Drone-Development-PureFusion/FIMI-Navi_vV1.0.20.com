...
public class FmMediaController extends FrameLayout {
                ...
                switch (msg.what) {
                    case 0:
                        if (FmMediaController.this.mPlayer.isPlaying()) {
                            FmMediaController.this.mPauseButton.setBackgroundResource(C1787R.C1790drawable.drone_stop);
                            return;
                        } else {
                            FmMediaController.this.mPauseButton.setBackgroundResource(C1787R.C1790drawable.drone_play);
                            return;
                        }
                    case 1:
                        FmMediaController.this.hide();
    ...
    protected View makeControllerView() {
        ...
        this.mRoot = inflate.inflate(C1787R.layout.fm_media_controller, (ViewGroup) null);
        initControllerView(this.mRoot);
        return this.mRoot;
    }
    ...
    private void initControllerView(View v) {
        int i = 0;
        this.mPauseButton = (ImageButton) v.findViewById(C1787R.C1791id.pause);
        if (this.mPauseButton != null) {
            this.mPauseButton.requestFocus();
            this.mPauseButton.setOnClickListener(this.mPauseListener);
        }
        this.mFfwdButton = (ImageButton) v.findViewById(C1787R.C1791id.ffwd);
        ...
        this.mRewButton = (ImageButton) v.findViewById(C1787R.C1791id.rew);
        ...
        this.mNextButton = (ImageButton) v.findViewById(C1787R.C1791id.next);
        if (this.mNextButton != null && !this.mFromXml && !this.mListenersSet) {
            this.mNextButton.setVisibility(8);
        }
        this.mPrevButton = (ImageButton) v.findViewById(C1787R.C1791id.prev);
        if (this.mPrevButton != null && !this.mFromXml && !this.mListenersSet) {
            this.mPrevButton.setVisibility(8);
        }
        this.mProgress = (SeekBar) v.findViewById(C1787R.C1791id.fmmediacontroller_progress);
        ...
        this.mEndTime = (TextView) v.findViewById(C1787R.C1791id.time);
        this.mCurrentTime = (TextView) v.findViewById(C1787R.C1791id.time_current);
    ...
    public void updatePausePlay() {
        if (this.mRoot != null && this.mPauseButton != null) {
            if (this.mPlayer.isPlaying()) {
                this.mPauseButton.setBackgroundResource(C1787R.C1790drawable.drone_stop);
            } else {
                this.mPauseButton.setBackgroundResource(C1787R.C1790drawable.drone_play);
            }
