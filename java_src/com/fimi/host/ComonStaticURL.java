...
public class ComonStaticURL {
    ...
    public static String getGuideBookUrl() {
        return getCommonFormateURL(C1583R.string.kernal_gh2_guidebook);
    }

    public static String getFaqUrl() {
        return getCommonFormateURL(C1583R.string.kernel_faq);
    }

    public static String getPrivacyUrl() {
        return getCommonFormateLocalURL(C1583R.string.kernel_privacy);
    }

    public static String getPolicyUrl() {
        return getCommonFormateLocalURL(C1583R.string.kernel_policy);
    }
    ...
    private static String getCommonFormateURL(int resourceId) {
        StringBuffer stringBuffer = new StringBuffer();
        ServiceItem serviceItem = (ServiceItem) SPStoreManager.getInstance().getObject(Constants.SERVICE_ITEM_KEY, ServiceItem.class);
        if (serviceItem.getInfo() == C1583R.string.region_Mainland_China) {
