...
public class ForgetPasswordPresenter {
    ...
    public void sendEmail(String emailAddress) {
        UserManager.getIntance(this.mContext).getSecurityCode(emailAddress, "1", "1", new DisposeDataHandle(new DisposeDataListener() { // from class: com.fimi.libperson.presenter.ForgetPasswordPresenter.1
            ...
            public void onFailure(Object reasonObj) {
                ForgetPasswordPresenter.this.mIForgetPasswordView.sendEmail(false, ForgetPasswordPresenter.this.mContext.getString(C1647R.string.network_exception));
            }
        }));
    }
    ...
    public void inputVerficationCode(String emailAddress, String verficationCode) {
        ...
        UserManager.getIntance(this.mContext).resetPassword(restPswDto, new DisposeDataHandle(new DisposeDataListener() { // from class: com.fimi.libperson.presenter.ForgetPasswordPresenter.2
            ...
            @Override // com.fimi.kernel.network.okhttp.listener.DisposeDataListener
            public void onFailure(Object reasonObj) {
                ForgetPasswordPresenter.this.mIForgetPasswordView.inputVerfication(false, ForgetPasswordPresenter.this.mContext.getString(C1647R.string.network_exception));
            }
        }));
    }
    ...
    public void inputPassword(String emailAddress, String code, String password, String confirmPassword) {
        ...
        UserManager.getIntance(this.mContext).resetPassword(restPswDto, new DisposeDataHandle(new DisposeDataListener() { // from class: com.fimi.libperson.presenter.ForgetPasswordPresenter.3
            ...
            @Override // com.fimi.kernel.network.okhttp.listener.DisposeDataListener
            public void onFailure(Object reasonObj) {
                ForgetPasswordPresenter.this.mIForgetPasswordView.resetPassword(false, ForgetPasswordPresenter.this.mContext.getString(C1647R.string.network_exception));
            }
        }));
    }
}
