...
import com.fimi.libperson.p013ui.p014me.login.ForgetIphonePasswordFragment;
import com.fimi.libperson.p013ui.p014me.login.ForgetPasswordFragment;
import com.fimi.libperson.presenter.LoginPresenter;
import com.fimi.libperson.widget.TitleView;
import router.Router;
/* renamed from: com.fimi.libperson.ui.me.login.LoginMainActivity */
...
public class LoginMainActivity extends BasePersonActivity implements ILoginView, ForgetPasswordFragment.OnResetPasswordListerner, ForgetIphonePasswordFragment.OnResetIphonePasswordListerner {
    ...
    protected int getContentViewLayoutID() {
        return C1647R.layout.activity_login_main;
    }
    ...
    private void initView() {
        ...
        this.mEtPassword = (EditText) findViewById(C1647R.C1651id.et_password);
        this.mTvErrorHint = (TextView) findViewById(C1647R.C1651id.tv_error_hint);
        this.mCbSelectService = (CheckBox) findViewById(C1647R.C1651id.cb_iphone_select_service);
        ...
        this.mTvForgetIphoneHint = (TextView) findViewById(C1647R.C1651id.tv_forget_iphone_hint);
        this.mBtnLoginIphone = (Button) findViewById(C1647R.C1651id.btn_login_phone);
        this.mBtnLoginEmail = (Button) findViewById(C1647R.C1651id.btn_login_email);
        ...
        this.mTvTitleNmae.setText(getString(C1647R.string.login_login_main_phone_title));
    ...
    public void doTrans() {
        ...
        this.mForgetPasswordFragment = (ForgetPasswordFragment) this.fragmentManager.findFragmentById(C1647R.C1651id.fl_fp);
        if (this.mForgetPasswordFragment == null) {
            this.mForgetPasswordFragment = new ForgetPasswordFragment();
            this.fragmentManager.beginTransaction().add(C1647R.C1651id.fl_fp, this.mForgetPasswordFragment, "forgetPassword").hide(this.mForgetPasswordFragment).commitAllowingStateLoss();
        } else {
            this.fragmentManager.beginTransaction().hide(this.mForgetPasswordFragment).commit();
        }
        this.mForgetIphonePasswordFragment = (ForgetIphonePasswordFragment) this.fragmentManager.findFragmentById(C1647R.C1651id.fl_fp_iphone);
        if (this.mForgetIphonePasswordFragment == null) {
            this.mForgetIphonePasswordFragment = new ForgetIphonePasswordFragment();
            this.fragmentManager.beginTransaction().add(C1647R.C1651id.fl_fp_iphone, this.mForgetIphonePasswordFragment, "forget_iphone_password_fragment").hide(this.mForgetIphonePasswordFragment).commitAllowingStateLoss();
            return;
        }
        ...
        this.mIvShowPassword.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.libperson.ui.me.login.LoginMainActivity.2
            ...
            public void onClick(View v) {
                if (LoginMainActivity.this.isShowPassword) {
                    ...
                    LoginMainActivity.this.mIvShowPassword.setBackgroundResource(C1647R.C1650drawable.iv_login_email_password);
                } else {
                    ...
                    LoginMainActivity.this.mIvShowPassword.setBackgroundResource(C1647R.C1650drawable.iv_login_email_password_show);
                }
        ...
        this.mIvShowIphonePassword.setOnClickListener(new View.OnClickListener() { // from class: com.fimi.libperson.ui.me.login.LoginMainActivity.3
            ...
            public void onClick(View v) {
                if (LoginMainActivity.this.isShowIphonePassword) {
                    ...
                    LoginMainActivity.this.mIvShowIphonePassword.setBackgroundResource(C1647R.C1650drawable.iv_login_email_password);
                } else {
                    ...
                    LoginMainActivity.this.mIvShowIphonePassword.setBackgroundResource(C1647R.C1650drawable.iv_login_email_password_show);
                }
                ...
                if (LoginMainActivity.this.mForgetPasswordFragment == null || !LoginMainActivity.this.mForgetPasswordFragment.isVisible()) {
                    if (LoginMainActivity.this.mForgetIphonePasswordFragment != null && LoginMainActivity.this.mForgetIphonePasswordFragment.isVisible()) {
                        if (LoginMainActivity.this.mForgetIphonePasswordFragment.getState() == ForgetIphonePasswordFragment.State.IPHONE) {
                            ...
                            LoginMainActivity.this.mTvTitleNmae.setText(LoginMainActivity.this.getString(C1647R.string.login_login_main_phone_title));
                    ...
                    LoginMainActivity.this.mTvTitleNmae.setText(LoginMainActivity.this.getString(C1647R.string.login_login_main_email_title));
        ...
        if (keyCode == 4) {
            if (this.mForgetPasswordFragment != null && this.mForgetPasswordFragment.isVisible()) {
                if (this.mForgetPasswordFragment.getState() == ForgetPasswordFragment.State.EMAIL) {
                    ...
                    this.fragmentManager.beginTransaction().hide(this.mForgetPasswordFragment).commit();
                    this.mTvTitleNmae.setText(getString(C1647R.string.login_login_main_email_title));
                    if (this.isMainLand) {
                        this.mTitleView.setTvRightVisible(0);
                    }
    ...
    @Override // com.fimi.libperson.p013ui.p014me.login.ForgetPasswordFragment.OnResetPasswordListerner
    ...
    @Override // com.fimi.libperson.p013ui.p014me.login.ForgetIphonePasswordFragment.OnResetIphonePasswordListerner
    ...
    public void freorgottenPasswords(boolean isFrequently) {
        if (isFrequently) {
            this.mTvForgetHint.setTextColor(getResources().getColor(C1647R.C1649color.login_forget_password_frequently));
        } else {
            this.mTvForgetHint.setTextColor(getResources().getColor(C1647R.C1649color.login_forget_password));
        }
    }
    ...
    public void showEmail(boolean isEmail) {
        ...
        this.isEmail = false;
        this.mTitleView.setTvRightText(getString(C1647R.string.login_email_title));
        this.mTvTitleNmae.setText(getString(C1647R.string.login_login_main_phone_title));
    ...
    /* renamed from: com.fimi.libperson.ui.me.login.LoginMainActivity$EditTextWatcher */
    /* loaded from: classes.dex */
