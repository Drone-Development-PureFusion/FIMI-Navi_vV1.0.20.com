package com.fimi.libperson.p013ui.web;
...
/* renamed from: com.fimi.libperson.ui.web.UserProtocolWebViewActivity */
...
public class UserProtocolWebViewActivity extends BasePersonActivity {
    ...
    protected int getContentViewLayoutID() {
        return C1647R.layout.activity_user_protocol_web_view;
    }
    ...
    private void initView() {
        ...
        this.webView = (WebView) findViewById(C1647R.C1651id.web_view);
        ...
        this.webView.setWebViewClient(new WebViewClient() { // from class: com.fimi.libperson.ui.web.UserProtocolWebViewActivity.1
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                ...
                builder.setMessage(C1647R.string.notification_error_ssl_cert_invalid);
