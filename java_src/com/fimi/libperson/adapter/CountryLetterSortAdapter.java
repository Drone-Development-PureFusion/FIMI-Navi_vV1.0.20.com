...
public class CountryLetterSortAdapter extends BaseAdapter implements StickyListHeadersAdapter, SectionIndexer, Filterable {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(this.mContext).inflate(C1647R.layout.country_select_item_country_letter_sort, viewGroup, false);
            viewHolder.tvTitle = (TextView) view.findViewById(C1647R.C1651id.title);
    ...
    public View getHeaderView(int position, View view, ViewGroup viewGroup, boolean isScroll) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(this.mContext).inflate(C1647R.layout.country_select_item_sticky_header, viewGroup, false);
            headerViewHolder.tvLetter = (TextView) view.findViewById(C1647R.C1651id.sticky_header_letter_tv);
            view.setTag(headerViewHolder);
        } else {
            headerViewHolder = (HeaderViewHolder) view.getTag();
        }
        headerViewHolder.tvLetter.setBackgroundColor(this.mContext.getColor(C1647R.C1649color.country_select_bg));
        if (isScroll) {
