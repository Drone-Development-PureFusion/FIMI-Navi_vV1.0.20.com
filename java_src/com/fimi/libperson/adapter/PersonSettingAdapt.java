...
public class PersonSettingAdapt extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (this.mList != null) {
            ...
            if (positionIndex == State.UAV_INSURANCE) {
                holder.mTvItemTitle.setText(C1647R.string.person_setting_uav_insurance);
            } else if (positionIndex == State.MESSAGE_NOTICE) {
                holder.mTvItemTitle.setText(C1647R.string.person_setting_message_notice);
                ...
                holder.mTvItemTitle.setText(C1647R.string.person_setting_version_update);
            } else if (positionIndex == State.CLEAN_CACHE) {
                holder.mTvItemTitle.setText(C1647R.string.person_setting_clean_cache);
                holder.mTvContent.setVisibility(0);
                ...
                holder.mTvItemTitle.setText(C1647R.string.person_setting_go_to_app_store);
            } else if (positionIndex == State.USER_AGREEMENT) {
                holder.mViewDivide.setVisibility(8);
                holder.mTvItemTitle.setText(C1647R.string.person_setting_user_agreement);
            } else if (positionIndex == State.USER_PRIVACY) {
                holder.mTvItemTitle.setText(C1647R.string.person_setting_user_privacy);
            } else if (positionIndex == State.SERVICE) {
                holder.mViewDivide.setVisibility(8);
                holder.mTvItemTitle.setText(C1647R.string.person_setting_service);
            } else if (positionIndex == State.LANGUAGE) {
                holder.mTvItemTitle.setText(C1647R.string.person_setting_language);
            } else if (positionIndex == State.BLACK1 || positionIndex == State.BLACK2) {
                holder.mViewDivide.setVisibility(8);
                holder.mIvArrow.setVisibility(8);
                ViewGroup.LayoutParams params = convertView.getLayoutParams();
                params.height = (int) this.mContext.getResources().getDimension(C1647R.dimen.person_setting_height1);
                holder.mRlBg.setLayoutParams(params);
                holder.mRlBg.setBackgroundResource(C1647R.C1649color.person_setting_bg);
            }
        }
        return convertView;
    }
    ...
    public class ViewHolder {
        ...
        public View initView(ViewGroup parent) {
            ...
            View view = inflater.inflate(C1647R.layout.adapt_person_setting, parent, false);
