...
public class DownloadFwSelectActivity extends BaseActivity implements DownloadFwSelectAdapter.SelectListener {
    ...
    public void initData() {
        this.btnReturn = (ImageView) findViewById(C1631R.C1635id.iv_return);
        this.btnDown = (Button) findViewById(C1631R.C1635id.btn_down);
        this.lvSelectFw = (ListView) findViewById(C1631R.C1635id.lv_select_fw);
        this.tvHardWareSize = (TextView) findViewById(C1631R.C1635id.tv_hardSize);
        this.tv_title2 = (TextView) findViewById(C1631R.C1635id.tv_title2);
        this.tv_title = findViewById(C1631R.C1635id.tv_title);
        initValue();
            ...
            public void onClick(View view) {
                if (System.currentTimeMillis() - DownloadFwSelectActivity.this.currTime >= 1000 || DownloadFwSelectActivity.this.isFirstDown) {
                    ...
                    if (!DownloadFwSelectActivity.this.isDSNSuceess()) {
                        ToastUtil.showToast(DownloadFwSelectActivity.this, DownloadFwSelectActivity.this.getString(C1631R.string.host_down_net_exception), 0);
                    } else if (SystemParamUtil.isWifiNetwork(DownloadFwSelectActivity.this)) {
                        DownloadFwSelectActivity.this.startDownLoad();
                    } else {
                        DialogManager dialogManager = new DialogManager(DownloadFwSelectActivity.this, DownloadFwSelectActivity.this.getString(C1631R.string.host_down_tip), DownloadFwSelectActivity.this.getString(C1631R.string.host_down_firmware_warning), DownloadFwSelectActivity.this.getString(C1631R.string.host_down_continue), DownloadFwSelectActivity.this.getString(C1631R.string.host_down_cancel));
    ...
    protected int getContentViewLayoutID() {
        return C1631R.layout.activity_download_fw_select;
    }
        ...
        for (DownloadFwSelectInfo info : list) {
            if (info.hasData()) {
                switch (info.getProduct()) {
                    case GH2:
                        this.tv_title2.setText(getString(C1631R.string.downfw_device_hand_gimbal));
                        break;
                    case X9:
                        this.tv_title2.setText(getString(C1631R.string.downfw_device_x9));
                    case X8S:
                        this.tv_title2.setText(getString(C1631R.string.downfw_device_fimiapp));
                        break;
                    case FIMIAPP:
                        this.tv_title2.setText(getString(C1631R.string.downfw_device_fimiapp));
                        break;
            ...
            if (mList != null && mList.size() > 0) {
                ...
                for (int m = 0; m < mList.size(); m++) {
                    ...
                    if (totalSize > 0) {
                        ...
                        this.tvHardWareSize.setText(String.format(getString(C1631R.string.downfw_update_firmware_detail), tempString));
