...
public class DownloadFwSelectAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(this.context).inflate(C1631R.layout.list_download_fm_select_info_item, (ViewGroup) null);
            viewHandle.tvTitle = (TextView) convertView.findViewById(C1631R.C1635id.tv_title);
            viewHandle.tvInfo = (TextView) convertView.findViewById(C1631R.C1635id.tv_info);
            viewHandle.cbSelect = convertView.findViewById(C1631R.C1635id.cb_select);
            viewHandle.vLinOne = convertView.findViewById(C1631R.C1635id.v_lin_one);
