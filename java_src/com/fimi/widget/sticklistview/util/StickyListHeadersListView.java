...
import com.fimi.widget.sticklistview.util.AdapterWrapper;
...
public class StickyListHeadersListView extends ListView {
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAdapterHeaderClickListener = new AdapterWrapper.OnHeaderClickListener() { // from class: com.fimi.widget.sticklistview.util.StickyListHeadersListView.1
            @Override // com.fimi.widget.sticklistview.util.AdapterWrapper.OnHeaderClickListener
        ...
        this.mDataSetChangedObserver = new DataSetObserver() { // from class: com.fimi.widget.sticklistview.util.StickyListHeadersListView.2
        ...
        this.mOnScrollListener = new AbsListView.OnScrollListener() { // from class: com.fimi.widget.sticklistview.util.StickyListHeadersListView.3
    ...
    private void measureHeader() {
        ...
        int widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(((getWidth() - getPaddingLeft()) - getPaddingRight()) - (isScrollBarOverlay() ? 0 : getVerticalScrollbarWidth()), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
        ViewGroup.LayoutParams params = this.mHeader.getLayoutParams();
        if (params != null && params.height > 0) {
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(params.height, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
        } else {
