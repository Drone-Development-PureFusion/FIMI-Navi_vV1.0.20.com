...
public class NetworkImageView extends ImageView {
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            ImageLoader.ImageContainer newContainer = this.mImageLoader.get(this.mUrl, new C05121(isInLayoutPass), maxWidth, maxHeight, scaleType);
    ...
    /* loaded from: classes.dex */
    public class C05121 implements ImageLoader.ImageListener {
        ...
        public void onResponse(final ImageLoader.ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new Runnable() { // from class: com.android.volley.toolbox.NetworkImageView.1.1
                    ...
                    public void run() {
                        C05121.this.onResponse(response, false);
                    }
                });
