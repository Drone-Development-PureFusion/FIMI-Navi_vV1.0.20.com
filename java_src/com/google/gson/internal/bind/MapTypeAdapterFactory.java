...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo1847read(JsonReader in) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (in.hasNext()) {
                    in.beginArray();
                    K key = this.keyTypeAdapter.mo1847read(in);
                    V value = this.valueTypeAdapter.mo1847read(in);
            ...
            while (in.hasNext()) {
                ...
                K key2 = this.keyTypeAdapter.mo1847read(in);
                V value2 = this.valueTypeAdapter.mo1847read(in);
