...
public final class DefaultDateTypeAdapter implements JsonSerializer<Date>, JsonDeserializer<Date> {
    ...
    public Date mo1871deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    ...
    public String toString() {
        ...
        sb.append(CoreConstants.LEFT_PARENTHESIS_CHAR).append(this.localFormat.getClass().getSimpleName()).append(CoreConstants.RIGHT_PARENTHESIS_CHAR);
        return sb.toString();
    }
}
