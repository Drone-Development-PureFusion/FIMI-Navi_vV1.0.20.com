    ...
    */
    ...
    public String nextName() throws IOException {
        ...
        if (p == 14) {
            ...
            result = nextQuotedValue(CoreConstants.SINGLE_QUOTE_CHAR);
        } else if (p == 13) {
            result = nextQuotedValue(CoreConstants.DOUBLE_QUOTE_CHAR);
        } else {
    ...
    public double nextDouble() throws IOException {
        ...
        if (p == 16) {
            ...
            this.peekedString = nextQuotedValue(p == 8 ? CoreConstants.SINGLE_QUOTE_CHAR : CoreConstants.DOUBLE_QUOTE_CHAR);
        } else if (p == 10) {
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        this.pos = 0;
        do {
            int total = this.f263in.read(buffer, this.limit, buffer.length - this.limit);
            if (total == -1) {
                return false;
            }
            this.limit += total;
    ...
    public String getPath() {
        StringBuilder result = new StringBuilder().append(CoreConstants.DOLLAR);
        ...
        for (int i = 0; i < size; i++) {
            switch (this.stack[i]) {
                ...
                case 4:
                case 5:
                    result.append(CoreConstants.DOT);
