...
public class ActivityTransitionRequest extends zzbgl {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(valueOf).length() + 61 + String.valueOf(str).length() + String.valueOf(valueOf2).length()).append("ActivityTransitionRequest [mTransitions=").append(valueOf).append(", mTag='").append(str).append(CoreConstants.SINGLE_QUOTE_CHAR).append(", mClients=").append(valueOf2).append(']').toString();
    }
