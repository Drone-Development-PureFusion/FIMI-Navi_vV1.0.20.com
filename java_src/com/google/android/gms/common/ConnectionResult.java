...
public final class ConnectionResult extends zzbgl {
    ...
    public final String toString() {
        return zzbg.zzx(this).zzg("statusCode", getStatusString(this.zzcc)).zzg(C2354g.f1039y, this.zzekd).zzg(ShareConstants.WEB_DIALOG_PARAM_MESSAGE, this.zzfqu).toString();
    }
