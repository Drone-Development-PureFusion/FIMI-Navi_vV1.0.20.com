...
public final class Polygon {
    private final com.google.android.gms.maps.model.internal.zzs zzjed;

    @Hide
    public Polygon(com.google.android.gms.maps.model.internal.zzs zzsVar) {
        this.zzjed = (com.google.android.gms.maps.model.internal.zzs) zzbq.checkNotNull(zzsVar);
    }
    ...
    public final Object getTag() {
        try {
            return com.google.android.gms.dynamic.zzn.zzy(this.zzjed.getTag());
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public final void setTag(@Nullable Object obj) {
        try {
            this.zzjed.setTag(com.google.android.gms.dynamic.zzn.zzz(obj));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
