...
public class StreetViewPanoramaCamera extends zzbgl implements ReflectedParcelable {
    ...
    public StreetViewPanoramaCamera(float f, float f2, float f3) {
        ...
        this.zzjen = new StreetViewPanoramaOrientation.Builder().tilt(f2).bearing(f3).build();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzbgo.zza(parcel, 2, this.zoom);
        zzbgo.zza(parcel, 3, this.tilt);
        zzbgo.zza(parcel, 4, this.bearing);
