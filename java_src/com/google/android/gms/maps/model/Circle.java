...
public final class Circle {
    private final com.google.android.gms.maps.model.internal.zzd zzjcw;

    @Hide
    public Circle(com.google.android.gms.maps.model.internal.zzd zzdVar) {
        this.zzjcw = (com.google.android.gms.maps.model.internal.zzd) zzbq.checkNotNull(zzdVar);
    }
    ...
    public final Object getTag() {
        try {
            return com.google.android.gms.dynamic.zzn.zzy(this.zzjcw.getTag());
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public final void setTag(@Nullable Object obj) {
        try {
            this.zzjcw.setTag(com.google.android.gms.dynamic.zzn.zzz(obj));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
