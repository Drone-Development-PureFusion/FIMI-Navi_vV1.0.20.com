...
public final class GroundOverlay {
    private final com.google.android.gms.maps.model.internal.zzg zzjde;

    @Hide
    public GroundOverlay(com.google.android.gms.maps.model.internal.zzg zzgVar) {
        this.zzjde = (com.google.android.gms.maps.model.internal.zzg) zzbq.checkNotNull(zzgVar);
    }
    ...
    public final Object getTag() {
        try {
            return com.google.android.gms.dynamic.zzn.zzy(this.zzjde.getTag());
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public final void setTag(@Nullable Object obj) {
        try {
            this.zzjde.setTag(com.google.android.gms.dynamic.zzn.zzz(obj));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
