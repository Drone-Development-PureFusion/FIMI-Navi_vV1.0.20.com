...
public final class zzbgm {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            throw new zzbgn(new StringBuilder(String.valueOf(hexString).length() + 46).append("Expected size ").append(i2).append(" got ").append(zza).append(" (0x").append(hexString).append(")").toString(), parcel);
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            ...
            throw new zzbgn(new StringBuilder(String.valueOf(hexString).length() + 46).append("Expected size ").append(i3).append(" got ").append(i2).append(" (0x").append(hexString).append(")").toString(), parcel);
        }
    }
    ...
    public static void zzaf(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new zzbgn(new StringBuilder(37).append("Overread allowed size end=").append(i).toString(), parcel);
        }
    }
    ...
    public static int zzd(Parcel parcel) {
        ...
        throw new zzbgn(new StringBuilder(54).append("Size read is invalid start=").append(dataPosition).append(" end=").append(i).toString(), parcel);
    }
