...
public final class zzbhq<I, O> extends zzbgl {
    ...
    public zzbhq(int i, int i2, boolean z, int i3, boolean z2, String str, int i4, String str2, zzbhj zzbhjVar) {
        ...
        if (zzbhjVar == null) {
            ...
            this.zzgix = (zzbhr<I, O>) zzbhjVar.zzand();
        }
    }
