...
public class ParserConfig {
    ...
    public ObjectDeserializer registerIfNotExists(Class<?> clazz, int classModifiers, boolean fieldOnly, boolean jsonTypeSupport, boolean jsonFieldSupport, boolean fieldGenericSupport) {
        ...
        ObjectDeserializer deserializer2 = new JavaBeanDeserializer(this, clazz, clazz, beanInfo);
    ...
    public FieldDeserializer createFieldDeserializer(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo) {
        ...
        return (fieldClass == List.class || fieldClass == ArrayList.class || (fieldClass.isArray() && !fieldClass.getComponentType().isPrimitive())) ? new ListTypeFieldDeserializer(mapping, clazz, fieldInfo) : new DefaultFieldDeserializer(mapping, clazz, fieldInfo);
    }
