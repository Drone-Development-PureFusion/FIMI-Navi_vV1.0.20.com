...
public class H265TrackImplOld {
            ...
            if (nal != null) {
                ...
                if (isFirstOfAU(nalUnitHeader.nalUnitType, nal, accessUnit) && !accessUnit.isEmpty()) {
                    ...
                    for (ByteBuffer byteBuffer : accessUnit) {
                        ...
                        System.err.println(String.format("type: %3d - layer: %3d - tempId: %3d - size: %3d", Integer.valueOf(_nalUnitHeader.nalUnitType), Integer.valueOf(_nalUnitHeader.nuhLayerId), Integer.valueOf(_nalUnitHeader.nuhTemporalIdPlusOne), Integer.valueOf(byteBuffer.limit())));
                    }
                    System.err.println("                          ##########################");
    ...
    public class LookAhead {
        ...
        boolean nextThreeEquals001() throws IOException {
            ...
            } else if (this.bufferStartPos + this.inBufferPos == this.dataSource.size()) {
