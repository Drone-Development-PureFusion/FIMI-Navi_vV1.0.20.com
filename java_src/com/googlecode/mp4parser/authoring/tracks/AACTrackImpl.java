...
public class AACTrackImpl extends AbstractTrack {
    ...
    static {
        ...
        samplingFrequencyIndexMap.put(Integer.valueOf((int) EventsFilesManager.MAX_BYTE_SIZE_PER_FILE), 11);
        ...
        samplingFrequencyIndexMap.put(11, Integer.valueOf((int) EventsFilesManager.MAX_BYTE_SIZE_PER_FILE));
    }
    ...
    public String toString() {
        return "AACTrackImpl{sampleRate=" + this.firstHeader.sampleRate + ", channelconfig=" + this.firstHeader.channelconfig + CoreConstants.CURLY_RIGHT;
    }
}
