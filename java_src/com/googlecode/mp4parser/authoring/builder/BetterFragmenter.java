...
public class BetterFragmenter implements Fragmenter {
    ...
    public long[] sampleNumbers(Track track) {
        ...
        if (time < this.targetDuration && fragments2.length > 1) {
            long numberSamplesLastTwoSegments = (durations.length + 1) - fragments2[fragments2.length - 2];
            fragments2[fragments2.length - 1] = fragments2[fragments2.length - 2] + (numberSamplesLastTwoSegments / 2);
            return fragments2;
        }
        return fragments2;
    }
