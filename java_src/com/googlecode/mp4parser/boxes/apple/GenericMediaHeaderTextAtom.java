...
public class GenericMediaHeaderTextAtom extends AbstractBox {
    ...
    int unknown_1 = 65536;
    int unknown_5 = 65536;
    int unknown_9 = NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE;
    ...
    private static void ajc$preClinit() {
        ...
        ajc$tjp_15 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setUnknown_8", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_8", "", "void"), SyslogConstants.LOG_CLOCK);
