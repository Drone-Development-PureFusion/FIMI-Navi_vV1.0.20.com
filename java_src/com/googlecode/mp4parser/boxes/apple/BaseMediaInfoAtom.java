...
public class BaseMediaInfoAtom extends AbstractFullBox {
    ...
    public String toString() {
        ...
        return "BaseMediaInfoAtom{graphicsMode=" + ((int) this.graphicsMode) + ", opColorR=" + this.opColorR + ", opColorG=" + this.opColorG + ", opColorB=" + this.opColorB + ", balance=" + ((int) this.balance) + ", reserved=" + ((int) this.reserved) + CoreConstants.CURLY_RIGHT;
    }
}
