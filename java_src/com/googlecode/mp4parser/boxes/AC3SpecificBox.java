...
public class AC3SpecificBox extends AbstractBox {
    ...
    public String toString() {
        ...
        return "AC3SpecificBox{fscod=" + this.fscod + ", bsid=" + this.bsid + ", bsmod=" + this.bsmod + ", acmod=" + this.acmod + ", lfeon=" + this.lfeon + ", bitRateCode=" + this.bitRateCode + ", reserved=" + this.reserved + CoreConstants.CURLY_RIGHT;
    }
}
