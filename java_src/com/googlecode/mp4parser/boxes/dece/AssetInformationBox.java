...
public class AssetInformationBox extends AbstractFullBox {
    ...
    private static void ajc$preClinit() {
        ...
        ajc$tjp_2 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "getProfileVersion", "com.googlecode.mp4parser.boxes.dece.AssetInformationBox", "", "", "", "java.lang.String"), TwitterApiConstants.Errors.ALREADY_FAVORITED);
    ...
    public static class Entry {
        ...
        public String toString() {
            return "{namespace='" + this.namespace + CoreConstants.SINGLE_QUOTE_CHAR + ", profileLevelIdc='" + this.profileLevelIdc + CoreConstants.SINGLE_QUOTE_CHAR + ", assetId='" + this.assetId + CoreConstants.SINGLE_QUOTE_CHAR + CoreConstants.CURLY_RIGHT;
        }
