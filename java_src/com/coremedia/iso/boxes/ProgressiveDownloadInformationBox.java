...
public class ProgressiveDownloadInformationBox extends AbstractFullBox {
    ...
    public static class Entry {
        ...
        public String toString() {
            return "Entry{rate=" + this.rate + ", initialDelay=" + this.initialDelay + CoreConstants.CURLY_RIGHT;
        }
    ...
    public String toString() {
        ...
        return "ProgressiveDownloadInfoBox{entries=" + this.entries + CoreConstants.CURLY_RIGHT;
    }
}
