...
public class SampleFlags {
    ...
    public void getContent(ByteBuffer os) {
        long a = 0 | (this.reserved << FcCollection.MSG_SET_FC_RETURE_HOME_RESUME);
        IsoTypeWriter.writeUInt32(os, a | (this.isLeading << 26) | (this.sampleDependsOn << 24) | (this.sampleIsDependedOn << 22) | (this.sampleHasRedundancy << AutoCameraStateADV.TAKEPHOTO_MODE_FULLVIEW) | (this.samplePaddingValue << 17) | ((this.sampleIsDifferenceSample ? 1 : 0) << 16) | this.sampleDegradationPriority);
    }
