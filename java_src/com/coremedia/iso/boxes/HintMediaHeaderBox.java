...
public class HintMediaHeaderBox extends AbstractMediaHeaderBox {
    ...
    public String toString() {
        ...
        return "HintMediaHeaderBox{maxPduSize=" + this.maxPduSize + ", avgPduSize=" + this.avgPduSize + ", maxBitrate=" + this.maxBitrate + ", avgBitrate=" + this.avgBitrate + CoreConstants.CURLY_RIGHT;
    }
}
