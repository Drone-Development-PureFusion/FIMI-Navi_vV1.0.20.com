...
public class SampleToChunkBox extends AbstractFullBox {
    ...
    public static class Entry {
        ...
        public String toString() {
            return "Entry{firstChunk=" + this.firstChunk + ", samplesPerChunk=" + this.samplesPerChunk + ", sampleDescriptionIndex=" + this.sampleDescriptionIndex + CoreConstants.CURLY_RIGHT;
        }
