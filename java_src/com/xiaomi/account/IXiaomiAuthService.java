        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        _arg04 = (Account) Account.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    Bundle _result = getMiCloudUserInfo(_arg04, _arg15);
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = (Account) Account.CREATOR.createFromParcel(data);
                    } else {
                        _arg03 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    Bundle _result2 = getMiCloudAccessToken(_arg03, _arg14);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                ...
                case 3:
                    ...
                    Bundle _result3 = getSnsAccessToken(_arg02, _arg13);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 4:
                    ...
                    invalidateAccessToken(_arg0, _arg12);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result4 = supportResponseWay();
                    reply.writeNoException();
                    if (_result4) {
                        i = 1;
                    }
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    IXiaomiAuthResponse _arg05 = IXiaomiAuthResponse.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                    ...
                    getAccessTokenInResponse(_arg05, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    int _result5 = getVersionNum();
                    reply.writeNoException();
        ...
        private static class Proxy implements IXiaomiAuthService {
            ...
            public void getAccessTokenInResponse(IXiaomiAuthResponse response, Bundle options, int oauthJarMajorVersion, int oauthJarMinorVersion) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(oauthJarMajorVersion);
                    _data.writeInt(oauthJarMinorVersion);
