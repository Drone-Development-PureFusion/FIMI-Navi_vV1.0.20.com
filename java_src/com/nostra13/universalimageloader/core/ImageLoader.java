...
public class ImageLoader {
    ...
    public synchronized void init(ImageLoaderConfiguration configuration) {
        ...
        if (this.configuration == null) {
            C2073L.m1299d(LOG_INIT_CONFIG, new Object[0]);
            this.engine = new ImageLoaderEngine(configuration);
            this.configuration = configuration;
        } else {
            C2073L.m1294w(WARNING_RE_INIT_CONFIG, new Object[0]);
        }
    }
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options, ImageSize targetSize, ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            listener.onLoadingStarted(uri, imageAware.mo1856getWrappedView());
            if (options.shouldShowImageForEmptyUri()) {
                imageAware.setImageDrawable(options.getImageForEmptyUri(this.configuration.resources));
            } else {
                imageAware.setImageDrawable(null);
            }
            listener.onLoadingComplete(uri, imageAware.mo1856getWrappedView(), null);
            return;
        }
        if (targetSize == null) {
        ...
        if (bmp != null && !bmp.isRecycled()) {
            C2073L.m1299d(LOG_LOAD_IMAGE_FROM_MEMORY_CACHE, memoryCacheKey);
            ...
            listener.onLoadingComplete(uri, imageAware.mo1856getWrappedView(), bmp);
            return;
        }
    ...
    public void destroy() {
        if (this.configuration != null) {
            C2073L.m1299d(LOG_DESTROY, new Object[0]);
        }
        stop();
