...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f292CR = 13;

    /* renamed from: LF */
    private static final byte f293LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f294in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        int result = this.f294in.read(this.buf, 0, this.buf.length);
        if (result == -1) {
