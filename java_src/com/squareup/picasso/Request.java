...
public final class Request {
    ...
    public String toString() {
        ...
        if (this.stableKey != null) {
            sb.append(" stableKey(").append(this.stableKey).append(CoreConstants.RIGHT_PARENTHESIS_CHAR);
        }
        if (this.targetWidth > 0) {
            sb.append(" resize(").append(this.targetWidth).append(CoreConstants.COMMA_CHAR).append(this.targetHeight).append(CoreConstants.RIGHT_PARENTHESIS_CHAR);
        }
        if (this.centerCrop) {
        ...
        if (this.rotationDegrees != 0.0f) {
            ...
            if (this.hasRotationPivot) {
                sb.append(" @ ").append(this.rotationPivotX).append(CoreConstants.COMMA_CHAR).append(this.rotationPivotY);
            }
