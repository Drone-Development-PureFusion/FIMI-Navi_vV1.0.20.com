...
abstract class RemoteViewsAction extends Action<RemoteViewsTarget> {
    ...
    public RemoteViewsTarget mo1859getTarget() {
        if (this.target == null) {
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        /* renamed from: getTarget */
        /* bridge */ /* synthetic */ RemoteViewsTarget mo1859getTarget() {
            return super.mo1859getTarget();
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        public AppWidgetAction(Picasso picasso, Request data, RemoteViews remoteViews, int viewId, int[] appWidgetIds, int memoryPolicy, int networkPolicy, String key, Object tag, int errorResId) {
    ...
    static class NotificationAction extends RemoteViewsAction {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public NotificationAction(Picasso picasso, Request data, RemoteViews remoteViews, int viewId, int notificationId, Notification notification, int memoryPolicy, int networkPolicy, String key, Object tag, int errorResId) {
            super(picasso, data, remoteViews, viewId, errorResId, memoryPolicy, networkPolicy, tag, key);
