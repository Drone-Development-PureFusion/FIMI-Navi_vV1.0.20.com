...
public class DynamicDefaultDiskStorage implements DiskStorage {
    ...
    public void purgeUnexpectedResources() {
        try {
            ...
            FLog.m1394e(TAG, "purgeUnexpectedResources", ioe);
        }
    }
    ...
    public Collection<DiskStorage.Entry> mo1643getEntries() throws IOException {
        return get().mo1643getEntries();
    }
    ...
    private void createStorage() throws IOException {
        File rootDirectory = new File(this.mBaseDirectoryPathSupplier.mo1796get(), this.mBaseDirectoryName);
    ...
    void createRootDirectoryIfNecessary(File rootDirectory) throws IOException {
        try {
            ...
            FLog.m1410d(TAG, "Created cache directory %s", rootDirectory.getAbsolutePath());
