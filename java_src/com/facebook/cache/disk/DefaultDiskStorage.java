...
public class DefaultDiskStorage implements DiskStorage {
    ...
    public long remove(DiskStorage.Entry entry) {
        ...
        FileBinaryResource resource = entryImpl.mo1644getResource();
    ...
    public DiskStorage.DiskDumpInfo getDumpInfo() throws IOException {
        List<DiskStorage.Entry> entries = mo1643getEntries();
    ...
    private DiskStorage.DiskDumpInfoEntry dumpCacheEntry(DiskStorage.Entry entry) throws IOException {
        EntryImpl entryImpl = (EntryImpl) entry;
        String firstBits = "";
        byte[] bytes = entryImpl.mo1644getResource().read();
        ...
        String path = entryImpl.mo1644getResource().getFile().getPath();
    ...
    public List<DiskStorage.Entry> mo1643getEntries() throws IOException {
    ...
    public static class EntryImpl implements DiskStorage.Entry {
        ...
        private EntryImpl(String id, File cachedFile) {
            ...
            this.f67id = (String) Preconditions.checkNotNull(id);
        ...
        public FileBinaryResource mo1644getResource() {
