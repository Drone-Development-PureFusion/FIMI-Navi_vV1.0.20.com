...
public class FacebookAppLinkResolver implements AppLinkResolver {
    ...
    public Task<AppLink> getAppLinkFromUrlInBackground(final Uri uri) {
        ...
        return resolveTask.onSuccess(new Continuation<Map<Uri, AppLink>, AppLink>() { // from class: com.facebook.applinks.FacebookAppLinkResolver.1
            ...
            /* renamed from: then */
            public AppLink mo1696then(Task<Map<Uri, AppLink>> resolveUrisTask) throws Exception {
        ...
        for (Uri uri : uris) {
            ...
            if (appLink != null) {
                ...
                if (!urisToRequest.isEmpty()) {
                    graphRequestFields.append(CoreConstants.COMMA_CHAR);
                }
    ...
    public static AppLink.Target getAndroidTargetFromJson(JSONObject targetJson) {
        ...
        String className = tryGetStringFromJson(targetJson, "class", null);
