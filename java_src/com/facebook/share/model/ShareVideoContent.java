...
public final class ShareVideoContent extends ShareContent<ShareVideoContent, Builder> implements ShareModel {
    public static final Parcelable.Creator<ShareVideoContent> CREATOR = new Parcelable.Creator<ShareVideoContent>() { // from class: com.facebook.share.model.ShareVideoContent.1
        ...
        public ShareVideoContent mo1759createFromParcel(Parcel in) {
        ...
        public ShareVideoContent[] mo1760newArray(int size) {
    ...
    ShareVideoContent(Parcel in) {
        ...
        SharePhoto.Builder previewPhotoBuilder = new SharePhoto.Builder().mo1762readFrom(in);
        if (previewPhotoBuilder.getImageUrl() != null || previewPhotoBuilder.getBitmap() != null) {
            this.previewPhoto = previewPhotoBuilder.mo1761build();
        } else {
            this.previewPhoto = null;
        }
        this.video = new ShareVideo.Builder().mo1762readFrom(in).mo1761build();
    }
    ...
    public static final class Builder extends ShareContent.Builder<ShareVideoContent, Builder> {
        ...
        public Builder setPreviewPhoto(@Nullable SharePhoto previewPhoto) {
            this.previewPhoto = previewPhoto == null ? null : new SharePhoto.Builder().readFrom(previewPhoto).mo1761build();
            return this;
        }

        public Builder setVideo(@Nullable ShareVideo video) {
            if (video != null) {
                this.video = new ShareVideo.Builder().readFrom(video).mo1761build();
            }
            return this;
        }
        ...
        /* renamed from: build */
        public ShareVideoContent mo1761build() {
        ...
        public Builder mo1762readFrom(Parcel parcel) {
