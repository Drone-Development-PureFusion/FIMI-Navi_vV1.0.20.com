...
public class VideoUploader {
        ...
        public void initialize() throws FileNotFoundException {
            try {
                if (Utility.isFileUri(this.videoUri)) {
                    ParcelFileDescriptor fileDescriptor = ParcelFileDescriptor.open(new File(this.videoUri.getPath()), NTLMConstants.FLAG_UNIDENTIFIED_11);
    ...
    public static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            int delay = ((int) Math.pow(3.0d, this.completedRetries)) * 5000;
