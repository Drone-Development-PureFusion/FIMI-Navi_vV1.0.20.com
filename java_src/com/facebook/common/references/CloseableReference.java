...
public final class CloseableReference<T> implements Cloneable, Closeable {
    ...
    @Nullable
    private final Throwable mObtainedTrace = getTraceOrNull();
    ...
    @Nullable
    /* renamed from: of */
    public static CloseableReference m1337of(@Nullable Closeable closeable) {
        if (closeable == null) {
            return null;
        }
    ...
    @Nullable
    /* renamed from: of */
    public static <T> CloseableReference<T> m1336of(@Nullable T t, ResourceReleaser<T> resourceReleaser) {
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: clone */
    public synchronized CloseableReference<T> m1651clone() {
            ...
            synchronized (this) {
                if (!this.mIsClosed) {
                    ...
                    if (listener != null) {
                        ...
                        FLog.m1353w(TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(this.mSharedReference)), this.mSharedReference.get().getClass().getSimpleName());
                    }
                    close();
                }
            }
