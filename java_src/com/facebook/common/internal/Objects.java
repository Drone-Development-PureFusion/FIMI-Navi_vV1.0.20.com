...
public final class Objects {
    ...
    public static final class ToStringHelper {
        ...
        public String toString() {
            ...
            StringBuilder builder = new StringBuilder(32).append(this.className).append(CoreConstants.CURLY_LEFT);
            ...
            return builder.append(CoreConstants.CURLY_RIGHT).toString();
        }
