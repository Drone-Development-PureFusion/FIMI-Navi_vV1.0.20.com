...
public class HandlerExecutorServiceImpl extends AbstractExecutorService implements HandlerExecutorService {
    ...
    protected /* bridge */ /* synthetic */ RunnableFuture mo1646newTaskFor(Runnable runnable, Object obj) {
    ...
    public /* bridge */ /* synthetic */ Future submit(Runnable runnable, @Nullable Object obj) {
        return mo1649submit(runnable, (Runnable) obj);
    }
    ...
    public <T> ScheduledFutureImpl<T> mo1647newTaskFor(Callable<T> callable) {
        return new ScheduledFutureImpl<>(this.mHandler, callable);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService
    public ScheduledFuture<?> submit(Runnable task) {
        return mo1649submit(task, (Runnable) null);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService
    /* renamed from: submit  reason: collision with other method in class */
    public <T> ScheduledFuture<T> mo1649submit(Runnable task, @Nullable T result) {
        if (task == null) {
    ...
    public <T> ScheduledFuture<T> submit(Callable<T> task) {
        ...
        ScheduledFutureImpl<T> future = mo1647newTaskFor((Callable) task);
        execute(future);
        return future;
    }
    ...
    public <V> ScheduledFuture<V> schedule(Callable<V> callable, long delay, TimeUnit unit) {
        ScheduledFutureImpl<V> future = mo1647newTaskFor((Callable) callable);
        this.mHandler.postDelayed(future, unit.toMillis(delay));
        return future;
    }
