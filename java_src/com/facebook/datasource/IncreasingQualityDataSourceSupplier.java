...
public class IncreasingQualityDataSourceSupplier<T> implements Supplier<DataSource<T>> {
    ...
    public class IncreasingQualityDataSource extends AbstractDataSource<T> {
        ...
        public IncreasingQualityDataSource() {
            ...
            for (int i = 0; i < n; i++) {
                DataSource<T> dataSource = (DataSource) ((Supplier) IncreasingQualityDataSourceSupplier.this.mDataSourceSuppliers.get(i)).mo1796get();
        ...
        public synchronized T mo1679getResult() {
            DataSource<T> dataSourceWithResult;
            dataSourceWithResult = getDataSourceWithResult();
            return dataSourceWithResult != null ? dataSourceWithResult.mo1679getResult() : null;
        }
