...
public abstract class AbstractDataSource<T> implements DataSource<T> {
    ...
    private boolean setResultInternal(@Nullable T resultToClose, boolean isLast) {
        boolean z;
        T resultToClose2 = null;
        try {
            synchronized (this) {
                if (this.mIsClosed || this.mDataSourceStatus != DataSourceStatus.IN_PROGRESS) {
                    ...
                    if (this.mResult != resultToClose2) {
                        resultToClose2 = this.mResult;
                        this.mResult = resultToClose2;
                    }
                    z = true;
