...
public class FacebookActivity extends FragmentActivity {
    ...
    @Override // android.support.p001v4.app.FragmentActivity, android.support.p001v4.app.SupportActivity, android.app.Activity
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(C0552R.layout.com_facebook_activity_layout);
        ...
        if (fragment == null) {
            if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
                ...
                manager.beginTransaction().add(C0552R.C0555id.com_facebook_fragment_container, fragment, FRAGMENT_TAG).commit();
            }
        }
