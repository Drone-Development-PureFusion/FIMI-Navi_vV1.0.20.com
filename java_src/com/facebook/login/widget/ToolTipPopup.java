...
public class ToolTipPopup {
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            TextView body = (TextView) this.mPopupContent.findViewById(C0552R.C0555id.com_facebook_tooltip_bubble_view_text_body);
            body.setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0552R.C0554drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C0552R.C0554drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0552R.C0554drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C0552R.C0554drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0552R.C0554drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C0552R.C0554drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0552R.C0554drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C0552R.C0554drawable.com_facebook_tooltip_black_xout);
            }
    ...
    public class PopupContentView extends FrameLayout {
        ...
        private void init() {
            ...
            inflater.inflate(C0552R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C0552R.C0555id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C0552R.C0555id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C0552R.C0555id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C0552R.C0555id.com_facebook_button_xout);
        }
