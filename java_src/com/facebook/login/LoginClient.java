...
public class LoginClient implements Parcelable {
    public static final Parcelable.Creator<LoginClient> CREATOR = new Parcelable.Creator() { // from class: com.facebook.login.LoginClient.1
        ...
        public LoginClient mo1702createFromParcel(Parcel source) {
            return new LoginClient(source);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: newArray */
        public LoginClient[] mo1703newArray(int size) {
    ...
    boolean checkInternetPermission() {
        ...
        if (permissionCheck != 0) {
            ...
            String errorType = activity.getString(C0552R.string.com_facebook_internet_permission_error_title);
            String errorDescription = activity.getString(C0552R.string.com_facebook_internet_permission_error_message);
    ...
    public static class Request implements Parcelable {
        public static final Parcelable.Creator<Request> CREATOR = new Parcelable.Creator() { // from class: com.facebook.login.LoginClient.Request.1
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public Request mo1704createFromParcel(Parcel source) {
                return new Request(source);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public Request[] mo1705newArray(int size) {
    ...
    public static class Result implements Parcelable {
        public static final Parcelable.Creator<Result> CREATOR = new Parcelable.Creator() { // from class: com.facebook.login.LoginClient.Result.1
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public Result mo1706createFromParcel(Parcel source) {
                return new Result(source);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public Result[] mo1707newArray(int size) {
