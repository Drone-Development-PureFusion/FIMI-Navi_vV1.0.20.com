...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(C0552R.layout.com_facebook_login_fragment, container, false);
        this.loginClient.setBackgroundProcessingListener(new LoginClient.BackgroundProcessingListener() { // from class: com.facebook.login.LoginFragment.2
            ...
            public void onBackgroundProcessingStarted() {
                view.findViewById(C0552R.C0555id.com_facebook_login_activity_progress_bar).setVisibility(0);
            }

            @Override // com.facebook.login.LoginClient.BackgroundProcessingListener
            public void onBackgroundProcessingStopped() {
                view.findViewById(C0552R.C0555id.com_facebook_login_activity_progress_bar).setVisibility(8);
            }
        });
        return view;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(C0552R.C0555id.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
