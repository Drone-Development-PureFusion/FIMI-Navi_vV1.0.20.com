...
public class DraweeConfig {
    ...
    private DraweeConfig(Builder builder) {
        ...
        if (builder.mDebugOverlayEnabledSupplier == null) {
            m1412of = Suppliers.m1412of(false);
        } else {
            m1412of = builder.mDebugOverlayEnabledSupplier;
        }
        this.mDebugOverlayEnabledSupplier = m1412of;
    ...
    public static class Builder {
        ...
        public Builder setDrawDebugOverlay(boolean drawDebugOverlay) {
            return setDebugOverlayEnabledSupplier(Suppliers.m1412of(Boolean.valueOf(drawDebugOverlay)));
        }
