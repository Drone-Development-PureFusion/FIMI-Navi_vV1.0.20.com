...
public class PipelineDraweeControllerBuilder extends AbstractDraweeControllerBuilder<PipelineDraweeControllerBuilder, ImageRequest, CloseableReference<CloseableImage>, ImageInfo> {
    ...
    /* renamed from: setUri */
    public PipelineDraweeControllerBuilder mo1658setUri(@Nullable Uri uri) {
        if (uri == null) {
    ...
    @Override // com.facebook.drawee.interfaces.SimpleDraweeControllerBuilder
    /* renamed from: setUri */
    public PipelineDraweeControllerBuilder mo1659setUri(@Nullable String uriString) {
        return (uriString == null || uriString.isEmpty()) ? (PipelineDraweeControllerBuilder) super.setImageRequest(ImageRequest.fromUri(uriString)) : mo1658setUri(Uri.parse(uriString));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.drawee.controller.AbstractDraweeControllerBuilder
    /* renamed from: obtainController */
    public PipelineDraweeController mo1657obtainController() {
    ...
    public PipelineDraweeControllerBuilder mo1656getThis() {
        return this;
    }
