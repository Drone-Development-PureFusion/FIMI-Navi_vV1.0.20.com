...
public final class Profile implements Parcelable {
    public static final Parcelable.Creator<Profile> CREATOR = new Parcelable.Creator() { // from class: com.facebook.Profile.2
        ...
        public Profile mo1640createFromParcel(Parcel source) {
            return new Profile(source);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: newArray */
        public Profile[] mo1641newArray(int size) {
    ...
    public Uri getProfilePictureUri(int width, int height) {
        return ImageRequest.getProfilePictureUri(this.f66id, width, height);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.f66id.equals(o.f66id) && this.firstName == null) {
    ...
    public int hashCode() {
        int result = this.f66id.hashCode() + 527;
    ...
    public Profile(JSONObject jsonObject) {
        Uri uri = null;
        this.f66id = jsonObject.optString("id", null);
