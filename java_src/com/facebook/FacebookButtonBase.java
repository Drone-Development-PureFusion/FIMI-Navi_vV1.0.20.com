...
public abstract class FacebookButtonBase extends Button {
    ...
    public FacebookButtonBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, String analyticsButtonCreatedEventName, String analyticsButtonTappedEventName) {
        ...
        configureButton(context, attrs, defStyleAttr, defStyleRes == 0 ? C0552R.style.com_facebook_button : defStyleRes);
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (a.hasValue(0)) {
                    ...
                    setBackgroundColor(a.getColor(0, C0552R.C0553color.com_facebook_blue));
                }
            } finally {
                a.recycle();
            }
