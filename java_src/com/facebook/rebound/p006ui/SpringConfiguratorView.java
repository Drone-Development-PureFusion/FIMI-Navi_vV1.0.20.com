package com.facebook.rebound.p006ui;
...
public class SpringConfiguratorView extends FrameLayout {
    ...
    public SpringConfiguratorView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mTextColor = Color.argb(255, (int) JfifUtil.MARKER_APP1, (int) JfifUtil.MARKER_APP1, (int) JfifUtil.MARKER_APP1);
    ...
    public void updateSeekBarsForSpringConfig(SpringConfig springConfig) {
        ...
        int scaledTension = Math.round(((tension - 0.0f) * 100000.0f) / MAX_TENSION);
        float friction = (float) OrigamiValueConverter.origamiValueFromFriction(springConfig.friction);
        int scaledFriction = Math.round(((friction - 0.0f) * 100000.0f) / MAX_FRICTION);
