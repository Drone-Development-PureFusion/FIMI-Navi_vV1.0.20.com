...
public class CountingMemoryCache<K, V> implements MemoryCache<K, V>, MemoryTrimmable {
    ...
    public static class Entry<K, V> {
        ...
        @VisibleForTesting
        /* renamed from: of */
        static <K, V> Entry<K, V> m1333of(K key, CloseableReference<V> valueRef, @Nullable EntryStateObserver<K> observer) {
    ...
    public CountingMemoryCache(ValueDescriptor<V> valueDescriptor, CacheTrimStrategy cacheTrimStrategy, Supplier<MemoryCacheParams> memoryCacheParamsSupplier, PlatformBitmapFactory platformBitmapFactory, boolean isExternalCreatedBitmapLogEnabled) {
        ...
        this.mMemoryCacheParams = this.mMemoryCacheParamsSupplier.mo1796get();
    ...
    public CloseableReference<V> cache(K key, CloseableReference<V> valueRef, EntryStateObserver<K> observer) {
        ...
        synchronized (this) {
            ...
            if (canCacheNewValue(valueRef.get())) {
                Entry<K, V> newEntry = Entry.m1333of(key, valueRef, observer);
    ...
    private synchronized CloseableReference<V> newClientReference(final Entry<K, V> entry) {
        ...
        return CloseableReference.m1336of(entry.valueRef.get(), new ResourceReleaser<V>() { // from class: com.facebook.imagepipeline.cache.CountingMemoryCache.3
