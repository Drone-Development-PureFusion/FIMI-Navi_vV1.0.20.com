    ...
    private static int getRotationAngle(String pathname) {
        if (pathname != null) {
            try {
                ...
                return JfifUtil.getAutoRotateAngleFromOrientation(exif.getAttributeInt(android.support.media.ExifInterface.TAG_ORIENTATION, 1));
            } catch (IOException ioe) {
                FLog.m1392e(TAG, ioe, "Unable to retrieve thumbnail rotation for %s", pathname);
                return 0;
            }
        }
        return 0;
