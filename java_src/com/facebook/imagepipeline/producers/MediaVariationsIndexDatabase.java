...
public class MediaVariationsIndexDatabase implements MediaVariationsIndex {
    ...
    public Task<List<MediaVariations.Variant>> getCachedVariants(final String mediaId) {
        try {
            ...
            FLog.m1348w(TAG, exception, "Failed to schedule query task for %s", mediaId);
    ...
    public synchronized List<MediaVariations.Variant> getCachedVariantsSync(String mediaId) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                FLog.m1388e(TAG, x, "Error reading for %s", mediaId);
                throw x;
            }
        }
        return variants;
            ...
            public void run() {
                ...
                try {
                    try {
                        ...
                        FLog.m1388e(MediaVariationsIndexDatabase.TAG, x, "Error writing for %s", mediaId);
                        db.endTransaction();
                    }
                } catch (Throwable th) {
                    db.endTransaction();
