...
public class PostprocessorProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    public class PostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> {
        ...
        private Map<String, String> getExtraMap(ProducerListener listener, String requestId, Postprocessor postprocessor) {
            ...
            return ImmutableMap.m1419of(PostprocessorProducer.POSTPROCESSOR, postprocessor.getName());
        }
        ...
        private CloseableReference<CloseableImage> postprocessInternal(CloseableImage sourceImage) {
            ...
            try {
                return CloseableReference.m1337of(new CloseableStaticBitmap(bitmapRef, sourceImage.getQualityInfo(), rotationAngle));
            } finally {
