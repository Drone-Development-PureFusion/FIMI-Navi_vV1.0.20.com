...
public class ResizeAndRotateProducer implements Producer<EncodedImage> {
    ...
    private class TransformingConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        public void doTransform(EncodedImage encodedImage, boolean isLast) {
            ...
            PooledByteBufferOutputStream outputStream = ResizeAndRotateProducer.this.mPooledByteBufferFactory.mo1687newOutputStream();
            ...
            try {
                try {
                    ...
                    ref = CloseableReference.m1337of(outputStream.mo1689toByteBuffer());
                    try {
