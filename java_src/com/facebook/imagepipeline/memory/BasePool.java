...
public abstract class BasePool<V> implements Pool<V> {
    ...
    /* renamed from: alloc */
    protected abstract V mo1682alloc(int i);
        ...
        synchronized (this) {
            ...
            if (bucket != null && (value = bucket.get()) != null) {
                ...
                if (FLog.isLoggable(2)) {
                    FLog.m1369v(this.TAG, "get (reuse) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSize2));
                }
            } else {
                ...
                value = null;
                try {
                    value = mo1682alloc(bucketedSize);
                } catch (Throwable e) {
                    synchronized (this) {
                ...
                synchronized (this) {
                    ...
                    logStats();
                    if (FLog.isLoggable(2)) {
                        FLog.m1369v(this.TAG, "get (alloc) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSize));
                    }
                }
            }
        }
    ...
    public void release(V value) {
        ...
        synchronized (this) {
            ...
            if (!this.mInUseValues.remove(value)) {
                FLog.m1393e(this.TAG, "release (free, value unrecognized) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSize));
                free(value);
                ...
                if (FLog.isLoggable(2)) {
                    FLog.m1369v(this.TAG, "release (free) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSize));
                }
                free(value);
                ...
                if (FLog.isLoggable(2)) {
                    FLog.m1369v(this.TAG, "release (reuse) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSize));
                }
            }
            logStats();
        }
    ...
    synchronized void trimToSize(int targetSize) {
        ...
        if (bytesToFree > 0) {
            if (FLog.isLoggable(2)) {
                FLog.m1368v(this.TAG, "trimToSize: TargetSize = %d; Initial Size = %d; Bytes to free = %d", Integer.valueOf(targetSize), Integer.valueOf(this.mUsed.mNumBytes + this.mFree.mNumBytes), Integer.valueOf(bytesToFree));
            }
            logStats();
            ...
            logStats();
            if (FLog.isLoggable(2)) {
                FLog.m1369v(this.TAG, "trimToSize: TargetSize = %d; Final Size = %d", Integer.valueOf(targetSize), Integer.valueOf(this.mUsed.mNumBytes + this.mFree.mNumBytes));
            }
        }
    }
    ...
    synchronized Bucket<V> getBucket(int bucketedSize) {
        ...
        if (bucket != null || !this.mAllowNewBuckets) {
            ...
            if (FLog.isLoggable(2)) {
                FLog.m1370v(this.TAG, "creating new bucket %s", Integer.valueOf(bucketedSize));
            }
    ...
    private void logStats() {
        if (FLog.isLoggable(2)) {
            FLog.m1367v(this.TAG, "Used = (%d, %d); Free = (%d, %d)", Integer.valueOf(this.mUsed.mCount), Integer.valueOf(this.mUsed.mNumBytes), Integer.valueOf(this.mFree.mCount), Integer.valueOf(this.mFree.mNumBytes));
        }
    }
