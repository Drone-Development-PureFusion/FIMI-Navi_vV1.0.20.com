...
public class GraphRequestBatch extends AbstractList<GraphRequest> {
    ...
    public GraphRequestBatch() {
        ...
        this.f65id = Integer.valueOf(idGenerator.incrementAndGet()).toString();
    ...
    @Override // java.util.AbstractList, java.util.List
    /* renamed from: get */
    public final GraphRequest mo1638get(int i) {
        return this.requests.get(i);
    }

    @Override // java.util.AbstractList, java.util.List
    /* renamed from: remove */
    public final GraphRequest mo1639remove(int location) {
