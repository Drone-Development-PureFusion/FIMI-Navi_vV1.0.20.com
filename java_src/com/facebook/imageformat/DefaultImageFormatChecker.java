...
public class DefaultImageFormatChecker implements ImageFormat.FormatChecker {
    ...
    private static final byte[] PNG_HEADER = {FcCollection.MSG_REST_SYSTEM_PARAMS, FcCollection.MSG_SET_FOLLOW_EXCUTE, 78, FcCollection.MSG_GET_SURROUND_SPEED, 13, 10, 26, 10};
