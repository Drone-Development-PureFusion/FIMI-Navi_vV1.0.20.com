...
public class Autolink {
    ...
    public interface LinkAttributeModifier {
        void modify(Extractor.C2098Entity c2098Entity, Map<String, String> map);
    }

    /* loaded from: classes2.dex */
    public interface LinkTextModifier {
        CharSequence modify(Extractor.C2098Entity c2098Entity, CharSequence charSequence);
    }
    ...
    public void linkToText(Extractor.C2098Entity entity, CharSequence text, Map<String, String> attributes, StringBuilder builder) {
        if (this.noFollow) {
    ...
    public void linkToTextWithSymbol(Extractor.C2098Entity entity, CharSequence symbol, CharSequence text, Map<String, String> attributes, StringBuilder builder) {
    ...
    public void linkToHashtag(Extractor.C2098Entity entity, String text, StringBuilder builder) {
        ...
        attrs.put(ShareConstants.WEB_DIALOG_PARAM_TITLE, "#" + ((Object) hashtag));
        if (Regex.RTL_CHARACTERS.matcher(text).find()) {
            attrs.put(Action.CLASS_ATTRIBUTE, this.hashtagClass + " rtl");
        } else {
            attrs.put(Action.CLASS_ATTRIBUTE, this.hashtagClass);
        }
        linkToTextWithSymbol(entity, hashChar, hashtag, attrs, builder);
    }

    public void linkToCashtag(Extractor.C2098Entity entity, String text, StringBuilder builder) {
        CharSequence cashtag = entity.getValue();
        Map<String, String> attrs = new LinkedHashMap<>();
        attrs.put(ShareConstants.WEB_DIALOG_PARAM_HREF, this.cashtagUrlBase + ((Object) cashtag));
        attrs.put(ShareConstants.WEB_DIALOG_PARAM_TITLE, "$" + ((Object) cashtag));
        attrs.put(Action.CLASS_ATTRIBUTE, this.cashtagClass);
        linkToTextWithSymbol(entity, "$", cashtag, attrs, builder);
    }

    public void linkToMentionAndList(Extractor.C2098Entity entity, String text, StringBuilder builder) {
        ...
        if (entity.listSlug != null) {
            ...
            attrs.put(Action.CLASS_ATTRIBUTE, this.listClass);
            attrs.put(ShareConstants.WEB_DIALOG_PARAM_HREF, this.listUrlBase + mention);
        } else {
            attrs.put(Action.CLASS_ATTRIBUTE, this.usernameClass);
    ...
    public void linkToURL(Extractor.C2098Entity entity, String text, StringBuilder builder) {
        ...
        if (this.urlClass != null) {
            attrs.put(Action.CLASS_ATTRIBUTE, this.urlClass);
        }
    ...
    public String autoLinkEntities(String text, List<Extractor.C2098Entity> entities) {
        StringBuilder builder = new StringBuilder(text.length() * 2);
        int beginIndex = 0;
        for (Extractor.C2098Entity entity : entities) {
    ...
    public String autoLink(String text) {
        ...
        List<Extractor.C2098Entity> entities = this.extractor.extractEntitiesWithIndices(text2);
