...
public class OAuthActivity extends Activity implements OAuthController.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C2105R.layout.tw__activity_oauth);
        this.spinner = (ProgressBar) findViewById(C2105R.C2108id.tw__spinner);
        this.webView = (WebView) findViewById(C2105R.C2108id.tw__web_view);
        ...
        this.oAuthController = new OAuthController(this.spinner, this.webView, (TwitterAuthConfig) getIntent().getParcelableExtra(EXTRA_AUTH_CONFIG), new OAuth1aService(kit, new TwitterApi()), this);
