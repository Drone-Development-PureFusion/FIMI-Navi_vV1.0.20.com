...
public class SSOAuthHandler extends AuthHandler {
    ...
    private boolean startAuthActivityForResult(Activity activity) {
        ...
        if (packageName == null) {
            Twitter.getLogger().mo1290e("Twitter", "SSO app signature check failed", null);
            return false;
        }
        ...
        if (!IntentUtils.isActivityAvailable(activity, intent)) {
            Twitter.getLogger().mo1290e("Twitter", "SSO auth activity not found", null);
            return false;
        }
        ...
        try {
            ...
            Twitter.getLogger().mo1290e("Twitter", "SSO exception occurred", e);
            return false;
        }
    }
