...
public class ToggleImageButton extends ImageButton {
    private static final int[] STATE_TOGGLED_ON = {C2168R.attr.state_toggled_on};
    ...
    public ToggleImageButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = null;
        try {
            a = context.getTheme().obtainStyledAttributes(attrs, C2168R.styleable.ToggleImageButton, defStyle, 0);
            String contentDescriptionOn = a.getString(C2168R.styleable.ToggleImageButton_contentDescriptionOn);
            String contentDescriptionOff = a.getString(C2168R.styleable.ToggleImageButton_contentDescriptionOff);
            ...
            this.toggleOnClick = a.getBoolean(C2168R.styleable.ToggleImageButton_toggleOnClick, true);
            setToggledOn(false);
        } finally {
            if (a != null) {
                a.recycle();
