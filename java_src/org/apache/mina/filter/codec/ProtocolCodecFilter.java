    ...
    private void disposeEncoder(IoSession session) {
        ...
        if (encoder != null) {
            try {
                ...
                LOGGER.warn("Failed to dispose: " + encoder.getClass().getName() + " (" + encoder + CoreConstants.RIGHT_PARENTHESIS_CHAR);
            }
        }
    }
    ...
    private void disposeDecoder(IoSession session) {
        ...
        if (decoder != null) {
            try {
                ...
                LOGGER.warn("Failed to dispose: " + decoder.getClass().getName() + " (" + decoder + CoreConstants.RIGHT_PARENTHESIS_CHAR);
            }
        }
    }
