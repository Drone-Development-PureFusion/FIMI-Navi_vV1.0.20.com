...
public class DefaultIoFilterChain implements IoFilterChain {
    ...
    public synchronized IoFilter replace(String name, IoFilter newFilter) {
        ...
        try {
            ...
            try {
                ...
                throw new IoFilterLifeCycleException("onPostAdd(): " + name + CoreConstants.COLON_CHAR + newFilter + " in " + getSession(), e);
            }
        } catch (Exception e2) {
            throw new IoFilterLifeCycleException("onPreAdd(): " + name + CoreConstants.COLON_CHAR + newFilter + " in " + getSession(), e2);
        }
        return oldFilter;
    }
            ...
            if (entry.getFilter() == oldFilter) {
                ...
                try {
                    ...
                    try {
                        ...
                        entry.setFilter(oldFilter);
                        throw new IoFilterLifeCycleException("onPostAdd(): " + oldFilterName + CoreConstants.COLON_CHAR + newFilter + " in " + getSession(), e);
                    }
                } catch (Exception e2) {
                    throw new IoFilterLifeCycleException("onPreAdd(): " + oldFilterName + CoreConstants.COLON_CHAR + newFilter + " in " + getSession(), e2);
                }
            }
        }
    ...
    private void register(EntryImpl prevEntry, String name, IoFilter filter) {
        ...
        try {
            ...
            try {
                ...
                throw new IoFilterLifeCycleException("onPostAdd(): " + name + CoreConstants.COLON_CHAR + filter + " in " + getSession(), e);
            }
        } catch (Exception e2) {
            throw new IoFilterLifeCycleException("onPreAdd(): " + name + CoreConstants.COLON_CHAR + filter + " in " + getSession(), e2);
        }
    }
    ...
    private void deregister(EntryImpl entry) {
        ...
        try {
            ...
            try {
                ...
                throw new IoFilterLifeCycleException("onPostRemove(): " + entry.getName() + CoreConstants.COLON_CHAR + filter + " in " + getSession(), e);
            }
        } catch (Exception e2) {
            throw new IoFilterLifeCycleException("onPreRemove(): " + entry.getName() + CoreConstants.COLON_CHAR + filter + " in " + getSession(), e2);
        }
    }
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (s.mo1951getConfig().isUseReadOperation()) {
    ...
    public final class EntryImpl implements IoFilterChain.Entry {
        ...
        public String toString() {
            ...
            sb.append("('").append(getName()).append(CoreConstants.SINGLE_QUOTE_CHAR);
            sb.append(", prev: '");
