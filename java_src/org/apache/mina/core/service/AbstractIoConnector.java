...
public abstract class AbstractIoConnector extends AbstractIoService implements IoConnector {
    ...
    private long connectTimeoutInMillis = ReconfigureOnChangeFilter.DEFAULT_REFRESH_PERIOD;
    ...
    public SocketAddress mo1940getDefaultRemoteAddress() {
    ...
    public final ConnectFuture connect() {
        SocketAddress defaultRemoteAddress = mo1940getDefaultRemoteAddress();
        if (defaultRemoteAddress == null) {
    ...
    protected final void finishSessionInitialization0(final IoSession session, IoFuture future) {
        future.mo1923addListener(new IoFutureListener<ConnectFuture>() { // from class: org.apache.mina.core.service.AbstractIoConnector.2
    ...
    public String toString() {
        ...
        return CoreConstants.LEFT_PARENTHESIS_CHAR + m.getProviderName() + ' ' + m.getName() + " connector: managedSessionCount: " + getManagedSessionCount() + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}
