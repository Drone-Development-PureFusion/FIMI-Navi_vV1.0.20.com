...
public class SimpleIoProcessorPool<S extends AbstractIoSession> implements IoProcessor<S> {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:35:0x01b1 -> B:32:0x0197). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:47:0x00f6 -> B:18:0x007c). Please submit an issue!!! */
