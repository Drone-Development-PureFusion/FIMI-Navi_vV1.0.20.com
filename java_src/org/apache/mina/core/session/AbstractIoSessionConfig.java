...
public abstract class AbstractIoSessionConfig implements IoSessionConfig {
    ...
    public void setMinReadBufferSize(int minReadBufferSize) {
        ...
        if (minReadBufferSize > this.maxReadBufferSize) {
            throw new IllegalArgumentException("minReadBufferSize: " + minReadBufferSize + " (expected: smaller than " + this.maxReadBufferSize + CoreConstants.RIGHT_PARENTHESIS_CHAR);
        }
    ...
    public void setMaxReadBufferSize(int maxReadBufferSize) {
        ...
        if (maxReadBufferSize < this.minReadBufferSize) {
            throw new IllegalArgumentException("maxReadBufferSize: " + maxReadBufferSize + " (expected: greater than " + this.minReadBufferSize + CoreConstants.RIGHT_PARENTHESIS_CHAR);
        }
