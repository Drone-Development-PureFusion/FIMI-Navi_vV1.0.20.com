...
public interface NTLMConstants {
    ...
    public static final byte[] NTLM_SIGNATURE = {78, FcCollection.MSG_SET_FOLLOW_STANDBY, 76, 77, FcCollection.MSG_SET_FOLLOW_EXIT, FcCollection.MSG_SET_FOLLOW_EXIT, FcCollection.MSG_SET_FOLLOW_EXCUTE, 0};
    public static final byte[] DEFAULT_OS_VERSION = {5, 1, FcCollection.MSG_ID_GET_AUTO_HOME, 10, 0, 0, 0, 15};
}
