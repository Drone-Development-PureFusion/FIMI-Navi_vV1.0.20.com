...
public final class VmPipeAcceptor extends AbstractIoAcceptor {
    ...
    public VmPipeSessionConfig mo1950getSessionConfig() {
    ...
    public VmPipeAddress mo1948getLocalAddress() {
        return (VmPipeAddress) super.mo1948getLocalAddress();
    }

    @Override // org.apache.mina.core.service.AbstractIoAcceptor, org.apache.mina.core.service.IoAcceptor
    /* renamed from: getDefaultLocalAddress  reason: collision with other method in class */
    public VmPipeAddress mo1947getDefaultLocalAddress() {
        return (VmPipeAddress) super.mo1947getDefaultLocalAddress();
    }
    ...
    protected Set<SocketAddress> bindInternal(List<? extends SocketAddress> localAddresses) throws IOException {
        ...
        synchronized (boundHandlers) {
            Iterator<? extends SocketAddress> it = localAddresses.iterator();
            while (it.hasNext()) {
                VmPipeAddress localAddress = (VmPipeAddress) it.next();
