...
public class TableStatements {
    ...
    /* renamed from: db */
    private final Database f1487db;
    ...
    public DatabaseStatement getInsertStatement() {
        if (this.insertStatement == null) {
            ...
            DatabaseStatement newInsertStatement = this.f1487db.compileStatement(sql);
            synchronized (this) {
                if (this.insertStatement == null) {
    ...
    public DatabaseStatement getInsertOrReplaceStatement() {
        if (this.insertOrReplaceStatement == null) {
            ...
            DatabaseStatement newInsertOrReplaceStatement = this.f1487db.compileStatement(sql);
            synchronized (this) {
                if (this.insertOrReplaceStatement == null) {
    ...
    public DatabaseStatement getDeleteStatement() {
        if (this.deleteStatement == null) {
            ...
            DatabaseStatement newDeleteStatement = this.f1487db.compileStatement(sql);
            synchronized (this) {
                if (this.deleteStatement == null) {
    ...
    public DatabaseStatement getUpdateStatement() {
        if (this.updateStatement == null) {
            ...
            DatabaseStatement newUpdateStatement = this.f1487db.compileStatement(sql);
            synchronized (this) {
                if (this.updateStatement == null) {
    ...
    public DatabaseStatement getCountStatement() {
        if (this.countStatement == null) {
            ...
            this.countStatement = this.f1487db.compileStatement(sql);
        }
