...
abstract class SignatureImpl implements Signature {
    ...
    String fullTypeName(Class type) {
        return type == null ? "ANONYMOUS" : type.isArray() ? new StringBuffer().append(fullTypeName(type.getComponentType())).append("[]").toString() : type.getName().replace(CoreConstants.DOLLAR, CoreConstants.DOT);
    }
    ...
    String shortTypeName(Class type) {
        return type == null ? "ANONYMOUS" : type.isArray() ? new StringBuffer().append(shortTypeName(type.getComponentType())).append("[]").toString() : stripPackageName(type.getName()).replace(CoreConstants.DOLLAR, CoreConstants.DOT);
    }
