...
public final class DocumentHelper {
    ...
    public static AbstractC2649Entity createEntity(String name, String text) {
    ...
    public static Element makeElement(Branch source, String path) {
        ...
        while (tokens.hasMoreTokens()) {
            ...
            if (name2.indexOf(58) > 0) {
                element = parent.element(parent.getQName(name2));
            } else {
                element = parent.element(name2);
            }
            if (element == null) {
                element = parent.addElement(name2);
            }
            parent = element;
        }
        return element;
